\begin{figure}[h!]
    ...
    % Vettori velocità
    \draw[velocity] (m1) -- ++(0.8,0.3) node[above right] {$\vec{v}_1$};
    \draw[velocity] (m2) -- ++(0.4,0.7) node[above right] {$\vec{v}_2$};
    \draw[velocity] (m3) -- ++(-0.7,0.2) node[above left] {$\vec{v}_3$};
    \draw[velocity] (m4) -- ++(0.3,-0.6) node[below right] {$\vec{v}_4$};
    \draw[velocity] (m5) -- ++(-0.5,-0.4) node[below left] {$\vec{v}_5$};
