...
%Aggiunta sfera
\shade[ball color=blue!30!white, opacity=0.2] (0,0) circle (5.4cm);


% Arco orientato per omega
\tdplotdrawarc[->, thick]{(0,0,5.3)}{2}{0}{350}{ anchor=south west}{$\omega$}
