...
\fill[blue] (-0.3,-1.0) circle (0.3);
\fill[red] (0.3,-1.0) circle (0.3);
\node[below=4pt] at (0,-1.1) {\textbf{C}};
\node[above=6pt] at (0,-0.9) {$M_0$};

% Velocità C
\node[right=8pt] at (0.6,-1.0) {$u'_C = 0$};

% Asse x' inferiore
\draw[->, thick] (-4,-1.9) -- (4,-1.9) node[right] {$x'$};
