...
\[\overset{\underline{}}{B} = \frac{1 + \chi}{\chi}\mu_{0}\overset{\underline{}}{M}\]
...
\[\mathcal{D =}\frac{k_{B}T}{6\pi\eta r}\]
...
\[\mathcal{D =}\frac{k_{B}T}{6\pi\eta r} = \frac{1.38 \cdot 10^{- 23}\ \frac{J}{K}295\ K\ }{6\pi \cdot 1.0\frac{m^{2}}{s}0.1 \cdot 10^{- 9}m} = \frac{1.38 \cdot 10^{- 23}\ \frac{kg}{K}m/295\ K\ }{6\pi \cdot 1.0\frac{m^{2}}{s}0.1 \cdot 10^{- 9}m} = 2.2 \cdot 10^{- 12}\frac{m^{2}}{s} = 2.2\frac{pm^{2}}{s}\]
...
\[M_{xy}(t) = M_{0}\exp\left( - \frac{t}{T_{2}} \right)\exp\left( - \gamma G^{2}\mathcal{D}\frac{t^{3}}{3} \right)\]
...
\[M_{xy}(t) = M_{0}\exp\left( - \frac{t}{T_{2}} \right)\exp\left( - b\mathcal{D} \right)\]
...
\[b = \gamma^{2}G^{2}\delta^{2}\left( \Delta - \frac{1}{3}\delta \right)\]
