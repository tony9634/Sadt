...
\vfill
    ...
    \label{blx:FastImm\therefsection}
\vfill
...
\[M_{\bot}\left( t_{n} \right) = M_{\bot}\left( 0^{+} \right)\exp\left( - \dfrac{t_{n}}{T_{2}} \right),0 < t_{n} < T_{R}\]
...
\[M_{\bot}\left( t_{n} \right) = {\overset{\underline{}}{M}}_{\bot}\left( 0^{+} \right)\exp\left( - \dfrac{t_{n}}{T_{2}} \right) = {\overset{\underline{}}{M}}_{z}\left( 0^{-} \right)\sin\vartheta\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]
...
\[M_{z}\left( t_{n} \right) = M_{0}\left( 1 - \exp\left( - \dfrac{t_{n}}{T_{1}} \right) \right) + M_{z}\left( 0^{+} \right)\exp\left( - \dfrac{t_{n}}{T_{1}} \right)\]
...
\[M_{z}\left( t_{n} \right) = M_{0}\left( 1 - \exp\left( - \dfrac{t_{n}}{T_{1}} \right) \right) + M_{z}\left( 0^{-} \right)\cos\vartheta\exp\left( - \dfrac{t_{n}}{T_{1}} \right)\]
...
\[M_{\bot}\left( (n + 1)T_{R} \right) = M_{\bot}\left( nT_{R}^{+} \right)\exp\left( - \dfrac{T_{R}}{T_{2}} \right)\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]

Per semplicità di notazione si pone:

\[E_{2} = \exp\left( - \dfrac{T_{R}}{T_{2}} \right)\]

Con questa posizione la magnetizzazione trasversale si scrive come:

\[M_{\bot}\left( (n + 1)T_{R} \right) = M_{\bot}\left( nT_{R}^{+} \right)E_{2}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]
...
\[M_{z}\left( (n + 1)T_{R}^{-} \right) = M_{z}\left( nT_{R}^{-} \right)\cos\vartheta\exp\left( - \dfrac{T_{R}}{T_{1}} \right) + M_{0}\left( 1 - \exp\left( - \dfrac{T_{R}}{T_{1}} \right) \right)\]

Per semplicità di notazione si pone;

\[E_{1} = \exp\left( - \dfrac{T_{R}}{T_{1}} \right)\]
...
\[M_{ze} = M_{0}\dfrac{1 - E_{1}}{1 - E_{1}\cos\vartheta}\]
...
\[M_{\bot}\left( (n + 1)T_{R} \right) = M_{ze}\sin\vartheta\left( nT_{R}^{+} \right)E_{2}\exp\left( - \dfrac{t_{n}}{T_{2}} \right) = M_{0}\sin\vartheta\dfrac{1 - E_{1}}{1 - E_{1}\cos\vartheta}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]
...
\[\widehat{\rho}\left( \vartheta,T_{E} \right) = \rho_{0}\sin\vartheta\dfrac{1 - E_{1}}{1 - E_{1}\cos\vartheta}\exp\left( - \dfrac{T_{E}}{T_{2}^{*}} \right)\]
...
\[\dfrac{\partial\widehat{\rho}}{\partial\vartheta} = 0 \Leftrightarrow \dfrac{\partial}{\partial\vartheta}\left( \rho_{0}\sin\vartheta\dfrac{1 - E_{1}}{1 - E_{1}\cos\vartheta}\exp\left( - \dfrac{T_{E}}{T_{2}^{*}} \right) \right) = 0\]

Grazie alla linearità della derivata, si ha:

\[\left( 1 - E_{1} \right)\rho_{0}\exp\left( - \dfrac{T_{E}}{T_{2}^{*}} \right)\dfrac{\partial}{\partial\vartheta}\left( \sin\vartheta\dfrac{1}{1 - E_{1}\cos\vartheta} \right) = 0\]

I termini costante possono essere semplificati poiché diversi da zero, quindi:

\[\dfrac{\partial}{\partial\vartheta}\left( \sin\vartheta\dfrac{1}{1 - E_{1}\cos\vartheta} \right) = 0\]

Si esegue la derivata:

\[\cos\vartheta\dfrac{1}{1 - E_{1}\cos\vartheta} + \sin\vartheta\dfrac{1}{\left( 1 - E_{1}\cos\vartheta \right)^{2}}\left( - E_{1}\sin\vartheta \right) = 0\]

Si considera \(1 - E_{1}\cos\vartheta\) e si verifica se può essere uguale a zero:

\[1 - E_{1}\cos\vartheta = 0 \Leftrightarrow \cos\vartheta = \dfrac{1}{E_{1}}\]
...
\[\exp\left( - \dfrac{T_{R}}{T_{1}} \right) \simeq 1\]
...
\[\cos\vartheta - E_{1}\sin^{2}\vartheta\dfrac{1}{1 - E_{1}\cos\vartheta} = 0\]
...
\[\vartheta_{opt} = \arccos\left( \exp\left( - \dfrac{T_{R}}{T_{1}} \right) \right)\]
...
\[E_{1} = \exp\left( - \dfrac{T_{R}}{T_{1}} \right) \simeq 1 - \dfrac{T_{R}}{T_{1}}\]
...
\[\sin\vartheta_{E} = \sqrt{1 - E_{1}^{2}} \simeq \sqrt{1 - \left( 1 - \dfrac{T_{R}}{T_{1}} \right)^{2}}\]

Svolgendo il quadrato, si ottiene:

\[\sin\vartheta_{E} \simeq \sqrt{1 - 1 + 2\dfrac{T_{R}}{T_{1}} - \left( \dfrac{T_{R}}{T_{1}} \right)^{2}} = \sqrt{2\dfrac{T_{R}}{T_{1}} - \left( \dfrac{T_{R}}{T_{1}} \right)^{2}}\]

Siccome \(T_{R}/T_{1} \ll 1\), è possibile trascurare i termini di ordine superiore al primo, ottenendo:

\[\sin\vartheta_{E} \simeq \sqrt{2\dfrac{T_{R}}{T_{1}}}\]
...
\[\vartheta_{E} \simeq \sqrt{2\dfrac{T_{R}}{T_{1}}}\]

Con questa approssimazione, la componente trasversale del vettore di magnetizzazione, valutata nell'angolo di Ernst è:

\[M_{\bot}\left( \vartheta_{E} \right) = M_{0}\sin\vartheta_{E}\dfrac{1 - E_{1}}{1 - E_{1}\cos\vartheta_{E}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]

Si è visto che \(\sin\vartheta_{E} = \sqrt{1 - E_{1}^{2}}\) e che \(\vartheta_{E} = \arccos\left( E_{1} \right)\), per cui:

\[M_{\bot}\left( \vartheta_{E} \right) = M_{0}\sin\vartheta_{E}\dfrac{1 - E_{1}}{1 - E_{1}\cos\vartheta_{E}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right) = M_{0}\sqrt{1 - E_{1}^{2}}\ \dfrac{1 - E_{1}}{1 - E_{1}\cos\left( \arccos\left( E_{1} \right) \right)}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]

Da cui:

\[M_{\bot}\left( \vartheta_{E} \right) = M_{0}\sqrt{1 - E_{1}^{2}}\ \dfrac{1 - E_{1}}{1 - E_{1}^{2}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]

Si scompongono i termini \(1 - E_{1}^{2}\) in \(\left( 1 - E_{1} \right)\left( 1 + E_{1} \right)\):

\[M_{\bot}\left( \vartheta_{E} \right) = M_{0}\sqrt{\left( 1 - E_{1} \right)\left( 1 + E_{1} \right)}\ \dfrac{1 - E_{1}}{\left( 1 - E_{1} \right)\left( 1 + E_{1} \right)}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]

Nella frazione è possibile semplificare \(1 - E_{1}\):

\[M_{\bot}\left( \vartheta_{E} \right) = M_{0}\ \dfrac{\sqrt{\left( 1 - E_{1} \right)\left( 1 + E_{1} \right)}}{\left( 1 + E_{1} \right)}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]

Grazie alle proprietà delle radici, è possibile scrivere:

\[M_{\bot}\left( \vartheta_{E} \right) = M_{0}\ \sqrt{\dfrac{\left( 1 - E_{1} \right)\left( 1 + E_{1} \right)}{\left( 1 + E_{1} \right)^{2}}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]

Da cui:

\[M_{\bot}\left( \vartheta_{E} \right) = M_{0}\ \sqrt{\dfrac{1 - E_{1}}{1 + E_{1}}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]

Nella condizione \(T_{R} \ll T_{1}\) è possibile applicare lo sviluppo di Taylor per \(E_{1}\), ottenendo:

\[M_{\bot}\left( \vartheta_{E} \right) = M_{0}\ \sqrt{\dfrac{1 - E_{1}}{1 + E_{1}}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right) \simeq M_{0}\ \sqrt{\dfrac{1 - \left( 1 - \dfrac{T_{R}}{T_{1}} \right)}{1 + 1 - \dfrac{T_{R}}{T_{1}}}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right) =\]

Svolendo le somme, si ottiene:

\[M_{\bot}\left( \vartheta_{E} \right) \simeq M_{0}\ \sqrt{\dfrac{\dfrac{T_{R}}{T_{1}}}{2 - \dfrac{T_{R}}{T_{1}}}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]

Dato che \(T_{R} \ll T_{1}\) è possibile trascurare \(T_{R}/T_{1}\) al denominatore:

\[M_{\bot}\left( \vartheta_{E} \right) \simeq M_{0}\ \sqrt{\dfrac{\dfrac{T_{R}}{T_{1}}}{2 - \dfrac{T_{R}}{T_{1}}}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right) \simeq M_{0}\ \sqrt{\dfrac{T_{R}}{2T_{1}}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]

Poiché \(T_{2} < T_{1}\) e \(0 < t_{n} < T_{R}\) il termine \(\exp\left( - t_{n}/T_{2} \right)\) tende all'unità:

\[\exp\left( - \dfrac{t_{n}}{T_{2}} \right) \simeq 1\]

Si ottiene:

\[M_{\bot}\left( \vartheta_{E} \right) \simeq M_{0}\ \sqrt{\dfrac{T_{R}}{2T_{1}}}\]

All'interno della radice quadrata, si moltiplica e divide per \(2\):

\[M_{\bot}\left( \vartheta_{E} \right) \simeq M_{0}\sqrt{\dfrac{T_{R}}{2T_{1}}} = M_{0}\sqrt{\dfrac{2T_{R}}{4T_{1}}}\]
...
\[M_{\bot}\left( \vartheta_{E} \right) \simeq M_{0}\dfrac{\vartheta_{E}}{2}\]
...
\[M_{\bot}(\vartheta) = M_{0}\sin\vartheta\dfrac{1 - E_{1}}{1 - E_{1}\cos\vartheta}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]
...
\[\cos(\vartheta) \simeq 1 - \dfrac{\vartheta^{2}}{2}\]

La componente trasversale del vettore magnetizzazione può essere approssimata come:

\[M_{\bot}(\vartheta) = M_{0}\sin\vartheta\dfrac{1 - E_{1}}{1 - E_{1}\cos\vartheta}\exp\left( - \dfrac{t_{n}}{T_{2}} \right) \simeq M_{0}\vartheta\dfrac{1 - E_{1}}{1 - E_{1}\left( 1 - \dfrac{\vartheta^{2}}{2} \right)}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]

Si divide e moltiplica il secondo membro per \(1 - E_{1}\):

\[M_{\bot}(\vartheta) \simeq \dfrac{M_{0}\vartheta}{\dfrac{1 - E_{1}\left( 1 - \dfrac{\vartheta^{2}}{2} \right)}{1 - E_{1}}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]

Svolgendo i prodotti, si ottiene:

\[M_{\bot}(\vartheta) \simeq \dfrac{M_{0}\vartheta}{\dfrac{1 - E_{1} + E_{1}\dfrac{\vartheta^{2}}{2}}{1 - E_{1}}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]

Grazie alla proprietà distributiva del prodotto, si ha:

\[M_{\bot}(\vartheta) \simeq \dfrac{M_{0}\vartheta}{\dfrac{1 - E_{1}}{1 - E_{1}} + \dfrac{E_{1}}{1 - E_{1}}\dfrac{\vartheta^{2}}{2}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]

Per cui:

\[M_{\bot}(\vartheta) \simeq \dfrac{M_{0}\vartheta}{1 + \dfrac{E_{1}}{1 - E_{1}}\dfrac{\vartheta^{2}}{2}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right)\]
...
\[E_{1} \simeq 1 - \dfrac{T_{R}}{T_{1}}\]

Sostituendo, si ottiene:

\[M_{\bot}(\vartheta) \simeq \dfrac{M_{0}\vartheta}{1 + \dfrac{1 - \dfrac{T_{R}}{T_{1}}}{1 - \left( 1 - \dfrac{T_{R}}{T_{1}} \right)}\dfrac{\vartheta^{2}}{2}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right) =\]

Si considera solamente il denominatore. Svolgendo le operazioni di somme:

\[1 + \dfrac{1 - \dfrac{T_{R}}{T_{1}}}{1 - \left( 1 - \dfrac{T_{R}}{T_{1}} \right)}\dfrac{\vartheta^{2}}{2} = 1 + \dfrac{1 - \dfrac{T_{R}}{T_{1}}}{1 - 1 + \dfrac{T_{R}}{T_{1}}}\dfrac{\vartheta^{2}}{2} = 1 + \dfrac{1 - \dfrac{T_{R}}{T_{1}}}{\dfrac{T_{R}}{T_{1}}}\dfrac{\vartheta^{2}}{2} =\]

Da cui:

\[= 1 + \left( \dfrac{T_{1}}{T_{R}} - 1 \right)\dfrac{\vartheta^{2}}{2}\]

Per l'ipotesi \(T_{R} \ll T_{1}\) risulta che \(T_{1} \gg T_{R}\), per cui è possibile trascurare l'unità:

\[1 + \left( \dfrac{T_{1}}{T_{R}} - 1 \right)\dfrac{\vartheta^{2}}{2} \simeq 1 + \dfrac{T_{1}}{T_{R}}\dfrac{\vartheta^{2}}{2}\]
...
\[\vartheta_{E}^{- 2} \simeq \dfrac{1}{2}\dfrac{T_{1}}{T_{R}}\]

Sostituendo nel denominatore della magnetizzazione trasversale si ha:

\[1 + \dfrac{T_{1}}{T_{R}}\dfrac{\vartheta^{2}}{2} \simeq 1 + \dfrac{\vartheta^{2}}{\vartheta_{E}^{2}}\]

La componente trasversale del vettore di magnetizzazione si scrive come:

\[M_{\bot}(\vartheta) \simeq \dfrac{M_{0}\vartheta}{1 + \dfrac{\vartheta^{2}}{\vartheta_{E}^{2}}}\exp\left( - \dfrac{t_{n}}{T_{2}} \right) =\]
...
\[M_{z}(n) = \sum_{l = 0}^{n - 1}\left\lbrack \left( E_{1}\cos\vartheta \right)^{l}\left( 1 - E_{1} \right)M_{0} \right\rbrack + M_{0}\left( E_{1}\cos\vartheta \right)^{n} = M_{0}\left( 1 - E_{1} \right)\dfrac{1 - \left( E_{1}\cos\vartheta \right)^{n}}{1 - E_{1}\cos\vartheta} + M_{0}E_{1}^{2n}\]
...
\[\left. \ M_{z}(n) \right|_{\vartheta = \vartheta_{E}} = M_{0}\left( 1 - E_{1} \right)\dfrac{1 - \left( E_{1}\cos\vartheta_{E} \right)^{n}}{1 - E_{1}\cos\vartheta_{E}} + M_{0}E_{1}^{2n}\]

Dove \(\vartheta_{E} = \arccos\left( E_{1} \right)\). Sostituendo questa relazione si ottiene:

\[\left. \ M_{z}(n) \right|_{\vartheta = \vartheta_{E}} = M_{0}\left( 1 - E_{1} \right)\dfrac{1 - \left( E_{1}\cos\left( \arccos\left( E_{1} \right) \right) \right)^{n}}{1 - E_{1}\cos\left( \arccos\left( E_{1} \right) \right)} + M_{0}E_{1}^{2n}\]

Per cui:

\[\left. \ M_{z}(n) \right|_{\vartheta = \vartheta_{E}} = M_{0}\left( 1 - E_{1} \right)\dfrac{1 - \left( E_{1}^{2} \right)^{n}}{1 - E_{1}^{2}} + M_{0}E_{1}^{2n}\]
...
\[\left. \ M_{z}(n) \right|_{\vartheta = \vartheta_{E}} = M_{0}\dfrac{1 - E_{1}^{2n}}{1 + E_{1}} + M_{0}E_{1}^{2n}\]

Per valutare lo stato stazionario si passa al limite per \(n \rightarrow \infty\) di questa lezione:

\[\lim_{n \rightarrow \infty}\left. \ M_{z}(n) \right|_{\vartheta = \vartheta_{E}} = \lim_{n \rightarrow \infty}\left( M_{0}\dfrac{1 - E_{1}^{2n}}{1 + E_{1}} + M_{0}E_{1}^{2n} \right)\]

I termini

\[E_{1}^{2n} = \exp\left( - \dfrac{2nT_{R}}{T_{1}} \right) \rightarrow 0,n \rightarrow \infty\]

Per cui si ottiene:

\[\lim_{n \rightarrow \infty}\left. \ M_{z}(n) \right|_{\vartheta = \vartheta_{E}} = \lim_{n \rightarrow \infty}\left( M_{0}\dfrac{1 - E_{1}^{2n}}{1 + E_{1}} + M_{0}E_{1}^{2n} \right) = M_{0}\dfrac{1}{1 + E_{1}} = M_{ze}\]
...
\[\alpha = \dfrac{M_{z}\left( n,\vartheta_{E} \right) - M_{ze}\left( \vartheta_{E} \right)}{M_{ze}\left( \vartheta_{E} \right)}\]

Dove:

\[M_{ze}\left( \vartheta_{E} \right) = \dfrac{M_{0}}{1 + E_{1}}\]

\[M_{z}\left( n,\vartheta_{E} \right) = M_{0}\dfrac{1 - E_{1}^{2n}}{1 + E_{1}} + M_{0}E_{1}^{2n}\]
...
\[\alpha = \dfrac{M_{z}\left( n,\vartheta_{E} \right) - M_{ze}\left( \vartheta_{E} \right)}{M_{ze}\left( \vartheta_{E} \right)} = \dfrac{M_{0}\dfrac{1 - E_{1}^{2n}}{1 + E_{1}} + M_{0}E_{1}^{2n} - \dfrac{M_{0}}{1 + E_{1}}}{\dfrac{M_{0}}{1 + E_{1}}}\]

Si considera il numeratore e si applica la proprietà distributiva del prodotto:

\[M_{0}\dfrac{1 - E_{1}^{2n}}{1 + E_{1}} + M_{0}E_{1}^{2n} - \dfrac{M_{0}}{1 + E_{1}} = \dfrac{M_{0}}{1 + E_{1}} - \dfrac{M_{0}E_{1}^{2n}}{1 + E_{1}} + M_{0}E_{1}^{2n} - \dfrac{M_{0}}{1 + E_{1}} =\]

Semplificando, si ottiene:

\[= M_{0}E_{1}^{2n} - \dfrac{M_{0}E_{1}^{2n}}{1 + E_{1}} =\]

Raccogliendo i termini comuni, si ottiene:

\[= M_{0}E_{1}^{2n}\left( 1 - \dfrac{1}{1 + E_{1}} \right) =\]

Applicando il minimo comune multiplo si ottiene:

\[= M_{0}E_{1}^{2n}\left( \dfrac{1 + E_{1} - 1}{1 + E_{1}} \right) = M_{0}E_{1}^{2n}\left( \dfrac{E_{1}}{1 + E_{1}} \right)\]

Sostituendo questo risultato nell'espressione dell'errore relativo, \(\alpha\), si ottiene:

\[\alpha = \dfrac{M_{0}\dfrac{1 - E_{1}^{2n}}{1 + E_{1}} + M_{0}E_{1}^{2n} - \dfrac{M_{0}}{1 + E_{1}}}{\dfrac{M_{0}}{1 + E_{1}}} = \dfrac{M_{0}E_{1}^{2n}\left( \dfrac{E_{1}}{1 + E_{1}} \right)}{\dfrac{M_{0}}{1 + E_{1}}}\]
...
\[M_{z}(n) = M_{0}\left( 1 - E_{1} \right)\dfrac{1 - \left( E_{1}\cos\vartheta \right)^{n}}{1 - E_{1}\cos\vartheta} + M_{0}E_{1}^{2n}\]
...
\[s\left( \vartheta,T_{E} \right) = \rho_{0}\sin\vartheta\dfrac{1 - E_{1}}{1 - E_{1}\cos\vartheta}\exp\left( - \dfrac{T_{E}}{T_{2}^{*}} \right)\]
...
\[E_{2} = \exp\left( - \dfrac{T_{R}}{T_{2}} \right) \simeq 1,T_{R} \ll T_{2}\]

Il segnale del voxel, contenente il tessuto di interesse, può essere approssimato come:

\[s(\vartheta) \simeq \rho_{0}\sin\vartheta\dfrac{1 - E_{1}}{1 - E_{1}\cos\vartheta}\]
...
\[s\left( \vartheta,T_{1},\rho_{0} \right) = \rho_{0}\sin\vartheta\dfrac{1 - E_{1}}{1 - E_{1}\cos\vartheta}\]
...
\[\left( 1 - E_{1}\cos\vartheta \right)\dfrac{s\left( \vartheta,T_{1},\rho_{0} \right)}{\sin\vartheta} = \left( 1 - E_{1} \right)\rho_{0}\]

Si svolgono i prodotti al primo membro:

\[\dfrac{s\left( \vartheta,T_{1},\rho_{0} \right)}{\sin\vartheta} - E_{1}\cos\vartheta\dfrac{s\left( \vartheta,T_{1},\rho_{0} \right)}{\sin\vartheta} = \left( 1 - E_{1} \right)\rho_{0}\]

Il rapporto tra il seno e il coseno coincide con la tangente dell'angolo, per cui:

\[\dfrac{s\left( \vartheta,T_{1},\rho_{0} \right)}{\sin\vartheta} - E_{1}s\left( \vartheta,T_{1},\rho_{0} \right)\dfrac{\cos\vartheta}{\sin\vartheta} = \left( 1 - E_{1} \right)\rho_{0}\]

Dove:

\[\dfrac{\cos\vartheta}{\sin\vartheta} = \cot\vartheta = \dfrac{1}{\tan\vartheta}\]

Da cui:

\[\Longleftrightarrow \dfrac{s\left( \vartheta,T_{1},\rho_{0} \right)}{\sin\vartheta} - E_{1}\dfrac{s\left( \vartheta,T_{1},\rho_{0} \right)}{\tan\vartheta} = \left( 1 - E_{1} \right)\rho_{0}\]

Si porta al secondo membro i termini dipendenti da \(E_{1}\):

\[\dfrac{s\left( \vartheta,T_{1},\rho_{0} \right)}{\sin\vartheta} = \left( 1 - E_{1} \right)\rho_{0} + E_{1}\dfrac{s\left( \vartheta,T_{1},\rho_{0} \right)}{\tan\vartheta}\]
...
\[\left\{ \begin{matrix}
y = \dfrac{s\left( \vartheta,T_{1},\rho_{0} \right)}{\sin\vartheta} \\
x = \dfrac{s\left( \vartheta,T_{1},\rho_{0} \right)}{\tan\vartheta}
\end{matrix} \right.\ \]
...
\[\left\{ \begin{matrix}
y_{k} = \dfrac{s_{k}}{\sin\vartheta_{k}} \\
x_{k} = \dfrac{s_{k}}{\tan\vartheta_{k}}
\end{matrix} \right.\ \]
