...
\subsection{\texorpdfstring{Pesatura in \(\mathbf{T}_{\mathbf{1}}\) con sequenza short-\(\mathbf{T}_{\mathbf{R}}\) steady state}{Pesatura in \textbackslash mathbf\{T\}\_\{\textbackslash mathbf\{1\}\} con sequenza short-\textbackslash mathbf\{T\}\_\{\textbackslash mathbf\{R\}\} steady state}}\label{pesatura-in-mathbft_mathbf1-con-sequenza-short-mathbft_mathbfr-steady-state}
...
\subsection{\texorpdfstring{Pesatura in densità protonica con sequenza short-\(\mathbf{T}_{\mathbf{R}}\) steady state}{Pesatura in densità protonica con sequenza short-\textbackslash mathbf\{T\}\_\{\textbackslash mathbf\{R\}\} steady state}}\label{pesatura-in-densituxe0-protonica-con-sequenza-short-mathbft_mathbfr-steady-state}
...
\subsection{\texorpdfstring{Vantaggi e svantaggi della sequenza short-\(\mathbf{T}_{\mathbf{R}}\) steady state}{Vantaggi e svantaggi della sequenza short-\textbackslash mathbf\{T\}\_\{\textbackslash mathbf\{R\}\} steady state}}\label{vantaggi-e-svantaggi-della-sequenza-short-mathbft_mathbfr-steady-state}
...
\subsection{\texorpdfstring{Applicazione della short-\(\mathbf{T}_{\mathbf{R}}\) inchoerent gradient-echo}{Applicazione della short-\textbackslash mathbf\{T\}\_\{\textbackslash mathbf\{R\}\} inchoerent gradient-echo}}\label{applicazione-della-short-mathbft_mathbfr-inchoerent-gradient-echo}
...
\subsection{\texorpdfstring{Stima del tempo \(\mathbf{T}_{\mathbf{1}}\) mediante variazioni del flip angle}{Stima del tempo \textbackslash mathbf\{T\}\_\{\textbackslash mathbf\{1\}\} mediante variazioni del flip angle}}\label{stima-del-tempo-mathbft_mathbf1-mediante-variazioni-del-flip-angle}
...
\subsubsection{\texorpdfstring{Linearizzazione del problema NLS per stima di \(\mathbf{\rho}_{\mathbf{0}}\) e \(\mathbf{T}_{\mathbf{1}}\)}{Linearizzazione del problema NLS per stima di \textbackslash mathbf\{\textbackslash rho\}\_\{\textbackslash mathbf\{0\}\} e \textbackslash mathbf\{T\}\_\{\textbackslash mathbf\{1\}\}}}\label{linearizzazione-del-problema-nls-per-stima-di-mathbfrho_mathbf0-e-mathbft_mathbf1}
