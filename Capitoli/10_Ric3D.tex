...
\[= \frac{1}{2}\cos(\xi - \phi) - \frac{1}{2}\cos\left( 2\omega_{0}t + \phi + \xi \right)\]
...
\[= \frac{1}{2}\sin(\xi - \phi) + \frac{1}{2}\sin\left( 2\omega_{0}t + \phi + \xi \right)\]
...
\[s(k) \propto \frac{1}{2}\cos(\xi - \phi) + j\frac{1}{2}\sin(\xi - \phi) =\]

Applicando le relazioni trigonometriche si ottiene:

\[= \frac{1}{2}\left\lbrack \left( \cos\xi\cos\phi + \sin\xi\sin\phi \right) + j\left( \sin\xi\cos\phi - \cos\xi\sin\phi \right) \right\rbrack =\]

Raccogliendo \(\cos\xi\) e \(\sin\xi\), si ottiene:

\[= \frac{1}{2}\left\lbrack \cos\xi\left( \cos\phi - j\sin\phi \right) + \sin\xi\left( \sin\phi + j\cos\phi \right) \right\rbrack =\]

Nel termine \(\sin\phi + j\cos\phi\) si mette in evidenza \(j\):

\[= \frac{1}{2}\left\lbrack \cos\xi\left( \cos\phi - j\sin\phi \right) + j\sin\xi\left( \cos\phi - j\sin\phi \right) \right\rbrack =\]

Per le formule di Eulero, si ottiene:

\[= \frac{1}{2}\left\lbrack \cos\xi\exp( - j\phi) + j\sin\xi\exp( - j\phi) \right\rbrack =\]

Raccogliendo \(\exp( - j\phi)\) e applicando le formule di Eulero, si ottiene:

\[= \frac{1}{2}\exp( - j\phi)\exp(j\xi)\]
...
\[= \int_{}^{}{s^{*}\left( \overset{\underline{}}{k} \right)\exp\left( j\frac{\pi}{2} \right)\exp(j2\pi kx)dk} =\]

Per le proprietà del complesso coniugato è possibile scrivere:

\[= \left\lbrack \int_{}^{}{s\left( \overset{\underline{}}{k} \right)\exp\left( - j\frac{\pi}{2} \right)\exp( - j2\pi kx)dk} \right\rbrack^{*}\]

Per definizione di antitrasformata di Fourier, si ha:

\[\widehat{\rho}(x) = \widehat{\rho}( - x)\exp\left( - j\frac{\pi}{2} \right)\]
...
\[\left| \widehat{\rho}(x) \right| = \left| \widehat{\rho}( - x)\exp\left( - j\frac{\pi}{2} \right) \right| = \left| \widehat{\rho}( - x) \right|\]
...
\[s_{R} \propto \sin\left( \omega_{0}t + \xi \right)\cos(\omega t) = \frac{1}{2}\sin\left\lbrack \left( \omega_{0} - \omega \right)t + \xi \right\rbrack + \frac{1}{2}\sin\left\lbrack \left( \omega_{0} + \omega \right)t + \xi \right\rbrack\]

Per il canale immaginario, invece, risulta:

\[s_{I} \propto \sin\left( \omega_{0}t + \xi \right)\sin(\omega t) = \frac{1}{2}\cos\left\lbrack \left( \omega_{0} - \omega \right)t + \xi \right\rbrack - \frac{1}{2}\cos\left\lbrack \left( \omega_{0} + \omega \right)t + \xi \right\rbrack\]

Il segnale \(s(k)\) nel \(k\)-spazio, dopo la moltiplicazione con le oscillazioni, può essere scritto come:

\[s(k) \propto \frac{1}{2}\sin\left\lbrack \left( \omega_{0} - \omega \right)t + \xi \right\rbrack + \frac{1}{2}\sin\left\lbrack \left( \omega_{0} + \omega \right)t + \xi \right\rbrack + j\frac{1}{2}\cos\left\lbrack \left( \omega_{0} - \omega \right)t + \xi \right\rbrack - j\frac{1}{2}\cos\left\lbrack \left( \omega_{0} + \omega \right)t + \xi \right\rbrack\]

A valle del filtro passa-basso, le frequenze a \(\omega_{0} + \omega\) sono rimosse, per cui si ottiene:

\[s(k) \propto \frac{1}{2}\sin\left\lbrack \left( \omega_{0} - \omega \right)t + \xi \right\rbrack + j\frac{1}{2}\cos\left\lbrack \left( \omega_{0} - \omega \right)t + \xi \right\rbrack\]

Dove \(\omega_{0} - \omega = \Delta\omega\):

\[s(k) \propto \frac{1}{2}\sin(\Delta\omega t + \xi) + j\frac{1}{2}\cos(\Delta\omega t + \xi)\]

Si raccoglie \(j\) per applicare le formule di Eulero:

\[\frac{1}{2}\sin(\Delta\omega t + \xi) + j\frac{1}{2}\cos(\Delta\omega t + \xi) = j\frac{1}{2}\left\lbrack \cos(\Delta\omega t + \xi) - j\sin(\Delta\omega t + \xi) \right\rbrack\]

Per le formule di Eulero, si può scrivere:

\[s(k) \propto \frac{1}{2}\exp( - j\Delta\omega t)\exp\left( - j\frac{\pi}{2} - j\xi \right)\]
...
\[x_{0} = \frac{\Delta\omega t}{2\pi k}\]
...
\[\widehat{p}(x) = \int_{}^{}{s(k)\exp\left\lbrack j2\pi k\left( x - x_{0} \right) \right\rbrack dk} = \widehat{p}\left( x - x_{0} \right) = \widehat{p}\left( x - \frac{\Delta\omega t}{2\pi k} \right)\]
...
\[\phi(x) = \arctan\left( \frac{Im\left\{ \widehat{\rho}(x) \right\}}{Re\{\widehat{\rho}(x)\}} \right)\]
...
\[s(k) + s( - k) = s(k) + s^{*}(k) = 2Re\left\{ s(k) \right\} = 2s_{R} \Leftrightarrow s_{R} = \frac{s(k) + s( - k)}{2}\]

\[s(k) - s( - k) = s(k) - s^{*}(k) = 2jIm\left\{ s(k) \right\} = 2s_{I} \Leftrightarrow s_{I} = \frac{s(k) - s( - k)}{2j}\]

Applicando la relazione per \(s_{I}\) nella relazione per \(\widehat{\rho}(x)\) e ricordando che \(s_{R} + js_{I} = s(k)\), è possibile scrivere:

\[\widehat{\rho}(x) = \int_{}^{}{\left\lbrack s_{R} + js_{I} + j(\delta - 1)s_{I} \right\rbrack\exp(j2\pi kx)dk} = \int_{}^{}{\left\lbrack s(k) + j(\delta - 1)\frac{s(k) - s( - k)}{2j} \right\rbrack\exp(j2\pi kx)dk} = \int_{}^{}{\left\lbrack s(k) + (\delta - 1)\frac{s(k) - s( - k)}{2} \right\rbrack\exp(j2\pi kx)dk}\]

Svolgendo i prodotti si ottiene:

\[= \int_{}^{}{\left\lbrack s(k) + \frac{1}{2}(\delta - 1)s(k) - \frac{1}{2}(\delta - 1)s( - k) \right\rbrack\exp(j2\pi kx)dk}\]

Da cui:

\[\widehat{\rho}(x) = \int_{}^{}{\left\lbrack \left( 1 + \frac{\delta - 1}{2} \right)s(k) - \frac{1}{2}(\delta - 1)s( - k) \right\rbrack\exp(j2\pi kx)dk} = \widehat{\rho}(x) =\]

Da cui:

\[\widehat{\rho}(x) = \int_{}^{}{\left\lbrack \frac{1}{2}(\delta + 1)s(k) - \frac{1}{2}(\delta - 1)s( - k) \right\rbrack\exp(j2\pi kx)dk}\]
...
\[\widehat{\rho}(x) = \frac{1}{2}(1 + \delta)\widehat{\rho}(x) - \frac{1}{2}(1 - \delta)\widehat{\rho}( - x)\]
...
\[\widehat{\rho}(x) = \int_{}^{}{\left\lbrack \delta\left( \frac{s(k) + s( - k)}{2} \right) + j\frac{s(k) - s( - k)}{2j} \right\rbrack\exp(j2\pi kx)dk} = \int_{}^{}{\left\lbrack \delta\left( \frac{s(k) + s( - k)}{2} \right) + \frac{s(k) - s( - k)}{2} \right\rbrack\exp(j2\pi kx)dk} = \int_{}^{}{\left\lbrack \frac{\delta}{2}s(k) + \frac{\delta}{2}s( - k) + \frac{1}{2}s(k) - \frac{1}{2}s( - k) \right\rbrack\exp(j2\pi kx)dk} = \frac{\delta}{2}\widehat{\rho}(x) + \frac{\delta}{2}\widehat{\rho}( - x) + \frac{1}{2}\widehat{\rho}(x) - \frac{1}{2}\widehat{\rho}( - x) = \frac{1}{2}(1 + \delta)\widehat{\rho}(x) + \frac{1}{2}(\delta - 1)\widehat{\rho}( - x)\]
...
\[\frac{d}{dx}\rho(x) \rightarrow j2\pi k\ s(k)\]
...
\[\int_{}^{}{\rho(x)dx} \rightarrow \frac{1}{j2\pi k}s(k)\]
...
\[U(x) = \mathfrak{F}^{- 1}\left\lbrack u(k) \right\rbrack = \sum_{q = - \infty}^{+ \infty}{\delta\left( x - \frac{q}{\Delta k_{R}} \right)}\]

La densità protonica ricostruita si può scrivere come:

\[{\widehat{\rho}}_{\infty}(x) = \mathfrak{F}^{- 1}\left\lbrack s_{\infty}(k) \right\rbrack*\mathfrak{F}^{- 1}\left\lbrack u(k) \right\rbrack = \rho(x)*U(x) = \ \rho(x)*\sum_{q = - \infty}^{+ \infty}{\delta\left( x - \frac{q}{\Delta k_{R}} \right)}\]

Per l proprietà di campionamento della \(\delta\), è possibile scrivere:

\[{\widehat{\rho}}_{\infty}(x) = \sum_{q = - \infty}^{+ \infty}{\rho(x)*\delta\left( x - \frac{q}{\Delta k_{R}} \right)} = \sum_{q = - \infty}^{+ \infty}{\rho\left( \frac{q}{\Delta k_{R}} \right)\delta\left( x - \frac{q}{\Delta k_{R}} \right)}\]
...
\[FOV_{R} \geq \frac{1}{\Delta k_{R}} \geq A_{R} \Leftrightarrow \Delta k_{R} \leq \frac{1}{A_{R}}\]
...
\[FOV_{R} \geq \frac{1}{\Delta k_{R}} \geq A_{R} \Leftrightarrow \Delta k_{R} \leq \frac{1}{A_{R}} \Leftrightarrow \overline{\gamma}G_{R}\Delta t \leq \frac{1}{A_{R}}\]

Passando ai reciproci:

\[\frac{1}{\overline{\gamma}G_{R}\Delta t} \geq A_{R}\]

Si isola \(1/\Delta t\):

\[\frac{1}{\Delta t} \geq \overline{\gamma}G_{R}A_{R}\]
...
\[\frac{1}{L_{R}} = \overline{\gamma}G_{R}\frac{1}{{BW}_{R}}\ \]
...
\[{FOV}_{PE} = L_{PE} = \frac{1}{\Delta k_{PE}}\]
...
\[{FOV}_{PE} = \frac{1}{\overline{\gamma}\Delta G_{PE}\tau_{PE}} \geq A_{PE}\]
...
\[{BW}_{PE} = \frac{1}{\Delta G_{PE}} \geq A_{PE}\]
...
\[s_{m}(k) = s_{\infty}(k)rect\left( \frac{k + \frac{\Delta k}{2}}{W} \right)\]

\(s_{\infty}(k)\) è dato dalla moltiplicazione del segnale originale per il treno di impulsi di Dirac:

\[s_{m}(k) = s(k)u(k)rect\left( \frac{k + \frac{\Delta k}{2}}{W} \right)\]
...
\[s_{m}(k) = \Delta k_{R}\left\lbrack \sum_{p = - \infty}^{+ \infty}{s\left( p\Delta k_{R} \right)\delta\left( k - p\Delta k_{R} \right)} \right\rbrack rect\left( \frac{k + \frac{\Delta k}{2}}{W} \right) = \Delta k_{R}\sum_{p = - n}^{n - 1}{s\left( p\Delta k_{R} \right)\delta\left( k - p\Delta k_{R} \right)}\]
...
\[\widehat{\rho}(x) = \mathfrak{F}^{- 1}\left\lbrack s_{\infty}(k) \right\rbrack*\mathfrak{F}^{- 1}\left\lbrack u(k) \right\rbrack*\mathfrak{F}^{- 1}\left\lbrack rect\left( \frac{k + \frac{\Delta k}{2}}{W} \right) \right\rbrack\]

Dove l'antitrasformata dalla finestra di troncamento corrisponde a una \(sinc\):

\[\mathfrak{F}^{- 1}\left\lbrack rect\left( \frac{k + \frac{\Delta k}{2}}{W} \right) \right\rbrack = Wsinc(\pi Wx)\exp{\left( - j2\pi\frac{\Delta k}{2}x\  \right)\ }\]

La \(sinc\) presenta il primo zero in \(x = \pm W^{- 1}\).

Nel dominio dello spazio-immagine, la densità protonica ricostruita è data da:

\[\widehat{\rho}(x) = \rho(x)*\sum_{q = - \infty}^{+ \infty}{\delta\left( x - \frac{q}{\Delta k_{R}} \right)}*Wsinc(\pi Wx)\exp{\left( - j2\pi\frac{\Delta k}{2}x\  \right)\ }\]
...
\[\widehat{\rho}(x) = {\widehat{\rho}}_{\infty}(x)*Wsinc(\pi Wx)\exp{\left( - j2\pi\frac{\Delta k}{2}x\  \right)\ }\]
...
\[f_{R} = \overline{\gamma}G_{R}A_{R} = 42.6\frac{MHz}{T}10\frac{mT}{m}0.5\ m = 42.6 \cdot 10^{6}\frac{Hz}{T}10 \cdot 10^{- 3}\frac{T}{m}0.5\ m = 213\ kHz\]

Se il gradiente di lettura raddoppia, anche la banda minima del senale raddoppia:

\[f_{R} = \overline{\gamma}2G_{R}A_{R} = 42.6 \cdot 10^{6}\frac{Hz}{T}2 \cdot 10 \cdot 10^{- 3}\frac{T}{m}0.5\ m = 426\ kHz\]
...
\[rect\left( \frac{x + \frac{1}{2}\Delta x}{L} \right)\]
...
\[{\widehat{\rho}}_{m}(x) = \widehat{\rho}(x)\widetilde{U}(x)\ rect\left( \frac{x + \frac{1}{2}\Delta x}{L} \right)\]

Si esplicita il termine di campionamento:

\[{\widehat{\rho}}_{m}(x) = \widehat{\rho}(x)\Delta x\sum_{q = - \infty}^{+ \infty}{\delta(x - q\Delta x)}rect\left( \frac{x + \frac{1}{2}\Delta x}{L} \right)\]
...
\[L = 2n\Delta x \Leftrightarrow \Delta x = \frac{L}{2n}\]

Il prodotto \(\Delta k\Delta x\) può, quindi, essere scritto come:

\[\Delta k\Delta x = \frac{1}{L}\frac{L}{2n} = \frac{1}{2n}\]
...
\[\widehat{s}\left( \frac{r}{L} \right) = \frac{1}{2n}\sum_{q = - n}^{n + 1}\left\{ \sum_{p = - n}^{n - 1}\left\lbrack s\left( \frac{p}{L} \right)\exp\left( j2\pi q\frac{p - r}{2n} \right) \right\rbrack \right\}\]

Per la linearità, si ha:

\[\widehat{s}\left( \frac{r}{L} \right) = \frac{1}{2n}\sum_{q = - n}^{n + 1}\left\{ s\left( \frac{p}{L} \right)\sum_{p = - n}^{n - 1}\left\lbrack \exp\left( j2\pi q\frac{p - r}{2n} \right) \right\rbrack \right\}\]

È noto che

\[\sum_{p = - n}^{n - 1}\left\lbrack \exp\left( j2\pi q\frac{p - r}{2n} \right) \right\rbrack = 2n\delta_{pr}\]
...
\[\widehat{s}\left( \frac{r}{L} \right) = \frac{1}{2n}2n\sum_{q = - n}^{n + 1}\left\lbrack s\left( \frac{p}{L} \right)\delta_{pr} \right\rbrack = \sum_{q = - n}^{n + 1}\left\lbrack s\left( \frac{p}{L} \right)\delta_{pr} \right\rbrack\]
...
\[\left\{ \begin{matrix}
s\left( \frac{p}{L} \right) = \Delta x\sum_{q = - n}^{n - 1}{\widehat{\rho}\left( q\frac{L}{2n} \right)\exp\left( - j2\pi\frac{pq}{2n} \right)} \\
s\left( q\frac{L}{2n} \right) = \Delta k\sum_{q = - n}^{n - 1}{s\left( \frac{p}{L} \right)\exp\left( j2\pi\frac{pq}{2n} \right)}
\end{matrix} \right.\ \]
...
\[\Delta t_{R} = \frac{T_{S}}{N_{R}}\]

La banda di ricezione minima è, dunque:

\[BW_{R} = \frac{1}{\Delta t_{R}} = \frac{N_{R}}{T_{S}} = \frac{256}{5.12 \cdot 10^{- 3}\ s} = 50\ kHz\]

L'intervallo di campionamento è, invece:

\[\Delta t_{R} = \frac{T_{S}}{N_{R}} = \frac{10^{- 3}s}{256} = 0.02\ ms\]
...
\[BW_{R} = \overline{\gamma}G_{R}L_{R} \Leftrightarrow G_{R} = \frac{BW_{R}}{\overline{\gamma}L_{R}}\]

Numericamente, si scrive:

\[G_{R} = \frac{BW_{R}}{\overline{\gamma}L_{R}} = \frac{50 \cdot 10^{3}Hz}{42.6 \cdot 10^{6}\frac{Hz}{T} \cdot 256 \cdot 10^{- 3}m} = 4.58\frac{mT}{m}\]

L'intervallo di campionamento lungo l'asse di lettura è:

\[\Delta k_{R} = \frac{1}{L_{R}} = \frac{1}{256\ mm} = 3.9\ m^{- 1}\]

Analogamente, per l'asse di codifica di fase, il campionamento avviene con passo:

\[\Delta k_{PE} = \frac{1}{L_{PE}} = \frac{1}{256\ mm} = 3.9\ m^{- 1}\]

La variazione del gradiente lungo l'asse di codifica di fase, tra una sequenza e l'altra, è dato da:

\[\Delta k_{PE} = \overline{\gamma}\Delta G_{PE}\tau_{PE} \Leftrightarrow \ \Delta G_{PE} = \frac{\Delta k_{PE}}{\overline{\gamma}\tau_{PE}}\]

Numericamente:

\[\Delta G_{PE} = \frac{\Delta k_{PE}}{\overline{\gamma}\tau_{PE}} = \frac{3.9\frac{1}{m}}{42.6 \cdot 10^{6}\frac{Hz}{T} \cdot 256 \cdot 10^{- 3}m} = 0.036\frac{mT}{m}\]
...
\[\Delta G_{\max} = \Delta G_{PE}\frac{N_{PE}}{2}\]

Numericamente, si scrive:

\[\Delta G_{\max} = \Delta G_{PE}\frac{N_{PE}}{2} = 0.036 \cdot 10^{- 3}\frac{T}{m} \cdot \frac{256}{2} = 4.57\frac{mT}{m}\]

Il gradiente di selezione della fetta è legato allo spessore della fetta, \(TH\), tramite la relazione:

\[TH = \frac{BW_{rf}}{\overline{\gamma}G_{SS}} \Leftrightarrow G_{SS} = \frac{BW_{rf}}{\overline{\gamma}TH}\]

Numericamente, si ha:

\[G_{SS} = \frac{BW_{rf}}{\overline{\gamma}TH} = \frac{2\ kHz}{42.6 \cdot 10^{6}\frac{Hz}{T} \cdot 3 \cdot 10^{- 3}\ m} = 9.38\frac{mT}{m}\]
...
\[G_{R} = \frac{BW_{R}}{\overline{\gamma}L_{R}}\]

Per definizione di \(BW_{R} = N_{R}/T_{S}\), si ha:

\[G_{R} = \frac{N_{R}}{\overline{\gamma}L_{R}T_{S}}\]
...
\[G_{PE,max} = \Delta G_{PE}\frac{N_{PE}}{2}\]
...
\[G_{SS} = \left. \ \frac{BW_{rf}}{\overline{\gamma}TH} \right|_{TH = \frac{TH}{2}} = 2\frac{BW_{rf}}{\overline{\gamma}TH}\]
...
\[G_{R} = \left. \ \frac{BW_{R}}{\overline{\gamma}L_{R}} \right|_{L_{R} = \frac{L_{R}}{2}} = 2\frac{BW_{R}}{\overline{\gamma}L_{R}}\]
...
\[G_{R} = \frac{N_{R}}{\overline{\gamma}L_{R}T_{S}} = \frac{256}{42.6 \cdot 10^{6}\frac{Hz}{T} \cdot 256 \cdot 10^{- 3}m \cdot 2.56 \cdot 10^{- 3}s} = 9.2\frac{mT}{m}\]

Il valore del gradiente di selezione della fetta è dato da:

\[G_{SS} = \frac{BW_{rf}}{\overline{\gamma}TH} = \frac{2\ kHz}{42.6 \cdot 10^{6}\frac{Hz}{T}36 \cdot 10^{- 3}m} = 1.3\frac{mT}{m}\]

Il passo di campionamento lungo l'asse di \emph{slice selection} è dato da:

\[\Delta k_{SS} = \overline{\gamma}\Delta G_{SS}\tau_{SS} \Leftrightarrow \ \Delta G_{SS} = \frac{\Delta k_{SS}}{\overline{\gamma}\tau_{SS}}\]

Dove \(\Delta k_{SS} = 1/L_{SS}\), ovvero:

\[\Delta k_{SS} = \frac{1}{L_{SS}} = \frac{1}{32 \cdot 10^{- 3}m} = 31.3\ m^{- 1}\]
...
\[\ \Delta G_{SS} = \frac{\Delta k_{SS}}{\overline{\gamma}\tau_{SS}} = \frac{31.3\ m^{- 1}}{42.6 \cdot 10^{6}\frac{Hz}{T}256 \cdot 10^{- 3}m} = 2.87\frac{\mu T}{m}\]

Il gradiente massimo applicato lungo la direzione di selezione della fetta è dato da:

\[G_{SS,max} = \Delta G_{SS}N_{SS} = 16 \cdot 2.87\frac{\mu T}{m} = 45.9\frac{\mu T}{m}\]
...
\[L \geq A,\Delta k = \frac{1}{L}\]

Risulta:

\[\Delta k \leq \frac{1}{A}\]
...
\[W = N\Delta k \Leftrightarrow W \leq \frac{N}{A}\]
...
\[{\widehat{\rho}}_{m}(x) = {\widehat{\rho}}_{\infty}(x)*U(x)*Wsinc(\pi Wx)\exp{\left( - j2\pi\frac{\Delta k}{2}x\  \right)\ }\]

Nel \(k\)-spazio la relazione può essere espressa come:

\[s_{m}(k) = s_{\infty}(k)u(k)rect\left( \frac{k + \frac{\Delta k}{2}}{W} \right)\]
...
\[H(k) = u(k)rect\left( \frac{k + \frac{\Delta k}{2}}{W} \right)\]
...
\[H_{W}(k) = rect\left( \frac{k + \frac{\Delta k}{2}}{W} \right)\]
...
\[H_{WS}(k) = \Delta k\sum_{p = - \infty}^{+ \infty}{\delta(k - p\Delta k)}rect\left( \frac{k + \frac{\Delta k}{2}}{W} \right)\]
...
\[\widehat{\rho}(x) = \int_{- \infty}^{+ \infty}{s_{\infty}(k)\left\lbrack \Delta k\sum_{p = - \infty}^{+ \infty}{\delta(k - p\Delta k)}rect\left( \frac{k + \frac{\Delta k}{2}}{W} \right) \right\rbrack\exp(j2\pi kx)dk}\]
...
\[h_{WS}(x) = \ \Delta k\sum_{p = - n}^{n - 1}{\exp(j2\pi p\Delta kx)} = \Delta k\exp( - j2\pi n\Delta kx)\frac{1 - \exp(j4\pi n\Delta kx)}{1 - \exp(j2\pi\Delta kx)}\]
...
\[h_{WS}(x) = \Delta k\frac{1 - \exp(j4\pi n\Delta kx)}{1 - \exp(j2n\Delta kx)}\exp( - j2\pi n\Delta kx) = \Delta k\frac{- 2j\sin(2\pi n\Delta kx)\exp(j2\pi n\Delta kx)}{- 2j\sin(\pi\Delta kx)\exp(j\pi n\Delta kx)}\exp( - j2\pi n\Delta kx) =\]

È noto che \(W = 2n\Delta k\), per cui:

\[= \Delta k\frac{\sin(\pi Wx)}{\sin(\pi\Delta kx)}\exp(j\pi n\Delta kx)\exp( - j2\pi n\Delta kx) =\]

Si moltiplica e divide il secondo membro per \(\pi Wx\):

\[= \Delta k\frac{\frac{\sin(\pi Wx)}{\pi Wx}}{\frac{\sin(\pi\Delta kx)}{\pi Wx}}\exp( - j\pi n\Delta kx) =\]

Per definizione:

\[\frac{\sin(\pi Wx)}{\pi Wx} = sinc(\pi Wx)\]

Inoltre, al denominatore si ricorda che \(W = 2n\Delta k\):

\[\frac{\sin(\pi\Delta kx)}{2n\pi\Delta kx} = \frac{1}{2n}\frac{\sin(\pi\Delta kx)}{\pi\Delta kx}\frac{1}{2n}{sinc}(\pi\Delta kx)\]

Sostituendo questo risultato appena ottenuto in \(h_{WS}(x)\), si ha:

\[h_{WS}(x) = 2n\Delta k\frac{{sinc}(\pi Wx)}{{sinc}(\pi\Delta kx)}\exp( - j\pi n\Delta kx)\]

Ovvero:

\[h_{WS}(x) = W\frac{{sinc}(\pi Wx)}{{sinc}(\pi\Delta kx)}\exp( - j\pi n\Delta kx)\]
...
\[H_{ham}(k) = \frac{1}{2} + \frac{1}{2}\cos\left( \frac{2\pi k}{W} \right) = \cos^{2}\left( \frac{\pi k}{W} \right)\]
...
\[\frac{2\pi k}{W} = \frac{2\pi k}{k_{\max} + k_{\min}} = \frac{2\pi k}{2k_{\max}} = \frac{\pi k}{k_{\max}} \rightarrow \pm \pi,k \rightarrow \pm k_{\max}\ \]

In questa condizione:

\[H_{ham}(k) = \cos^{2}\left( \frac{\pi k}{W} \right) \rightarrow 0,k \rightarrow \pm k_{\max}\ \]
...
\[h_{ham}(x) = \frac{1}{2}\delta(x) + \frac{1}{4}\left\lbrack \delta\left( x - \frac{1}{W} \right) + \delta\left( x + \frac{1}{W} \right) \right\rbrack\]

Dove \(W\) è legato alla risoluzione spaziale \(\Delta x\) dalla relazione:

\[W = \frac{1}{\Delta x} \Leftrightarrow \Delta x = \frac{1}{W}\]

Per cui, è possibile la finestra nello spazio-immagine:

\[h_{ham}(x) = \frac{1}{2}\delta(x) + \frac{1}{4}\left\lbrack \delta(x - \Delta x) + \delta(x + \Delta x) \right\rbrack\]
...
\[\widehat{\rho}(x) = \rho(x)*\left\{ \frac{1}{2}\delta(x) + \frac{1}{4}\left\lbrack \delta(x - \Delta x) + \delta(x + \Delta x) \right\rbrack \right\}\]

Per la proprietà di campionamento della delta, si ha:

\[\widehat{\rho}(x) = \frac{1}{2}\rho(x) + \frac{1}{4}\rho(x - \Delta x) + \frac{1}{4}\rho(x + \Delta x)\]
...
\[\widehat{\rho}(x) = \ \rho(x)*\left\lbrack W\frac{{sinc}(\pi Wx)}{{sinc}(\pi\Delta kx)}\exp( - j\pi n\Delta kx) \right\rbrack*\left\lbrack \frac{1}{2}\delta(x) + \frac{1}{4}\delta(x - \Delta x) + \frac{1}{4}\delta(x + \Delta x) \right\rbrack\]

Applicando le proprietà della delta di Dirac tra le due funzioni di trasferimento, si ha:

\[\widehat{\rho}(x) = \ \rho(x)*\left\lbrack \frac{1}{2}W\frac{{sinc}(\pi Wx)}{{sinc}(\pi\Delta kx)}\exp( - j\pi n\Delta kx) + \frac{1}{4}W\frac{{sinc}\left( \pi W(x - \Delta x) \right)}{{sinc}\left( \pi\Delta k(x - \Delta x) \right)}\exp\left( - j\pi n\Delta k(x - \Delta x) \right)\frac{1}{4}W\frac{{sinc}\left( \pi W(x + \Delta x) \right)}{{sinc}\left( \pi\Delta k(x + \Delta x) \right)}\exp\left( - j\pi n\Delta k(x + \Delta x) \right) \right\rbrack\]
...
\[\Delta x_{MRI} = \frac{1}{h(0)}\int_{- \infty}^{+ \infty}{h(x)dx}\]
...
Sia \(\left\lbrack - \frac{L}{2};\frac{L}{2} \right\rbrack\) l'intervallo in cui la PSF è non nulla, dove \(L\) è l'estensione della finestra di acquisizione, ovvero il FOV. L'integrale si riduce a:

\[H_{WS}(0) = \int_{- \frac{L}{2}}^{+ \frac{L}{2}}{\left\lbrack \sum_{p = - n}^{n - 1}{\exp(j2\pi p\Delta kx)} \right\rbrack dx}\]

Si inverte il simbolo di integrale con quello di sommatoria, ottenendo:

\[H_{WS}(0) = \sum_{p = - n}^{n - 1}\left\lbrack \int_{- \frac{L}{2}}^{+ \frac{L}{2}}{\exp(j2\pi p\Delta kx)dx} \right\rbrack\]

Si risolve l'integrale:

\[\int_{- \frac{L}{2}}^{+ \frac{L}{2}}{\exp(j2\pi p\Delta kx)dx} = \frac{1}{j2\pi p\Delta k}\left\lbrack \exp(j2\pi p\Delta kx) \right\rbrack_{- \frac{L}{2}}^{+ \frac{L}{2}} = \ \frac{1}{j2\pi p\Delta k}\left\lbrack \exp\left( j2\pi p\Delta k\frac{L}{2} \right) - \exp\left( - j2\pi p\Delta k\frac{L}{2} \right) \right\rbrack\]

Per le formule di Eulero, risulta:

\[\exp\left( j2\pi p\Delta k\frac{L}{2} \right) - \exp\left( - j2\pi p\Delta k\frac{L}{2} \right) = 2j\sin\left( 2\pi p\Delta k\frac{L}{2} \right)\]

Quindi la soluzione dell'integrale è:

\[\int_{- \frac{L}{2}}^{+ \frac{L}{2}}{\exp(j2\pi p\Delta kx)dx} = \frac{1}{j2\pi p\Delta k}2j\sin\left( 2\pi p\Delta k\frac{L}{2} \right) = \frac{1}{\pi p\Delta k}\sin(\pi p\Delta kL) =\]

Moltiplicando e dividendo per \(L\) il secondo membro è possibile esprimere l'integrale in termini di \(sinc\):

\[= L\frac{\sin(\pi p\Delta kL)}{\pi p\Delta kL} = L{sinc}(\pi p\Delta kL) =\]

Il campionamento nel \(k\)-spazio, \(\Delta k\), e il FOV sono legati dalla relazione \(\Delta k = L^{- 1}\), per cui:

\[= L{sinc}\left( \pi p\frac{1}{L}L \right) = L{sinc}(\pi p)\]
...
\[\Delta x_{MRI} = \frac{1}{h_{WS}(0)}\int_{- \infty}^{+ \infty}{h_{WS}(x)dx} = \frac{H_{WS}(0)}{h_{WS}(0)}\]

Sostituendo i risultati ottenuti si ottiene:

\[\Delta x_{MRI} = \frac{L}{2n} = \frac{1}{2n\Delta k} = \Delta x\]
...
\[s_{m}(k) = s(k)\exp\left( - \frac{t}{T_{2}^{*}} \right)\]
...
\[k = \overline{\gamma}Gt' \Leftrightarrow t' = \frac{k}{\overline{\gamma}G}\]

Il tempo \(t\), legato a \(t'\), può essere espresso come:

\[t' = t - T_{E} \Leftrightarrow t = t' + T_{E} = \frac{k}{\overline{\gamma}G} + T_{E}\]

Con questa posizione, il decadimento esponenziale del segnale registrato nel \(k\)-spazio si scrive come:

\[\exp\left( - \frac{t}{T_{2}^{*}} \right) = \exp\left( - \frac{k}{\overline{\gamma}GT_{2}^{*}} \right)\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\]

Applicando anche il troncamento al segnale registrato nel \(k\)-spazio, si ottiene:

\[s_{m}(k) = s(k)\exp\left( - \frac{k}{\overline{\gamma}GT_{2}^{*}} \right)\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)H_{w}(k)\]
...
\[s_{m}(k) = s(k)\exp\left( - \frac{k}{\overline{\gamma}GT_{2}^{*}} \right){rect}\left( \frac{k + \frac{\Delta k}{2}}{W} \right)\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\]
...
\[\mathfrak{F}^{-}\left\lbrack \exp\left( - \frac{k}{\overline{\gamma}GT_{2}^{*}} \right)\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right) \right\rbrack(x) = \exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\mathfrak{F}^{-}\left\lbrack \exp\left( - \frac{k}{\overline{\gamma}GT_{2}^{*}} \right) \right\rbrack(x)\]

Si applica la definizione di trasformata inversa di Fourier:

\[\mathfrak{F}^{-}\left\lbrack \exp\left( - \frac{k}{\overline{\gamma}GT_{2}^{*}} \right) \right\rbrack(x) = \int_{- \infty}^{+ \infty}{\exp\left( - \frac{k}{\overline{\gamma}GT_{2}^{*}} \right)\exp(j2\pi kx)dk} = \int_{- \infty}^{+ \infty}{\exp\left( - \frac{k}{\overline{\gamma}GT_{2}^{*}} + j2\pi kx \right)dk} =\]
...
\[\mathfrak{F}^{-}\left\lbrack \exp\left( - \frac{k}{\overline{\gamma}GT_{2}^{*}} \right) \right\rbrack(x) = \int_{- k_{\max}}^{+ k_{\max}}{\exp\left( - \frac{k}{\overline{\gamma}GT_{2}^{*}} + j2\pi kx \right)dk} = \int_{- k_{\max}}^{+ k_{\max}}{\exp\left( \left( j2\pi x - \frac{1}{\overline{\gamma}GT_{2}^{*}} \right)k \right)dk} =\]

Si risolve l'integrale al secondo membro, moltiplicando e dividendo per l'argomento di \(k\):

\[= \int_{- k_{\max}}^{+ k_{\max}}{\exp\left( \left( j2\pi x - \frac{1}{\overline{\gamma}GT_{2}^{*}} \right)k \right)dk} = \frac{1}{j2\pi x - \frac{1}{\overline{\gamma}GT_{2}^{*}}}\left\lbrack \exp\left( \left( j2\pi x - \frac{1}{\overline{\gamma}GT_{2}^{*}} \right)k \right) \right\rbrack_{- k_{\max}}^{k_{\max}} = \frac{\exp\left( \left( j2\pi x - \frac{1}{\overline{\gamma}GT_{2}^{*}} \right)k_{\max} \right) - \exp\left( - \left( j2\pi x - \frac{1}{\overline{\gamma}GT_{2}^{*}} \right)k_{\max} \right)}{j2\pi x - \frac{1}{\overline{\gamma}GT_{2}^{*}}} =\]

Il gradiente \(G\) è legato alla finestra di lettura dalla relazione:

\[T_{S} = \frac{W}{\overline{\gamma}G} \Leftrightarrow \ G = \frac{W}{\overline{\gamma}T_{S}}\]
...
\[G = \frac{2k_{\max}}{\overline{\gamma}T_{S}}\]

È possibile scrivere:

\[= \frac{\exp\left( \left( j2\pi x - \frac{1}{\overline{\gamma}\frac{2k_{\max}}{\overline{\gamma}T_{S}}T_{2}^{*}} \right)k_{\max} \right) - \exp\left( - \left( j2\pi x - \frac{1}{\overline{\gamma}\frac{2k_{\max}}{\overline{\gamma}T_{S}}T_{2}^{*}} \right)k_{\max} \right)}{j2\pi x - \frac{1}{\overline{\gamma}\frac{2k_{\max}}{\overline{\gamma}T_{S}}T_{2}^{*}}} =\]

Si svolgono i prodotti:

\[= \frac{\exp\left( j2\pi xk_{\max} - \frac{T_{S}}{2T_{2}^{*}} \right) - \exp\left( - j2\pi xk_{\max} + \frac{T_{S}}{2T_{2}^{*}} \right)}{j2\pi x - \frac{T_{S}}{2k_{\max}T_{2}^{*}}} =\]
...
\[W = 2k_{\max} \Leftrightarrow 2k_{\max} = \frac{1}{\Delta x} \Leftrightarrow k_{\max} = \frac{1}{2\Delta x}\]

Sostituendo tale risultato si ottiene:

\[= \frac{\exp\left( j2\pi x\frac{1}{2\Delta x} - \frac{T_{S}}{2T_{2}^{*}} \right) - \exp\left( - j2\pi x\frac{1}{2\Delta x} + \frac{T_{S}}{2T_{2}^{*}} \right)}{j2\pi x - \frac{T_{S}}{\frac{2}{2\Delta x}T_{2}^{*}}}\]

Semplificando, si ottiene:

\[\mathfrak{F}^{-}\left\lbrack \exp\left( - \frac{k}{\overline{\gamma}GT_{2}^{*}} \right) \right\rbrack(x) = \frac{\exp\left( j\pi\frac{x}{\Delta x} - \frac{T_{S}}{2T_{2}^{*}} \right) - \exp\left( - j\pi\frac{x}{\Delta x} + \frac{T_{S}}{2T_{2}^{*}} \right)}{j2\pi x - \Delta x\frac{T_{S}}{T_{2}^{*}}}\]

Mettendo un segno negativo in evidenza al numerato e al denominatore, si ottiene:

\[\mathfrak{F}^{-}\left\lbrack \exp\left( - \frac{k}{\overline{\gamma}GT_{2}^{*}} \right) \right\rbrack(x) = \frac{\exp\left( \frac{T_{S}}{2T_{2}^{*}} - j\pi\frac{x}{\Delta x} \right) - \exp\left( - \frac{T_{S}}{2T_{2}^{*}} + j\pi\frac{x}{\Delta x} \right)}{\Delta x\frac{T_{S}}{T_{2}^{*}} - j2\pi x}\]

Considerando anche il termine esponenziale costante, la PSF introdotta dal tempo di rilassamento \(T_{2}^{*}\) è data da:

\[h_{T_{2}^{*}}(x) = \exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\mathfrak{F}^{-}\left\lbrack \exp\left( - \frac{k}{\overline{\gamma}GT_{2}^{*}} \right) \right\rbrack(x) = \frac{\exp\left( \frac{T_{S}}{2T_{2}^{*}} - j\pi\frac{x}{\Delta x} \right) - \exp\left( - \frac{T_{S}}{2T_{2}^{*}} + j\pi\frac{x}{\Delta x} \right)}{\Delta x\frac{T_{S}}{T_{2}^{*}} - j2\pi x}\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\]

La risoluzione \(\Delta x_{RMI}\) introdotta da questo filtraggio può essere ottenuta applicando la definizione:

\[\Delta x_{MRI} = \frac{1}{h_{T_{2}^{*}}(0)}\int_{\infty}^{\infty}{h_{T_{2}^{*}}(x)dx} = \frac{H_{T_{2}^{*}}(0)}{h_{T_{2}^{*}}(0)}\]

La trasformata di Fourier della PSF è nota ed è:

\[H_{T_{2}^{*}}(k) = \exp\left( - \frac{k}{\overline{\gamma}GT_{2}^{*}} \right)\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\]

La quale, valutata per \(k = 0\), si riduce a:

\[H_{T_{2}^{*}}(0) = \exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\]

La PSF valutata in \(x = 0\) è data, invece, da:

\[h_{T_{2}^{*}}(x) = \left. \ \frac{\exp\left( \frac{T_{S}}{2T_{2}^{*}} - j\pi\frac{x}{\Delta x} \right) - \exp\left( - \frac{T_{S}}{2T_{2}^{*}} + j\pi\frac{x}{\Delta x} \right)}{\Delta x\frac{T_{S}}{T_{2}^{*}} - j2\pi x}\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right) \right|_{x = 0} = \frac{\exp\left( \frac{T_{S}}{2T_{2}^{*}} \right) - \exp\left( - \frac{T_{S}}{2T_{2}^{*}} \right)}{\Delta x\frac{T_{S}}{T_{2}^{*}}}\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\]

La risoluzione della PSF è, quindi:

\[\Delta x_{MRI} = \frac{H_{T_{2}^{*}}(0)}{h_{T_{2}^{*}}(0)} = \frac{\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)}{\frac{\exp\left( \frac{T_{S}}{2T_{2}^{*}} \right) - \exp\left( - \frac{T_{S}}{2T_{2}^{*}} \right)}{\Delta x\frac{T_{S}}{T_{2}^{*}}}\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)} = \Delta x\frac{T_{S}}{T_{2}^{*}}\frac{1}{\exp\left( \frac{T_{S}}{2T_{2}^{*}} \right) - \exp\left( - \frac{T_{S}}{2T_{2}^{*}} \right)}\]

Si definisce \(sinc\) iperbolico, \(sinch\), come:

\[{sinch}(x) = \frac{\sinh(x)}{x} = \frac{e^{x} - e^{- x}}{2x}\]

È possibile scrivere, dunque:

\[{sinch}\left( \frac{T_{S}}{2T_{2}^{*}} \right) = \frac{\exp\left( \frac{T_{S}}{2T_{2}^{*}} \right) - \exp\left( - \frac{T_{S}}{2T_{2}^{*}} \right)}{2\frac{T_{S}}{2T_{2}^{*}}} = \frac{\exp\left( \frac{T_{S}}{2T_{2}^{*}} \right) - \exp\left( - \frac{T_{S}}{2T_{2}^{*}} \right)}{\frac{T_{S}}{T_{2}^{*}}}\]

La risoluzione \(\Delta x_{MRI}\) relativo alla PSF dovuta al tempo di rilassamento \(T_{2}^{*}\) si può scrivere come:

\[\Delta x_{MRI} = \frac{\Delta x}{{sinch}\left( \frac{T_{S}}{2T_{2}^{*}} \right)}\]

Se risulta:

\[\frac{T_{S}}{2T_{2}^{*}} \ll 1\]

È possibile approssimare la funzione \(sinc\) iperbolico come:

\[{sinch}\left( \frac{T_{S}}{2T_{2}^{*}} \right) \simeq 1 - \frac{x^{2}}{6}\]

In questa condizione, si ha:

\[\Delta x_{MRI} = \frac{\Delta x}{{sinch}\left( \frac{T_{S}}{2T_{2}^{*}} \right)} \simeq \frac{\Delta x}{\left( 1 - \frac{1}{6}\left( \frac{T_{S}}{2T_{2}^{*}} \right)^{2} \right)}\]

Se risulta che \(T_{S} = T_{2}^{*}\), la risoluzione è:

\[\left. \ \Delta x_{MRI} \right|_{T_{S} = T_{2}^{*}} = \left. \ \frac{\Delta x}{{sinch}\left( \frac{T_{S}}{2T_{2}^{*}} \right)} \right|_{T_{S} = T_{2}^{*}} = \left. \ \frac{\Delta x}{\frac{\exp\left( \frac{T_{S}}{2T_{2}^{*}} \right) - \exp\left( - \frac{T_{S}}{2T_{2}^{*}} \right)}{\frac{T_{S}}{T_{2}^{*}}}} \right|_{T_{S} = T_{2}^{*}} = \frac{\Delta x}{\exp\left( \frac{1}{2} \right) - \exp\left( - \frac{1}{2} \right)} \simeq 1.04\Delta x\]
...
\[\exp\left( - \frac{T_{S}}{2T_{2}^{*}} \right) \ll 1\]
...
\[h_{T_{2}^{*}}(x) = \frac{\exp\left( \frac{T_{S}}{2T_{2}^{*}} - j\pi\frac{x}{\Delta x} \right) - \exp\left( - \frac{T_{S}}{2T_{2}^{*}} + j\pi\frac{x}{\Delta x} \right)}{\Delta x\frac{T_{S}}{T_{2}^{*}} - j2\pi x}\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\]

Si considera il solo numeratore:

\[\exp\left( \frac{T_{S}}{2T_{2}^{*}} - j\pi\frac{x}{\Delta x} \right) - \exp\left( - \frac{T_{S}}{2T_{2}^{*}} + j\pi\frac{x}{\Delta x} \right)\]

Per le proprietà degli esponenziali, si ha:

\[\exp\left( \frac{T_{S}}{2T_{2}^{*}} - j\pi\frac{x}{\Delta x} \right) - \exp\left( - \frac{T_{S}}{2T_{2}^{*}} + j\pi\frac{x}{\Delta x} \right) = \exp\left( \frac{T_{S}}{2T_{2}^{*}} \right)\exp\left( - j\pi\frac{x}{\Delta x} \right) - \exp\left( - \frac{T_{S}}{2T_{2}^{*}} \right)\exp\left( j\pi\frac{x}{\Delta x} \right)\]

Raccogliendo, è possibile scrivere:

\[\exp\left( - j\pi\frac{x}{\Delta x} \right)\left( \exp\left( \frac{T_{S}}{2T_{2}^{*}} \right) - \exp\left( - \frac{T_{S}}{2T_{2}^{*}} \right)\exp\left( j2\pi\frac{x}{\Delta x} \right) \right)\]
...
\[\exp\left( \frac{T_{S}}{2T_{2}^{*}} \right) \gg \exp\left( - \frac{T_{S}}{2T_{2}^{*}} \right)\]

Per cui si ottiene:

\[\exp\left( \frac{T_{S}}{2T_{2}^{*}} - j\pi\frac{x}{\Delta x} \right) - \exp\left( - \frac{T_{S}}{2T_{2}^{*}} + j\pi\frac{x}{\Delta x} \right) \simeq \exp\left( - j\pi\frac{x}{\Delta x} \right)\exp\left( \frac{T_{S}}{2T_{2}^{*}} \right)\]

La PSF può essere scritta come:

\[h_{T_{2}^{*}}(x) \simeq \frac{\exp\left( - j\pi\frac{x}{\Delta x} \right)\exp\left( \frac{T_{S}}{2T_{2}^{*}} \right)}{\Delta x\frac{T_{S}}{T_{2}^{*}} - j2\pi x}\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\]

Per valutare l'ascissa in cui la finestra è uguale a metà dell'ampiezza massima si valuta il modulo di \(h_{T_{2}^{*}}(x)\):

\[\left| h_{T_{2}^{*}}(x) \right| \simeq \frac{\exp\left( \frac{T_{S}}{2T_{2}^{*}} \right)}{\sqrt{\left( \frac{T_{S}\Delta x}{T_{2}^{*}} \right)^{2} + (2\pi x)^{2}}}\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\]

Che può essere riscritta eseguendo il minimo comune multiplo al denominatore:

\[\left| h_{T_{2}^{*}}(x) \right| \simeq \frac{T_{2}^{*}\exp\left( \frac{T_{S}}{2T_{2}^{*}} \right)}{\sqrt{\left( T_{S}\Delta x \right)^{2} + \left( 2\pi xT_{2}^{*} \right)^{2}}}\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\]

Si applica la definizione di FWHM alla finestra \(\left| h_{T_{2}^{*}}(x) \right|\):

\[h_{T_{2}^{*}}\left( \frac{\Delta x_{RMI}}{2} \right) = \frac{1}{2}h_{T_{2}^{*}}(0)\]

Da cui:

\[\left. \ \frac{T_{2}^{*}\exp\left( \frac{T_{S}}{2T_{2}^{*}} \right)}{\sqrt{\left( T_{S}\Delta x \right)^{2} + \left( 2\pi xT_{2}^{*} \right)^{2}}}\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right) \right|_{x = \frac{\Delta x_{RMI}}{2}} = \frac{1}{2}\left. \ \frac{T_{2}^{*}\exp\left( \frac{T_{S}}{2T_{2}^{*}} \right)}{\sqrt{\left( T_{S}\Delta x \right)^{2} + \left( 2\pi xT_{2}^{*} \right)^{2}}}\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right) \right|_{x = 0}\]

\[\frac{T_{2}^{*}\exp\left( \frac{T_{S}}{2T_{2}^{*}} \right)}{\sqrt{\left( T_{S}\Delta x \right)^{2} + \left( 2\pi\frac{\Delta x_{RMI}}{2}T_{2}^{*} \right)^{2}}}\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right) = \frac{1}{2}\frac{T_{2}^{*}\exp\left( \frac{T_{S}}{2T_{2}^{*}} \right)}{\sqrt{\left( T_{S}\Delta x \right)^{2}}}\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\]

Semplificando i termini comuni tra i due membri, si ottiene:

\[\frac{1}{\sqrt{\left( T_{S}\Delta x \right)^{2} + \left( \pi\Delta x_{RMI}T_{2}^{*} \right)^{2}}} = \frac{1}{2}\frac{1}{\sqrt{\left( T_{S}\Delta x \right)^{2}}} = \frac{1}{2}\frac{1}{T_{S}\Delta x}\]

Si eleva al quadrato entrambi i membri per poter ricavare \(\Delta x_{RMI}\):

\[\frac{1}{\left( T_{S}\Delta x \right)^{2} + \left( \pi\Delta x_{RMI}T_{2}^{*} \right)^{2}} = \frac{1}{4}\frac{1}{\left( T_{S}\Delta x \right)^{2}}\]
...
\[\Delta x_{RMI} = \frac{\sqrt{3}}{\pi}\frac{T_{S}}{T_{2}^{*}}\Delta x\]
...
\[s(k) \propto \exp\left( - \frac{|k|}{\overline{\gamma}GT_{2}'} \right)\]
...
\[s(k) \propto \exp\left( - \frac{T_{E}}{T_{2}} \right)\exp\left( - \frac{k}{\overline{\gamma}GT_{2}} \right)\]

Il filtro equivalente, che descrive il decadimento con \(T_{2}\) e \(T_{2}'\), è ottenuto moltiplicando i due contributi:

\[H_{SE}(k) = \exp\left( - \frac{T_{E}}{T_{2}} \right)\exp\left( - \frac{k}{\overline{\gamma}GT_{2}} \right)\exp\left( - \frac{|k|}{\overline{\gamma}GT_{2}'} \right)\]
...
\[h_{SE}(x) = \mathfrak{F}^{-}\left\lbrack H_{SE}(k) \right\rbrack(x) = \mathfrak{F}^{-}\left\lbrack \exp\left( - \frac{k}{\overline{\gamma}GT_{2}} \right)\exp\left( - \frac{|k|}{\overline{\gamma}GT_{2}'} \right) \right\rbrack(x) =\]

Il termine \(\exp\left( - T_{E}/T_{2} \right)\) non dipende da \(k\), per cui è un fattore costante:

\[h_{SE}(x) = \exp\left( - \frac{T_{E}}{T_{2}} \right)\mathfrak{F}^{-}\left\lbrack \exp\left( - \frac{k}{\overline{\gamma}GT_{2}} \right)\exp\left( - \frac{|k|}{\overline{\gamma}GT_{2}'} \right) \right\rbrack(x)\]

Si risolve l'antitrasformata:

\[\mathfrak{F}^{-}\left\lbrack \exp\left( - \frac{k}{\overline{\gamma}GT_{2}} \right)\exp\left( - \frac{|k|}{\overline{\gamma}GT_{2}'} \right) \right\rbrack(x) = \int_{- \infty}^{+ \infty}{\exp\left( - \frac{k}{\overline{\gamma}GT_{2}} \right)\exp\left( - \frac{|k|}{\overline{\gamma}GT_{2}'} \right)\exp(j2\pi kx)dk}\]
...
\[\int_{- \infty}^{+ \infty}{\exp\left( - \frac{k}{\overline{\gamma}GT_{2}} \right)\exp\left( - \frac{|k|}{\overline{\gamma}GT_{2}'} \right)\exp(j2\pi kx)dk} = \int_{- \infty}^{0}{\exp\left( - \frac{k}{\overline{\gamma}GT_{2}} \right)\exp\left( \frac{k}{\overline{\gamma}GT_{2}'} \right)\exp(j2\pi kx)dk} + \int_{0}^{+ \infty}{\exp\left( - \frac{k}{\overline{\gamma}GT_{2}} \right)\exp\left( - \frac{k}{\overline{\gamma}GT_{2}'} \right)\exp(j2\pi kx)dk}\]
...
\[G = \frac{2k_{\max}}{\overline{\gamma}T_{S}} \Leftrightarrow k_{\max} = \frac{1}{2}\overline{\gamma}T_{S}G\]
...
\[\int_{- \infty}^{+ \infty}{\exp\left( - \frac{k}{\overline{\gamma}GT_{2}} \right)\exp\left( - \frac{|k|}{\overline{\gamma}GT_{2}'} \right)\exp(j2\pi kx)dk} = \int_{- \infty}^{0}{\exp{\left( \frac{k}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) + j2\pi kx \right)dk}} + \int_{0}^{+ \infty}{\exp\left( - \frac{k}{\overline{\gamma}G}\left( \frac{1}{T_{2}} + \frac{1}{T_{2}'} \right) + j2\pi kx \right)dk}\]

Si risolve il primo integrale:

\[\int_{- \infty}^{0}{\exp\left( \frac{k}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) + j2\pi kx \right)dk} = \frac{1}{\frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) + j2\pi x}\left\lbrack \exp\left( \frac{k}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) + j2\pi kx \right) \right\rbrack_{- \infty}^{0}\]

In tutte le applicazioni pratiche, \(T_{2} > T_{2}'\), per cui il fattore moltiplicativo \(k\) è positivo:

\[\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) > 0\]
...
\[\exp\left( \frac{k}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) + j2\pi kx \right) = \exp\left( \frac{k}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right)\exp(j2\pi kx) \rightarrow 0,k \rightarrow - \infty\]

L'integrale ha quindi soluzione:

\[\int_{- \infty}^{0}{\exp\left( \frac{k}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) + j2\pi kx \right)dk} = \frac{1}{\frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) + j2\pi x}\]

È possibile ripetere un discorso analogo per il secondo integrale:

\[\int_{0}^{+ \infty}{\exp\left( - \frac{k}{\overline{\gamma}G}\left( \frac{1}{T_{2}} + \frac{1}{T_{2}'} \right) + j2\pi kx \right)dk} = \frac{1}{- \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}} + \frac{1}{T_{2}'} \right) + j2\pi x}\left\lbrack \exp\left( - \frac{k}{\overline{\gamma}G}\left( \frac{1}{T_{2}} + \frac{1}{T_{2}'} \right) + j2\pi kx \right) \right\rbrack_{0}^{+ \infty}\]

Il fattore moltiplicativo la variabile \(k\) è positivo e il termine \(\exp( - j2\pi kx)\) è oscillante, per cui:

\[\exp\left( - \frac{k}{\overline{\gamma}G}\left( \frac{1}{T_{2}} + \frac{1}{T_{2}'} \right) \right)\exp(j2\pi kx) \rightarrow 0,k \rightarrow + \infty\]

La soluzione del secondo integrale è, quindi:

\[\int_{0}^{+ \infty}{\exp\left( - \frac{k}{\overline{\gamma}G}\left( \frac{1}{T_{2}} + \frac{1}{T_{2}'} \right) + j2\pi kx \right)dk} = - \frac{1}{- \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}} + \frac{1}{T_{2}'} \right) + j2\pi x}\]

La PSF complessiva è data dalla somma dei due contributi appena valutati:

\[h_{SE}(x) = \mathfrak{F}^{-}\left\lbrack H_{SE}(k) \right\rbrack(x) = \frac{1}{\frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) + j2\pi x} - \frac{1}{- \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}} + \frac{1}{T_{2}'} \right) + j2\pi x} =\]

Si svolge il minimo comune multiplo:

\[\frac{- \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}} + \frac{1}{T_{2}'} \right) + j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) - j2\pi x}{\left\lbrack \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) + j2\pi x \right\rbrack\left\lbrack - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}} + \frac{1}{T_{2}'} \right) + j2\pi x \right\rbrack}\]

Si considera solamente il numeratore. I termini \(j2\pi x\) si elidono mentre i restanti possono essere sommati:

\[- \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}} + \frac{1}{T_{2}'} \right) + j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) - j2\pi x = - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}} + \frac{1}{T_{2}'} \right) - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) = - \frac{k}{\overline{\gamma}G}\left( \frac{1}{T_{2}} + \frac{1}{T_{2}'} + \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) = - \frac{2}{\overline{\gamma}GT_{2}'}\]

Per il denominatore, invece, si eseguono i prodotti:

\[\left\lbrack j2\pi x + \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack\left\lbrack j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) \right\rbrack = (j2\pi x)^{2} - \frac{1}{{\overline{\gamma}}^{2}G^{2}}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right)\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + \ j2\pi x\left\lbrack - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack = - 4\pi^{2}x^{2} - \frac{1}{{\overline{\gamma}}^{2}G^{2}}\left( \frac{1}{{T_{2}'}^{2}} - \frac{1}{T_{2}^{2}} \right) + \ j2\pi x\left\lbrack - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack = - 4\pi^{2}x^{2} - \frac{1}{{\overline{\gamma}}^{2}G^{2}}\left( \frac{1}{{T_{2}'}^{2}} - \frac{1}{T_{2}^{2}} \right) + \ j2\pi x\left\lbrack \frac{1}{\overline{\gamma}G}\left( - \frac{1}{T_{2}'} - \frac{1}{T_{2}} + \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack = - 4\pi^{2}x^{2} - \frac{1}{{\overline{\gamma}}^{2}G^{2}}\left( \frac{1}{{T_{2}'}^{2}} - \frac{1}{T_{2}^{2}} \right) - \frac{4\pi x}{\overline{\gamma}GT_{2}}j\]

La PSF è, in definitiva, data da:

\[h_{SE}(x) = \frac{- \frac{2}{\overline{\gamma}GT_{2}'}}{- 4\pi^{2}x^{2} - \frac{1}{{\overline{\gamma}}^{2}G^{2}}\left( \frac{1}{{T_{2}'}^{2}} - \frac{1}{T_{2}^{2}} \right) - \frac{4\pi x}{\overline{\gamma}GT_{2}}j} = \frac{\frac{2}{\overline{\gamma}GT_{2}'}}{4\pi^{2}x^{2} + \frac{1}{{\overline{\gamma}}^{2}G^{2}}\left( \frac{1}{{T_{2}'}^{2}} - \frac{1}{T_{2}^{2}} \right) + \frac{4\pi x}{\overline{\gamma}GT_{2}}j}\]
...
\[\frac{1}{T_{2}'} - \frac{1}{T_{2}} \simeq \frac{1}{T_{2}'}\]
...
\[h_{SE}(x) \simeq \frac{\frac{2}{\overline{\gamma}GT_{2}'}}{4\pi^{2}x^{2} + \frac{1}{{\overline{\gamma}}^{2}G^{2}{T_{2}'}^{2}}}\]

Riarrangiando i termini si scrive:

\[h_{SE}(x) \simeq \frac{2\overline{\gamma}GT_{2}'}{1 + 4\pi^{2}x^{2}{\overline{\gamma}}^{2}G^{2}{T_{2}'}^{2}}\]
...
\[h_{SE}\left( \frac{\Delta x_{RMI}}{2} \right) = \frac{1}{2}h_{SE}(0)\]

Sostituendo l'espressione della PSF, si ottiene:

\[\frac{2\overline{\gamma}GT_{2}'}{1 + 4\pi^{2}\left( \frac{\Delta x_{RMI}}{2} \right)^{2}{\overline{\gamma}}^{2}G^{2}{T_{2}'}^{2}} = \frac{1}{2}2\overline{\gamma}GT_{2}'\]

I numeratori sono uguali, a meno del \(2\), quindi possono essere semplificati.

\[\frac{2}{1 + 4\pi^{2}\left( \frac{\Delta x_{RMI}}{2} \right)^{2}{\overline{\gamma}}^{2}G^{2}{T_{2}'}^{2}} = 1\]

Si passa ai reciproci:

\[1 + 4\pi^{2}\frac{\Delta x_{RMI}^{2}}{4}{\overline{\gamma}}^{2}G^{2}{T_{2}'}^{2} = 2\]
...
\[\Delta x_{RMI}^{2} = \frac{1}{{\overline{\gamma}}^{2}G^{2}{T_{2}'}^{2}\pi^{2}}\]

Applicando la radice a entrambi i membri si ottiene la risoluzione secondo il metodo FWHM:

\[\Delta x_{RMI} = \frac{1}{\overline{\gamma}GT_{2}'\pi}\]
...
\[\Delta x = \frac{1}{W} = \frac{1}{\overline{\gamma}GT_{S}}\]
...
\[\Delta x_{RMI} = \frac{1}{\overline{\gamma}GT_{2}'\pi}\frac{T_{S}}{T_{S}}\]

Da cui:

\[\Delta x_{RMI} = \frac{\Delta x}{\pi}\frac{T_{S}}{T_{2}'}\]
...
\[FWHM_{SE} = \frac{\sqrt{3}}{\pi}\frac{T_{S}}{T_{2}}\Delta x + \frac{\Delta x}{\pi}\frac{T_{S}}{T_{2}'}\]
...
\[= \int_{- k_{\max}}^{+ k_{\max}}{\exp\left( - \frac{k}{\overline{\gamma}GT_{2}} \right)\exp\left( - \frac{|k|}{\overline{\gamma}GT_{2}'} \right)\exp(j2\pi kx)dk} =\]

Al fine di risolvere l'integrale, per la presenza del modulo, è necessario distinguere il caso di \(k\) negative e positive. L'integrale, in altre parole, viene scisso nella somma di due integrali:

\[= \int_{- k_{\max}}^{0}{\exp\left( - \frac{k}{\overline{\gamma}GT_{2}} \right)\exp\left( \frac{k}{\overline{\gamma}GT_{2}'} \right)\exp(j2\pi kx)dk} + \int_{0}^{+ k_{\max}}{\exp\left( - \frac{k}{\overline{\gamma}GT_{2}} \right)\exp\left( - \frac{k}{\overline{\gamma}GT_{2}'} \right)\exp(j2\pi kx)dk} =\]

Per le proprietà degli esponenziali è possibile scrivere:

\[= \int_{- k_{\max}}^{0}{\exp\left( \left( \frac{1}{\overline{\gamma}GT_{2}'} - \frac{1}{\overline{\gamma}GT_{2}} + j2\pi x \right)k \right)dk} + \int_{0}^{+ k_{\max}}{\exp\left( \left( - \frac{1}{\overline{\gamma}GT_{2}'} - \frac{1}{\overline{\gamma}GT_{2}} + j2\pi x \right)k \right)dk} =\]
...
\[\int_{- k_{\max}}^{0}{\exp\left( \left( \frac{1}{\overline{\gamma}GT_{2}'} - \frac{1}{\overline{\gamma}GT_{2}} + j2\pi x \right)k \right)dk} = \frac{1}{\frac{1}{\overline{\gamma}GT_{2}'} - \frac{1}{\overline{\gamma}GT_{2}} + j2\pi x}\left\lbrack \exp\left( \left( \frac{1}{\overline{\gamma}GT_{2}'} - \frac{1}{\overline{\gamma}GT_{2}} + j2\pi x \right)k \right) \right\rbrack_{- k_{\max}}^{0} = \frac{1}{\frac{1}{\overline{\gamma}GT_{2}'} - \frac{1}{\overline{\gamma}GT_{2}} + j2\pi x}\left\lbrack 1 - \exp\left( - \left( \frac{1}{\overline{\gamma}GT_{2}'} - \frac{1}{\overline{\gamma}GT_{2}} + j2\pi x \right)k_{\max} \right) \right\rbrack =\]
...
\[= \frac{1}{\frac{1}{\overline{\gamma}GT_{2}'} - \frac{1}{\overline{\gamma}GT_{2}} + j2\pi x}\left\lbrack 1 - \exp\left( - \left( \frac{1}{\overline{\gamma}GT_{2}'} - \frac{1}{\overline{\gamma}GT_{2}} + j2\pi x \right)\frac{1}{2}\overline{\gamma}T_{S}G \right) \right\rbrack =\]

Svolgendo i prodotti nel termine esponenziale e raccogliendo, si ha:

\[= \frac{1}{\frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) + j2\pi x}\left\lbrack 1 - \exp\left( - \frac{1}{2}\left( \frac{T_{S}}{T_{2}'} - \frac{T_{S}}{T_{2}} + j2\pi\overline{\gamma}T_{S}Gx \right) \right) \right\rbrack = \frac{1}{\frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) + j2\pi x}\left\lbrack 1 - \exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) - j\pi\overline{\gamma}T_{S}Gx \right) \right\rbrack\]

Analogamente, per il secondo integrale:

\[\int_{0}^{+ k_{\max}}{\exp\left( \left( - \frac{1}{\overline{\gamma}GT_{2}'} - \frac{1}{\overline{\gamma}GT_{2}} + j2\pi x \right)k \right)dk} = \frac{1}{- \frac{1}{\overline{\gamma}GT_{2}'} - \frac{1}{\overline{\gamma}GT_{2}} + j2\pi x}\left\lbrack \exp\left( \left( - \frac{1}{\overline{\gamma}GT_{2}'} - \frac{1}{\overline{\gamma}GT_{2}} + j2\pi x \right)k \right) \right\rbrack_{0}^{k_{\max}} = \frac{1}{- \frac{1}{\overline{\gamma}GT_{2}'} - \frac{1}{\overline{\gamma}GT_{2}} + j2\pi x}\left\lbrack \exp\left( \left( - \frac{1}{\overline{\gamma}GT_{2}'} - \frac{1}{\overline{\gamma}GT_{2}} + j2\pi x \right)k_{\max} \right) - 1 \right\rbrack =\]

Dalla relazione tra \(G\) e \(k_{\max}\), si ha:

\[= \frac{1}{- \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + j2\pi x}\left\lbrack \exp\left( \left( - \frac{1}{\overline{\gamma}GT_{2}'} - \frac{1}{\overline{\gamma}GT_{2}} + j2\pi x \right)\frac{1}{2}\overline{\gamma}T_{S}G \right) - 1 \right\rbrack =\]

\[= \frac{1}{- \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + j2\pi x}\left\lbrack \exp\left( \frac{1}{2}\left( - \frac{T_{S}}{T_{2}'} - \frac{T_{S}}{T_{2}} + j2\pi\overline{\gamma}T_{S}Gx \right) \right) - 1 \right\rbrack =\]

Raccogliendo:

\[= \frac{1}{- \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + j2\pi x}\left\lbrack \exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + j\pi\overline{\gamma}T_{S}Gx \right) - 1 \right\rbrack\]

Utilizzando i risultati ottenuti, l'antitrasformata si scrive:

\[\mathfrak{F}^{-}\left\lbrack \exp\left( - \frac{k}{\overline{\gamma}GT_{2}} \right)\exp\left( - \frac{|k|}{\overline{\gamma}GT_{2}'} \right) \right\rbrack(x) = \frac{1}{\frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) + j2\pi x}\left\lbrack 1 - \exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) - j\pi\overline{\gamma}T_{S}Gx \right) \right\rbrack + \frac{1}{- \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + j2\pi x}\left\lbrack \exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + j\pi\overline{\gamma}T_{S}Gx \right) - 1 \right\rbrack\]

Si svolge il minimo comune multiplo:

\[\mathfrak{F}^{-}\left\lbrack \exp\left( - \frac{k}{\overline{\gamma}GT_{2}} \right)\exp\left( - \frac{|k|}{\overline{\gamma}GT_{2}'} \right) \right\rbrack(x) = \frac{\left\lbrack 1 - \exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) - j\pi\overline{\gamma}T_{S}Gx \right) \right\rbrack\left\lbrack j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) \right\rbrack}{\left\{ \left\lbrack j2\pi x + \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack\left\lbrack j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) \right\rbrack \right\}} + \frac{\left\lbrack \exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + j\pi\overline{\gamma}T_{S}Gx \right) - 1 \right\rbrack\left\lbrack j2\pi x + \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack}{\left\{ \left\lbrack j2\pi x + \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack\left\lbrack j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) \right\rbrack \right\}}\]

Si considerano i due termini del numeratore:

\[\left\lbrack 1 - \exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) - j\pi\overline{\gamma}T_{S}Gx \right) \right\rbrack\left\lbrack j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) \right\rbrack = \ j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) - \left\lbrack j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) \right\rbrack\exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) - j\pi\overline{\gamma}T_{S}Gx \right)\]

\[\left\lbrack \exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + j\pi\overline{\gamma}T_{S}Gx \right) - 1 \right\rbrack\left\lbrack j2\pi x + \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack = \left\lbrack j2\pi x + \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack\exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + j\pi\overline{\gamma}T_{S}Gx \right) - \ j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right)\]

Sommando i risultati, si ha:

\[j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) - \left\lbrack j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) \right\rbrack\exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) - j\pi\overline{\gamma}T_{S}Gx \right) + \left\lbrack j2\pi x + \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack\exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + j\pi\overline{\gamma}T_{S}Gx \right) - \ j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right)\]

I termini \(j2\pi x\) si elidono, inoltre:

\[- \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) = \frac{1}{\overline{\gamma}G}\left( - \frac{1}{T_{2}'} - \frac{1}{T_{2}} - \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) = - \frac{2}{\overline{\gamma}GT_{2}'}\]

Componendo il denominatore, si ottiene:

\[- \frac{2}{\overline{\gamma}GT_{2}'} - \left\lbrack j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) \right\rbrack\exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) - j\pi\overline{\gamma}T_{S}Gx \right) + \left\lbrack j2\pi x + \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack\exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + j\pi\overline{\gamma}T_{S}Gx \right)\]

Per il denominatore, invece, si ha:

\[\left\{ \left\lbrack j2\pi x + \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack\left\lbrack j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) \right\rbrack \right\} = (j2\pi x)^{2} - \frac{1}{{\overline{\gamma}}^{2}G^{2}}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right)\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + \ j2\pi x\left\lbrack - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack = - 4\pi^{2}x^{2} - \frac{1}{{\overline{\gamma}}^{2}G^{2}}\left( \frac{1}{{T_{2}'}^{2}} - \frac{1}{T_{2}^{2}} \right) + \ j2\pi x\left\lbrack - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack = - 4\pi^{2}x^{2} - \frac{1}{{\overline{\gamma}}^{2}G^{2}}\left( \frac{1}{{T_{2}'}^{2}} - \frac{1}{T_{2}^{2}} \right) + \ j2\pi x\left\lbrack \frac{1}{\overline{\gamma}G}\left( - \frac{1}{T_{2}'} - \frac{1}{T_{2}} + \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack = - 4\pi^{2}x^{2} - \frac{1}{{\overline{\gamma}}^{2}G^{2}}\left( \frac{1}{{T_{2}'}^{2}} - \frac{1}{T_{2}^{2}} \right) - \frac{4\pi x}{\overline{\gamma}GT_{2}}j\]

La PSF nel dominio dello spazio-immagine è:

\[h_{SE}(x) = \frac{- \frac{2}{\overline{\gamma}GT_{2}'} - \left\lbrack j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) \right\rbrack\exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) - j\pi\overline{\gamma}T_{S}Gx \right)}{- 4\pi^{2}x^{2} - \frac{1}{{\overline{\gamma}}^{2}G^{2}}\left( \frac{1}{{T_{2}'}^{2}} - \frac{1}{T_{2}^{2}} \right) - \frac{4\pi x}{\overline{\gamma}GT_{2}}j} + \frac{\left\lbrack j2\pi x + \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack\exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + j\pi\overline{\gamma}T_{S}Gx \right)}{- 4\pi^{2}x^{2} - \frac{1}{{\overline{\gamma}}^{2}G^{2}}\left( \frac{1}{{T_{2}'}^{2}} - \frac{1}{T_{2}^{2}} \right) - \frac{4\pi x}{\overline{\gamma}GT_{2}}j}\]

Al denominatore la parte immaginaria è pesata per \(T_{2}\), per cui può essere trascurata:

\[- 4\pi^{2}x^{2} - \frac{1}{{\overline{\gamma}}^{2}G^{2}}\left( \frac{1}{{T_{2}'}^{2}} - \frac{1}{T_{2}^{2}} \right) - \frac{4\pi x}{\overline{\gamma}GT_{2}} \simeq - 4\pi^{2}x^{2} - \frac{1}{{\overline{\gamma}}^{2}G^{2}{T_{2}'}^{2}}\]

Per quanto riguarda il numeratore, si considera il termine:

\[\left\lbrack j2\pi x - \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) \right\rbrack\exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) - j\pi\overline{\gamma}T_{S}Gx \right) \simeq \left( j2\pi x - \frac{1}{\overline{\gamma}GT_{2}'} \right)\exp\left( - \frac{1}{2}\frac{T_{S}}{T_{2}'} - j\pi\overline{\gamma}T_{S}Gx \right)\]

Per il secondo termine, si ottiene:

\[\left\lbrack j2\pi x + \frac{1}{\overline{\gamma}G}\left( \frac{1}{T_{2}'} - \frac{1}{T_{2}} \right) \right\rbrack\exp\left( - \frac{T_{S}}{2}\left( \frac{1}{T_{2}'} + \frac{1}{T_{2}} \right) + j\pi\overline{\gamma}T_{S}Gx \right) \simeq \left( \ j2\pi x + \frac{1}{\overline{\gamma}GT_{2}'} \right)\exp\left( - \frac{T_{S}}{2T_{2}'} + j\pi\overline{\gamma}T_{S}Gx \right)\]

La PSF, in questa ipotesi, è data da:

\[h_{SE}(x) \simeq \frac{- \frac{2}{\overline{\gamma}GT_{2}'} + \left( j2\pi x - \frac{1}{\overline{\gamma}GT_{2}'} \right)\exp\left( - \frac{1}{2}\frac{T_{S}}{T_{2}'} - j\pi\overline{\gamma}T_{S}Gx \right) + \left( \ j2\pi x + \frac{1}{\overline{\gamma}GT_{2}'} \right)\exp\left( - \frac{T_{S}}{2T_{2}'} + j\pi\overline{\gamma}T_{S}Gx \right)}{- \frac{1}{{\overline{\gamma}}^{2}G^{2}{T_{2}'}^{2}} - 4\pi^{2}x^{2}}\]
...
\[\exp\left( - \frac{1}{2}\frac{T_{S}}{T_{2}'} - j\pi\overline{\gamma}T_{S}Gx \right) = \exp\left( - \frac{1}{2}\frac{T_{S}}{T_{2}'} \right)\exp\left( - j\pi\overline{\gamma}T_{S}Gx \right)\]
...
\[\exp\left( - \frac{1}{2}\frac{T_{S}}{T_{2}'} \right)\exp\left( - j\pi\overline{\gamma}T_{S}Gx \right) \rightarrow 0,T_{S} \gg T_{2}'\]
...
\[h_{SE}(x) = \frac{- \frac{2}{\overline{\gamma}GT_{2}'}}{- \frac{1}{{\overline{\gamma}}^{2}G^{2}{T_{2}'}^{2}} - 4\pi^{2}x^{2}}\]

Riarragiando i termini si può scrivere:

\[h_{SE}(x) = \frac{2\overline{\gamma}GT_{2}'}{1 - 4\pi^{2}x^{2}{\overline{\gamma}}^{2}G^{2}{T_{2}'}^{2}}\]
...
\[\widehat{\rho}(x) = \Delta k\sum_{p = - \frac{N}{2}}^{\frac{N}{2} - 1}{s(p\Delta k)\exp\left( \frac{j2\pi pq}{N} \right)}\]
...
\[\Delta x = \left. \ \frac{1}{NW} \right|_{W = 2W} = \frac{1}{2NW} = \frac{\Delta x}{2}\]
...
0,\ \  & - N \leq p \leq - \frac{N}{2} - 1 \\
s(p\Delta k),\ \  & - \frac{N}{2} \leq p \leq \frac{N}{2} - 1 \\
0,\ \  & \frac{N}{2} \leq p \leq N - 1
\end{aligned} \right.\ \]
...
\[{\widehat{\rho}}_{0}\left( q\frac{\Delta x}{2} \right) = \frac{1}{2N}\sum_{p = - N}^{N - 1}{{\widehat{s}}_{0}(p\Delta k)\exp\left( j2\pi\frac{pq}{2N} \right)}\]
...
\[{\widehat{\rho}}_{0}\left( q\frac{\Delta x}{2} \right) = \frac{1}{2N}\sum_{p = - \frac{N}{2}}^{\frac{N}{2} - 1}{{\widehat{s}}_{0}(p\Delta k)\exp\left( j2\pi\frac{pq}{2N} \right)}\]
...
\[\left. \ {\widehat{\rho}}_{0}\left( q\frac{\Delta x}{2} \right) \right|_{q = 2r} = {\widehat{\rho}}_{0}(r\Delta x) = \frac{1}{2N}\sum_{p = - \frac{N}{2}}^{\frac{N}{2} - 1}{{\widehat{s}}_{0}(p\Delta k)\exp\left( j2\pi\frac{rq}{N} \right)}\]
...
\[{\widehat{\rho}}_{0}(q\Delta x) = \frac{1}{2}\widehat{\rho}(r\Delta x)\]
...
\[\left. \ {\widehat{\rho}}_{0}\left( q\frac{\Delta x}{2} \right) \right|_{q = 2r} = {\widehat{\rho}}_{0}\left( (2r + 1)\frac{\Delta x}{2} \right) = \frac{1}{2N}\sum_{p = - \frac{N}{2}}^{\frac{N}{2} - 1}{{\widehat{s}}_{0}(p\Delta k)\exp\left( j2\pi\frac{(2r + 1)q}{2N} \right)} = \frac{1}{2N}\sum_{p = - \frac{N}{2}}^{\frac{N}{2} - 1}{{\widehat{s}}_{0}(p\Delta k)\exp\left( j\pi\frac{(2r + 1)q}{N} \right)}\]

Per le proprietà degli esponenziali, si ha:

\[= \frac{1}{2N}\sum_{p = - \frac{N}{2}}^{\frac{N}{2} - 1}{\left( {\widehat{s}}_{0}(p\Delta k)\exp\left( j\pi\frac{p}{N} \right) \right)\exp\left( j2\pi\frac{rp}{N} \right)}\]

Per il teorema della traslazione, è possibile scrivere:

\[{\widehat{\rho}}_{0}\left( (2r + 1)\frac{\Delta x}{2} \right) = \frac{1}{2}\widehat{\rho}\left( r\Delta x + \frac{\Delta x}{2} \right)\]
...
s_{m}(p\Delta k)\left\lbrack 1 + \cos\left( \pi + \frac{\pi\left( p + n_{-} \right)}{u} \right) \right\rbrack + \\
 + {\widetilde{s}}_{j + 1}(p\Delta k)\left\lbrack 1 + \cos\left( 1 + \frac{\pi\left( p + n_{-} \right)}{u} \right) \right\rbrack
