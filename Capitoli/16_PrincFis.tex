...
\[E\left\lbrack \frac{dN}{dt} \right\rbrack = - E\left\lbrack N(t) \right\rbrack\lambda\]

Si ottiene, quindi, un'equazione del tipo:

\[- \frac{dN}{dt} = \lambda N\]

Dove \(- \frac{dN}{dt}\) è il tasso di decadimento, o attività, e può essere anche indicato con \(A\). La soluzione è ovviamente del tipo esponenziale:
...
\[A\left( t_{\frac{1}{2}} \right) = \frac{1}{2}A_{0}\]

\[A_{0}e^{- \lambda t} = \frac{1}{2}A_{0}\]

Da quest'ultima relazione è possibile ricavare la definizione del tempo di emivita:

\[t_{\frac{1}{2}} = \frac{\log(2)}{\lambda} = \frac{0.693}{\lambda}\]
...
\[A(\tau) = A_{0}e^{- \lambda\tau} = A_{0}e^{- \frac{\lambda}{\lambda}} = \frac{A_{0}}{e} = 0.63A_{0}\]
...
\[\frac{1}{T_{e}} = \frac{1}{T_{b}} + \frac{1}{T_{p}}\]
...
\[t_{\frac{1}{2}} = 110min \Leftrightarrow \ t_{\frac{1}{2}} = \frac{110min}{60min/h} = 1.8h\]
...
\[t_{\frac{1}{2}} = \frac{0.693}{\lambda} \Leftrightarrow \lambda = \frac{0.693}{t_{\frac{1}{2}}} = \frac{0.693}{1.8h} = 0.385\frac{1}{h}\]
...
\[A(7h) = A(10h)e^{- \lambda t} = 740MBq \cdot e^{- 0.385\frac{1}{h} \cdot 7h} \simeq 51MBq\]

\[A(14h) = A(10h)e^{- \lambda t} = 740MBq \cdot e^{- 0.385\frac{1}{h} \cdot 14h} \simeq 3.5MBq\]
...
\[m_{e_{i}}c^{2} + hf_{i} = m_{e_{f}}c^{2} + hf_{f} + \frac{1}{2}m_{e_{f}}v^{2}\]

Dove:

\[m_{e_{f}} = \frac{m_{e_{i}}}{\sqrt{1 - \left( \frac{v^{2}}{c^{2}} \right)}}\]

Scomponendo l'equazione per la conservazione della quantità di moto si ottiene un sistema:

\[\left\{ \begin{array}{r}
\frac{h}{\lambda_{i}} = \frac{m_{e_{i}}}{\sqrt{1 - \left( \frac{v^{2}}{c^{2}} \right)}}\cos\varphi + \frac{h}{\lambda_{f}}\cos\varphi \\
\frac{m_{e_{i}}}{\sqrt{1 - \left( \frac{v^{2}}{c^{2}} \right)}}\sin\theta = \frac{h}{\lambda_{f}}\sin\theta
\end{array} \right.\ \]

Dal sistema, aggiungendo anche la conservazione dell'energia, si ricava che:

\[\lambda_{f} - \lambda_{i} = \mathrm{\Delta}\lambda = \frac{h}{m_{e_{i}}c}\left( 1 - \cos\varphi \right)\]
...
\[N(HVL) = \frac{N_{0}}{2} \Leftrightarrow \frac{N_{0}}{2} = N_{0}e^{- \mu HVL}\]

Da cui si ricava:

\[HVL = - {\frac{\log\left( \frac{1}{2} \right)}{\mu} = \frac{\log(2)}{\mu} = \frac{0.693}{\mu}}\]
...
Il coefficiente di attenuazione massico è misurato in \(\frac{cm^{2}}{kg}\).
