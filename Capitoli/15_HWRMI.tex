...
\[\omega_{0} = \gamma B_{0} = 42.67\dfrac{MHz}{T}3\ T = 128MHz\]
...
\[\Delta B = 42.6\dfrac{MHz}{T}1.5\ T\ 1ppm = 64\ Hz\]
...
\[\left\{ \begin{matrix}
B_{r}(R,\vartheta) = \dfrac{\mu}{2}\sum_{n = 1}^{\infty}{\dfrac{c_{n}}{n + 1}R^{n}P_{n}^{1}\left( \cos\vartheta \right)} \\
B_{z}(R,\vartheta) = \dfrac{\mu}{2}\sum_{n = 0}^{\infty}{c_{n}R^{n}P_{n}\left( \cos\vartheta \right)}
\end{matrix} \right.\ \]
...
\[fem \propto - \dfrac{dB}{dt} = S_{\max}\dfrac{Fov}{2}\]
...
\[\dfrac{F_{m}}{F_{g}} = \dfrac{\chi_{m}B_{0}\left| \overset{\underline{}}{\nabla}{\overset{\underline{}}{B}}_{0} \right|}{\mu_{0}\rho g}\]
...
\[\dfrac{F_{torc}L}{F_{m}} \simeq \dfrac{B_{0}}{\left| \overset{\underline{}}{\nabla}{\overset{\underline{}}{B}}_{0} \right|}\]
...
\[F_{torc} = \dfrac{B_{0}}{\left| \overset{\underline{}}{\nabla}{\overset{\underline{}}{B}}_{0} \right|}\dfrac{1}{L}F_{m} = \dfrac{30\ T}{10\dfrac{T}{m}1 \cdot 10^{- 2}m}F_{m} = 300F_{m}\]
...
\[\overset{\underline{}}{\nabla} \times \overset{\underline{}}{E} = - \dfrac{\partial\overset{\underline{}}{B}}{\partial t}\]
...
\[\lbrack SAR\rbrack = \left\lbrack \dfrac{W}{kg} \right\rbrack\]
...
\[\lbrack TR\rbrack = \left\lbrack \dfrac{{^\circ}C}{s} \right\rbrack\]
...
\[TR = \dfrac{SAR}{c} = \dfrac{4.2\dfrac{Js}{kg}}{4200\dfrac{J}{kg{^\circ}C}} = 1 \cdot 10^{- 3}\dfrac{{^\circ}C}{s}\]
