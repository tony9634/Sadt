...
\[\left| \Delta f_{fw} \right| = \left| - \sigma_{fw}\overline{\gamma}B_{0} \right| = 3.335 \cdot 10^{- 6} \cdot 42.6 \cdot 10^{6}\frac{Hz}{T}1.5\ T = 214\ Hz\]
...
\[s = s(w)\exp\left( - j\omega_{0}t \right) + s(f)\exp\left( - \left( \omega_{0} + \frac{\Delta f_{fw}}{2\pi} \right)t \right)\]
...
\[x_{1} - x_{f} = \frac{\Delta f_{fw}}{\overline{\gamma}G_{x}}\]
...
\[\phi_{f}\left( t' \right) = - 2\pi\overline{\gamma}G_{x}\left( x + \frac{\Delta B_{fw}}{G_{x}} \right)t'\]

Questa relazione può essere espressa in termini del \(k\)-spazio:

\[\phi_{f}\left( k_{x} \right) = - 2\pi k_{x}\left( x + \frac{\Delta B_{fw}}{G_{x}} \right)\]
...
\[\phi_{f}\left( k_{x} \right) = - 2\pi k_{x}\left( x + \frac{\Delta B_{fw}}{G_{x}} \right) - 2\pi\overline{\gamma}\Delta B_{fw}T_{E}\]
...
\[T_{E,IN} = \frac{2\pi}{\Delta\omega_{fw}} \simeq 4.54\ ms\]

\[T_{E,OP} = \frac{\pi}{\Delta\omega_{fw}} \simeq 2.27\ ms\]
