...
\[\varepsilon_{int} = \varepsilon_{abs}\dfrac{4\pi}{\Omega}\]
...
\[\Psi(x,t) = \psi(x) \cdot \Phi(t) = u(x)e^{jkx}e^{- j\dfrac{E}{\hslash}t} = u(x)e^{j\left( kx - \dfrac{E}{\hslash}t \right)}\]
...
\[\dfrac{d^{2}u_{I}}{dx^{2}} + 2jk\dfrac{du_{I}}{dx} - \left( k^{2} - \alpha^{2} \right)u_{I}(x) = 0\]

\[\dfrac{d^{2}u_{II}}{dx^{2}} + 2jk\dfrac{du_{II}}{dx} - \left( k^{2} - \beta^{2} \right)u_{II}(x) = 0\]

Dove

\[\alpha^{2} = \dfrac{2mE}{\hslash^{2}}\]

\[\beta^{2} = \dfrac{2mE}{\hslash^{2}} - \dfrac{2mV_{0}}{\hslash^{2}}\]
...
u_{I}(0) = u_{II}(0) \\
u_{I}(a) = u_{II}( - b) \\
\left. \ \dfrac{du_{I}}{dx} \right|_{x = 0} = \left. \ \dfrac{du_{II}}{dx} \right|_{x = 0} \\
\left. \ \dfrac{du_{I}}{dx} \right|_{x = a} = \left. \ \dfrac{du_{II}}{dx} \right|_{x = - b}
\end{array} \right.\ \]
...
\[\cos\left( k(a + b) \right) = \dfrac{\alpha^{2} + \beta^{2}}{2\alpha\beta}\sin(a\alpha) + \sin(b\beta) + \cos(a\alpha)\cos(b\beta)\]
...
\[\cos(ka) = \dfrac{mV_{0}ab}{\hslash^{2}}\dfrac{\sin(a\alpha)}{a\alpha} + \cos(a\alpha)\]
...
\[Efficienza = \dfrac{numero\ di\ fotoni}{numero\ di\ coppie}\]
...
\[X_{\gamma} = \dfrac{(B + D) - (A + C)}{A + B + C + D}\]

\[Y_{\gamma} = \dfrac{(A + B) - (C + D)}{A + B + C + D}\]
