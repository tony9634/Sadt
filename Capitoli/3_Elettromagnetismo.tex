...
\[\begin{cases}
\displaystyle \oiint_{S}{\vec{E} \cdot d\vec{S}\ } = \dfrac{Q}{\varepsilon_{0}} \\
\displaystyle \oiint_{S}{\vec{B} \cdot d\vec{S}\ } = 0  \\
\displaystyle \oint_{\partial S}{\vec{E} \cdot d\vec{s}} = - \dfrac{\partial}{\partial t}\int_{\Sigma}{\vec{B} \cdot d\vec{\Sigma}}  \\
\displaystyle \oint_{\partial S}{\vec{B} \cdot d\vec{s}} = \mu_{0}I + \mu_{0}\varepsilon_{0}\dfrac{\partial}{\partial t}\int_{\Sigma}{\vec{E} \cdot d\vec{\Sigma}}
\end{cases}
\]
...
\end{pmatrix} = \begin{pmatrix}
    \displaystyle \mu_x\dfrac{\partial}{\partial x} + \mu_y\dfrac{\partial}{\partial y} + \mu_z\dfrac{\partial}{\partial z}
\end{pmatrix}\begin{pmatrix}
B_{x} \\
B_{y} \\
B_{z}
\end{pmatrix} = \begin{pmatrix}
\displaystyle \mu_x\dfrac{\partial B_x}{\partial x} + \mu_y\dfrac{\partial B_x}{\partial y} + \mu_z\dfrac{\partial B_x}{\partial z} \\
\displaystyle \mu_x\dfrac{\partial B_y}{\partial x} + \mu_y\dfrac{\partial B_y}{\partial y} + \mu_z\dfrac{\partial B_y}{\partial z} \\
\displaystyle \mu_x\dfrac{\partial B_z}{\partial x} + \mu_y\dfrac{\partial B_z}{\partial y} + \mu_z\dfrac{\partial B_z}{\partial z}
\end{pmatrix}
\]
...
0 \\
0 \\
\displaystyle \mu_z\dfrac{\partial B_z}{\partial z}
\end{pmatrix}
\]
