...
La suscettività magnetica è definita mediante il campo magnetico \(\vec{H}\) dalla relazione \(\chi_{m}=M_0/H\). Ma, poiché si suppone che la densità di atomi magnetici sia piccola, risulta che \(\vec{B}_0= \mu_0\vec{H}\) con ottima approssimazione. La magnetizzazione si scrive come:
