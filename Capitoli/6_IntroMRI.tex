...
\[M \simeq \dfrac{N}{V}\dfrac{\gamma^{2}\hslash^{2}}{4k_{B}T}B_{0}\]
...
\[\gamma = \dfrac{\left| \gamma_{e} \right|}{\gamma_{p}} = \dfrac{1.76 \cdot 10^{11}\ \dfrac{rad}{Ts}}{2.68 \cdot 10^{8}\ \dfrac{rad}{Ts}} = 658\]
...
\[f_{0} = 2\pi\omega_{0} = 2\pi 1.76 \cdot 10^{11}\ \dfrac{rad}{Ts}1.5\ T = 42\ GHz\]
...
\[s = - \dfrac{d}{dt}\int_{V}^{}{\overset{\underline{}}{M} \cdot {\overset{\underline{}}{B}}_{RF}dV}\]
...
\[\dfrac{dM}{dt} = \omega_{0}M = \gamma B_{0}M\]
...
\[s \propto \ \rho\dfrac{\gamma^{3}}{T}B_{0}^{2}\]
...
\[\overline{\gamma} = \dfrac{\gamma}{2\pi} = \dfrac{2.68 \cdot 10^{8}\ \dfrac{rad}{Ts}}{2\pi} = 42.6\dfrac{MHz}{T}\]

Con un campo statico principale di \(1.5\ T\) si ha una frequenza di precessione data da:

\[f_{0} = \overline{\gamma}B_{0} = 42.6\dfrac{MHz}{T}1.5\ T \simeq 64\ MHz\]

Per un campo di \(3\ T\), risulta invece:

\[f_{0} = \overline{\gamma}B_{0} = 42.6\dfrac{MHz}{T}3\ T \simeq 128\ MHz\]
...
\[\overset{\underline{}}{\tau} = \dfrac{d\overset{\underline{}}{L}}{dt}\]
...
\[\overset{\underline{}}{\mu} = \gamma\overset{\underline{}}{L} \Leftrightarrow \overset{\underline{}}{L} = \dfrac{1}{\gamma}\overset{\underline{}}{\mu}\]

Sostituendo i due risultati nell'equazione differenziale si ha:

\[\overset{\underline{}}{\mu} \times \overset{\underline{}}{B} = \dfrac{d}{dt}\left( \dfrac{1}{\gamma}\overset{\underline{}}{\mu} \right) \Leftrightarrow \dfrac{d\overset{\underline{}}{\mu}}{dt} = \gamma\overset{\underline{}}{\mu} \times \overset{\underline{}}{B}\]
...
\[\dfrac{d\overset{\underline{}}{\mu}}{dt} = \gamma\overset{\underline{}}{\mu} \times \overset{\underline{}}{B}\]
...
\[\overset{\underline{}}{\mu} \cdot \dfrac{d\overset{\underline{}}{\mu}}{dt} = \gamma\overset{\underline{}}{\mu} \cdot \left( \overset{\underline{}}{\mu} \times \overset{\underline{}}{B} \right)\]
...
\[\overset{\underline{}}{\mu} \cdot \dfrac{d\overset{\underline{}}{\mu}}{dt} = \gamma\overset{\underline{}}{\mu} \cdot \left( \overset{\underline{}}{\mu} \times \overset{\underline{}}{B} \right) = 0\]

Il prodotto scalare tra \(\overset{\underline{}}{\mu}\) e la sua derivata può essere scritto come:

\[\overset{\underline{}}{\mu} \cdot \dfrac{d\overset{\underline{}}{\mu}}{dt} = \dfrac{1}{2}\dfrac{d}{dt}\left( \overset{\underline{}}{\mu} \cdot \overset{\underline{}}{\mu} \right) = \dfrac{1}{2}\dfrac{d}{dt}\left| \overset{\underline{}}{\mu} \right|^{2} = 0\]
...
\[\dfrac{d\overset{\underline{}}{\mu}}{dt} = \gamma B_{0}\left( \mu_{y}{\widehat{i}}_{x} - \mu_{x}{\widehat{i}}_{y} \right)\]
...
\[\dfrac{d\mu_{\bot}}{dt} = - j\omega_{o}\mu_{\bot}\]

Dove \(\omega_{o} = \gamma B_{0}\) è la frequenza di precessione di Larmor. Per definizione di \(\mu_{\bot}(t)\), si ha:

\[\dfrac{d\mu_{\bot}}{dt} = - j\omega_{o}\mu_{\bot} = - j\omega_{o}\mu_{x}(t) - j\omega_{o}\left\lbrack j\mu_{y}(t) \right\rbrack = - j\omega_{o}\mu_{x}(t) - j\omega_{o}\mu_{y}(t)\]

Inoltre, deve risultare:

\[\dfrac{d\mu_{\bot}}{dt} = \dfrac{d\mu_{x}}{dt} + j\dfrac{d\mu_{y}}{dt}\]

Confrontando le due espressioni risulta che:

\[\dfrac{d\mu_{x}}{dt} = - j\omega_{o}\mu_{x}(t),\ \ \dfrac{d\mu_{y}}{dt} = - j\omega_{o}\mu_{y}(t)\]
...
\[\dfrac{d\mu_{\bot}}{dt} = - j\omega_{o}\mu_{\bot} \Leftrightarrow \dfrac{1}{\mu_{\bot}}d\mu_{\bot} = - j\omega_{o}\ dt\]
...
\[\overset{\underline{}}{\mu} \cdot \dfrac{d\overset{\underline{}}{\mu}}{dt} = 0\]
...
\[\dfrac{d\overset{\underline{}}{c}}{dt} = \overset{\underline{}}{\Omega} \times \overset{\underline{}}{c}\]
...
\[\dfrac{d\overset{\underline{}}{c}}{dt} = \overset{\underline{}}{0}\]
...
\[\left( \dfrac{d\overset{\underline{}}{c}}{dt} \right)' = \overset{\underline{}}{\Omega} \times {\overset{\underline{}}{c}}' \neq \overset{\underline{}}{0}\]
...
\[\dfrac{d\overset{\underline{}}{c}}{dt} = \dfrac{d}{dt}\left\lbrack c_{x}(t){\widehat{i}}_{x} + c_{y}(t){\widehat{i}}_{y} + c_{z}(t){\widehat{i}}_{z} \right\rbrack = \dfrac{dc_{x}}{dt}{\widehat{i}}_{x} + c_{x}\dfrac{d{\widehat{i}}_{x}}{dt} + \dfrac{dc_{y}}{dt}{\widehat{i}}_{y} + c_{y}\dfrac{d{\widehat{i}}_{y}}{dt} + \dfrac{dc_{z}}{dt}{\widehat{i}}_{z} + c_{z}\dfrac{d{\widehat{i}}_{z}}{dt}\]

Siccome il sistema di riferimento è fisso, le derivate dei suoi versori sono nulle:

\[\dfrac{d{\widehat{i}}_{x}}{dt} = 0,\ \ \dfrac{d{\widehat{i}}_{y}}{dt} = 0,\ \ \dfrac{d{\widehat{i}}_{z}}{dt} = 0\]

Si ottiene:

\[\dfrac{d\overset{\underline{}}{c}}{dt} = \dfrac{dc_{x}}{dt}{\widehat{i}}_{x} + \dfrac{dc_{y}}{dt}{\widehat{i}}_{y} + \dfrac{dc_{z}}{dt}{\widehat{i}}_{z}\]

La derivata del sistema rotante è, invece:

\[\dfrac{d\overset{\underline{}}{c}}{dt} = \dfrac{dc_{x'}}{dt}{\widehat{i}}_{x'} + c_{x'}\dfrac{d{\widehat{i}}_{x'}}{dt} + \dfrac{dc_{y'}}{dt}{\widehat{i}}_{y'} + c_{y'}\dfrac{d{\widehat{i}}_{y'}}{dt} + \dfrac{dc_{z'}}{dt}{\widehat{i}}_{z'} + c_{z'}\dfrac{d{\widehat{i}}_{z'}}{dt}\]
...
\[\dfrac{d{\widehat{i}}_{x'}}{dt} = \overset{\underline{}}{\Omega} \times {\widehat{i}}_{x'},\ \ \dfrac{d{\widehat{i}}_{y'}}{dt} = \overset{\underline{}}{\Omega} \times {\widehat{i}}_{y'},\ \ \dfrac{d{\widehat{i}}_{z'}}{dt} = \overset{\underline{}}{\Omega} \times {\widehat{i}}_{z'}\]

Per cui la derivata nel sistema rotante può essere scritta sostituendo queste relazioni:

\[\dfrac{d\overset{\underline{}}{c}}{dt} = \dfrac{dc_{x'}}{dt}{\widehat{i}}_{x'} + c_{x'}\overset{\underline{}}{\Omega} \times {\widehat{i}}_{x'} + \dfrac{dc_{y'}}{dt}{\widehat{i}}_{y'} + c_{y'}\overset{\underline{}}{\Omega} \times {\widehat{i}}_{y'} + \dfrac{dc_{z'}}{dt}{\widehat{i}}_{z'} + c_{z'}\overset{\underline{}}{\Omega} \times {\widehat{i}}_{z'} = \dfrac{dc_{x'}}{dt}{\widehat{i}}_{x'} + \dfrac{dc_{y'}}{dt}{\widehat{i}}_{y'} + \dfrac{dc_{z'}}{dt}{\widehat{i}}_{z'} + \overset{\underline{}}{\Omega} \times \left( c_{x'}{\widehat{i}}_{x'} + c_{y'}{\widehat{i}}_{y'} + c_{z'}{\widehat{i}}_{z'} \right)\]
...
\[\left( \dfrac{d\overset{\underline{}}{c}}{dt} \right)' = \dfrac{dc_{x'}}{dt}{\widehat{i}}_{x'} + \dfrac{dc_{y'}}{dt}{\widehat{i}}_{y'} + \dfrac{dc_{z'}}{dt}{\widehat{i}}_{z'}\]
...
\[\dfrac{d\overset{\underline{}}{c}}{dt} = \left( \dfrac{d\overset{\underline{}}{c}}{dt} \right)' + \overset{\underline{}}{\Omega} \times {\overset{\underline{}}{c}}'\]
...
\[\dfrac{d\overset{\underline{}}{\mu}}{dt} = \left( \dfrac{d\overset{\underline{}}{\mu}}{dt} \right)' + \overset{\underline{}}{\Omega} \times \overset{\underline{}}{\mu}\]
...
\[\gamma\overset{\underline{}}{\mu} \times \overset{\underline{}}{B} = \left( \dfrac{d\overset{\underline{}}{\mu}}{dt} \right)' + \overset{\underline{}}{\Omega} \times \overset{\underline{}}{\mu}\]

Ricavando la derivata nel sistema rotante si ha:

\[\left( \dfrac{d\overset{\underline{}}{\mu}}{dt} \right)' = \gamma\overset{\underline{}}{\mu} \times \overset{\underline{}}{B} - \overset{\underline{}}{\Omega} \times \overset{\underline{}}{\mu}\]
...
\[\left( \dfrac{d\overset{\underline{}}{\mu}}{dt} \right)' = \gamma\overset{\underline{}}{\mu} \times \overset{\underline{}}{B} + \overset{\underline{}}{\mu} \times \overset{\underline{}}{\Omega} = \gamma\overset{\underline{}}{\mu} \times \left( \overset{\underline{}}{B} + \dfrac{1}{\gamma}\overset{\underline{}}{\Omega} \right)\]

Si definisce campo magnetico effettivo o efficace come:

\[{\overset{\underline{}}{B}}_{eff} = \overset{\underline{}}{B} + \dfrac{1}{\gamma}\overset{\underline{}}{\Omega}\]

L'equazione per il momento magnetico nel sistema rotante assume la forma:

\[\left( \dfrac{d\overset{\underline{}}{\mu}}{dt} \right)' = \gamma\overset{\underline{}}{\mu} \times {\overset{\underline{}}{B}}_{eff}\]
...
\[{\overset{\underline{}}{B}}_{eff} = B_{0}{\widehat{i}}_{z} - \dfrac{1}{\gamma}\omega{\widehat{i}}_{z}\]

Se la frequenza con cui ruota il sistema coincide con quella di Larmor, ovvero \(\omega = \omega_{0} = \gamma B_{0}\), allora:

\[{\overset{\underline{}}{B}}_{eff} = B_{0}{\widehat{i}}_{z} - \dfrac{1}{\gamma}\omega_{0}{\widehat{i}}_{z} = B_{0}{\widehat{i}}_{z} - \dfrac{1}{\gamma}\gamma B_{0}{\widehat{i}}_{z} = \overset{\underline{}}{0}\]
...
\[{\overset{\underline{}}{B}}_{x}(t) = b_{x}(t)\left\lbrack \dfrac{1}{2}\cos\left( 2\omega_{0}t \right) + \dfrac{1}{2} \right\rbrack{\widehat{i}}_{x'} + \dfrac{1}{2}b_{x}(t)\sin\left( 2\omega_{0}t \right){\widehat{i}}_{y'}\]
...
\[{\overset{\underline{}}{B}}_{x}(t) = \dfrac{1}{2}b_{x}(t){\widehat{i}}_{x'} + b_{x}(t)\left\lbrack \dfrac{1}{2}\cos\left( 2\omega_{0}t \right){\widehat{i}}_{x'} + \dfrac{1}{2}\sin\left( 2\omega_{0}t \right){\widehat{i}}_{y'} \right\rbrack\]
...
\[\left\langle {\overset{\underline{}}{B}}_{x}(t) \right\rangle = \dfrac{1}{T}\int_{T}^{}{{\overset{\underline{}}{B}}_{x}(t)dt} = \dfrac{1}{2T}\int_{T}^{}{\left| \left\{ b_{x}(t){\widehat{i}}_{x'} + b_{x}(t)\left\lbrack \cos\left( 2\omega_{0}t \right){\widehat{i}}_{x'} + \sin\left( 2\omega_{0}t \right){\widehat{i}}_{y'} \right\rbrack \right\} \right|dt} = \dfrac{1}{2}\left\langle b_{x}(t) \right\rangle\]
...
\[\left( \dfrac{d\overset{\underline{}}{\mu}}{dt} \right)' = \gamma\overset{\underline{}}{\mu} \times \left( B_{0}{\widehat{i}}_{z} - \dfrac{1}{\gamma}\omega{\widehat{i}}_{z} + B_{1}{\widehat{i}}_{x'} \right)\]
...
\[\left( \dfrac{d\overset{\underline{}}{\mu}}{dt} \right)' = \gamma B_{1}\overset{\underline{}}{\mu} \times {\widehat{i}}_{x'}\]
...
\[{\overset{\underline{}}{B}}_{eff} = B_{0}{\widehat{i}}_{z} - \dfrac{1}{\gamma}\omega{\widehat{i}}_{z} + B_{1}{\widehat{i}}_{x'}\]
...
\[{\overset{\underline{}}{B}}_{eff} = \dfrac{1}{\gamma}\left\lbrack \left( \omega_{0} - \omega \right){\widehat{i}}_{z} + \omega_{1}{\widehat{i}}_{x'} \right\rbrack\]
...
\begin{figure}[ht]
\centering
\includegraphics[width=2.89286in,height=2.63294in,alt={P3086\#yIS1}]{media/6_IntroMRI/image66.pdf}\caption{Volumetto elementare di \(N_{A}\) di protoni in un campo magnetico diretto lungo \({\widehat{i}}_{z}\)}
\end{figure}
...
\[\overset{\underline{}}{M} = \dfrac{1}{V}\sum_{i = 1}^{N_{A}}{\overset{\underline{}}{\mu}}_{i}\]
...
\[\dfrac{d{\overset{\underline{}}{\mu}}_{i}}{dt} = \gamma{\overset{\underline{}}{\mu}}_{i} \times {\overset{\underline{}}{B}}_{0}\]

Sommando i vari contributi di ogni spin del volumetto e dividendo per il volume elementare si ha:

\[\dfrac{1}{V}\sum_{i = 1}^{N_{A}}\dfrac{d{\overset{\underline{}}{\mu}}_{i}}{dt} = \dfrac{1}{V}\sum_{i = 1}^{N_{A}}{\gamma{\overset{\underline{}}{\mu}}_{i} \times {\overset{\underline{}}{B}}_{0}}\]

Per la linearità dell'operatore somma e derivata è possibile scrivere:

\[\sum_{i = 1}^{N_{A}}{\dfrac{d}{dt}\left( \dfrac{1}{V}{\overset{\underline{}}{\mu}}_{i} \right)} = \sum_{i = 1}^{N_{A}}{\gamma\dfrac{1}{V}{\overset{\underline{}}{\mu}}_{i} \times {\overset{\underline{}}{B}}_{0}} \Leftrightarrow \dfrac{d}{dt}\left( \sum_{i = 1}^{N_{A}}{\dfrac{1}{V}{\overset{\underline{}}{\mu}}_{i}} \right) = \gamma\left( \sum_{i = 1}^{N_{A}}{\dfrac{1}{V}{\overset{\underline{}}{\mu}}_{i}} \right) \times {\overset{\underline{}}{B}}_{0}\]

Per definizione del vettore di magnetizzazione per unità di volume è possibile scrivere:

\[\dfrac{d\overset{\underline{}}{M}}{dt} = \gamma\overset{\underline{}}{M} \times {\overset{\underline{}}{B}}_{0}\]
...
\[\dfrac{d}{dt}\left( {\overset{\underline{}}{M}}_{\|} + {\overset{\underline{}}{M}}_{\bot} \right) = \gamma\left( {\overset{\underline{}}{M}}_{\|} + {\overset{\underline{}}{M}}_{\bot} \right) \times B_{o}{\widehat{i}}_{Z}\]

Per linearità:

\[\dfrac{d{\overset{\underline{}}{M}}_{\|}}{dt} + \dfrac{d{\overset{\underline{}}{M}}_{\bot}}{dt} = \gamma B_{o}{\overset{\underline{}}{M}}_{\|} \times {\widehat{i}}_{Z} + \gamma B_{o}{\overset{\underline{}}{M}}_{\bot} \times {\widehat{i}}_{Z}\]
...
\[\dfrac{d{\overset{\underline{}}{M}}_{\|}}{dt} + \dfrac{d{\overset{\underline{}}{M}}_{\bot}}{dt} = \gamma B_{o}{\overset{\underline{}}{M}}_{\bot} \times {\widehat{i}}_{Z}\]

Scrivendo le due equazioni per le proiezioni si ha:

\[\left\{ \begin{matrix}
\dfrac{dM_{\|}}{dt} = 0 \\
\dfrac{d{\overset{\underline{}}{M}}_{\bot}}{dt} = \gamma B_{o}{\overset{\underline{}}{M}}_{\bot} \times {\widehat{i}}_{Z}
\end{matrix} \right.\ \]
...
\[\overset{\underline{}}{A} = \dfrac{1}{\left| \overset{\underline{}}{r} \right|}\overset{\underline{}}{\mu} \times \overset{\underline{}}{r}\]
...
\[M_{z}(t) = M_{z}(0)\exp\left( - \dfrac{t}{T_{1}} \right) + M_{0}\left\lbrack 1 - \exp\left( - \dfrac{t}{T_{1}} \right) \right\rbrack\]
...
\[\dfrac{d\overset{\underline{}}{M}}{dt} = \gamma\overset{\underline{}}{M} \times {\overset{\underline{}}{B}}_{0} + R_{1}\left( M_{0} - M_{z}\  \right){\widehat{i}}_{z} - R_{2}{\overset{\underline{}}{M}}_{\bot}\]
...
\[\dfrac{d}{dt}\left( M_{x}{\widehat{i}}_{x} + M_{y}{\widehat{i}}_{y} + M_{z}{\widehat{i}}_{z} \right) = \gamma B_{0}\left( M_{y}{\widehat{i}}_{x} - M_{x}{\widehat{i}}_{y} \right) + \dfrac{1}{T_{1}}\left( M_{0} - M_{z}\  \right){\widehat{i}}_{z} - \dfrac{1}{T_{2}}\left( M_{x}{\widehat{i}}_{x} + M_{y}{\widehat{i}}_{y} \right)\]
...
\[M_{z}(t) = k\exp\left( - \dfrac{t}{T_{1}} \right)\]
...
\[M_{z}(t) = k\exp\left( - \dfrac{t}{T_{1}} \right) + M_{0}\]
...
\[M_{z}(t) = \left\lbrack M_{z}\left( t_{0} \right) - M_{0} \right\rbrack\exp\left( \dfrac{t_{0}}{T_{1}} \right)\exp\left( - \dfrac{t}{T_{1}} \right) + M_{0}\]

Esplicitando la componente transitoria e quella di regime, si ha:

\[M_{z}(t) = M_{0}\left\lbrack 1 - \exp\left( \dfrac{t_{0} - t}{T_{1}} \right) \right\rbrack + M_{z}\left( t_{0} \right)\exp\left( \dfrac{t_{0} - t}{T_{1}} \right)\]
...
\[M_{z}(t) = M_{0}\left\lbrack 1 - \exp\left( - \dfrac{t}{T_{1}} \right) \right\rbrack + M_{z}(0)\exp\left( - \dfrac{t}{T_{1}} \right)\]

Supponendo che il valore iniziale della magnetizzazione sia nullo, la soluzione diventa:

\[M_{z}(t) = M_{0}\left\lbrack 1 - \exp\left( - \dfrac{t}{T_{1}} \right) \right\rbrack\]
...
\[\dfrac{d}{dt}\left\lbrack \overset{\underline{}}{k}\exp\left( \lambda\overset{\underline{}}{\overset{\underline{}}{I}}t \right) \right\rbrack = \begin{pmatrix}
 - \dfrac{1}{T_{2}} & \omega_{0} \\
 - \omega_{0} & - \dfrac{1}{T_{2}}
...
\[\left\{ \begin{matrix}
M_{x}(t) = k_{1,x}\exp\left\lbrack \left( - \dfrac{1}{T_{2}} - j\omega_{0} \right)t \right\rbrack + k_{2,x}\exp\left\lbrack \left( - \dfrac{1}{T_{2}} + j\omega_{0} \right)t \right\rbrack \\
M_{y}(t) = k_{1,y}\exp\left\lbrack \left( - \dfrac{1}{T_{2}} - j\omega_{0} \right)t \right\rbrack + k_{2,y}\exp\left\lbrack \left( - \dfrac{1}{T_{2}} + j\omega_{0} \right)t \right\rbrack
\end{matrix} \right.\ \]

Per le proprietà degli esponenziali, è possibile scrivere:

\[\left\{ \begin{matrix}
M_{x}(t) = k_{1,x}\exp\left( - \dfrac{t}{T_{2}} \right)\exp\left( - j\omega_{0}t \right) + k_{2,x}\exp\left( - \dfrac{t}{T_{2}} \right)\exp\left( j\omega_{0}t \right) \\
M_{y}(t) = k_{1,y}\exp\left( - \dfrac{t}{T_{2}} \right)\exp\left( - j\omega_{0}t \right) + k_{2,y}\exp\left( - \dfrac{t}{T_{2}} \right)\exp\left( j\omega_{0}t \right)
\end{matrix} \right.\ \]

Raccogliendo il termine dipendente da \(T_{2}\), si ottiene:

\[\left\{ \begin{matrix}
M_{x}(t) = \left\lbrack k_{1,x}\exp\left( - j\omega_{0}t \right) + k_{2,x}\exp\left( j\omega_{0}t \right) \right\rbrack\exp\left( - \dfrac{t}{T_{2}} \right) \\
M_{y}(t) = \left\lbrack k_{1,y}\exp\left( - j\omega_{0}t \right) + k_{2,y}\exp\left( j\omega_{0}t \right) \right\rbrack\exp\left( - \dfrac{t}{T_{2}} \right)
\end{matrix} \right.\ \]
...
\[M_{x}(t) = m_{x}(t)\exp\left( - \dfrac{t}{T_{2}} \right),\ \ M_{y}(t) = m_{y}(t)\exp\left( - \dfrac{t}{T_{2}} \right)\]
...
\[\left\{ \begin{matrix}
M_{x}(t) = \left\lbrack C_{1}\exp\left( - j\omega_{0}t \right) + C_{2}\exp\left( j\omega_{0}t \right) \right\rbrack\exp\left( - \dfrac{t}{T_{2}} \right) \\
M_{y}(t) = \left\lbrack - jC_{1}\exp\left( - j\omega_{0}t \right) + jC_{2}\exp\left( j\omega_{0}t \right) \right\rbrack\exp\left( - \dfrac{t}{T_{2}} \right)
\end{matrix} \right.\ \]
...
\[M_{x}(t) = \left\{ \left\lbrack \dfrac{1}{2}M_{x}\left( t_{0} \right) - \dfrac{1}{2j}M_{y}\left( t_{0} \right) \right\rbrack\exp\left( \dfrac{t_{0}}{T_{2}} \right)\exp\left\lbrack - j\omega_{0}\left( t - t_{0} \right) \right\rbrack + \left\lbrack \dfrac{1}{2}M_{x}\left( t_{0} \right) - j\dfrac{1}{2}M_{y}\left( t_{0} \right) \right\rbrack\exp\left( - j\omega_{0}t_{0} \right)\exp\left\lbrack j\omega_{0}\left( t - t_{0} \right) \right\rbrack \right\}\exp\left( - \dfrac{t}{T_{2}} \right)\]

Raccogliendo opportunamente si ha:

\[M_{x}(t) = \left\{ M_{x}\left( t_{0} \right)\dfrac{\exp\left\lbrack j\omega_{0}\left( t - t_{0} \right) \right\rbrack + \exp\left\lbrack - j\omega_{0}\left( t - t_{0} \right) \right\rbrack}{2} + M_{y}\left( t_{0} \right)\dfrac{\exp\left\lbrack j\omega_{0}\left( t - t_{0} \right) \right\rbrack - \exp\left\lbrack - j\omega_{0}\left( t - t_{0} \right) \right\rbrack}{2j} \right\}\exp\left( - \dfrac{t - t_{0}}{T_{2}} \right)\]

Per le relazioni di Eulero, risulta:

\[M_{x}(t) = \left\{ M_{x}\left( t_{0} \right)\cos\left\lbrack \omega_{0}\left( t - t_{0} \right) \right\rbrack + M_{y}\left( t_{0} \right)\sin{\cos\left\lbrack \omega_{0}\left( t - t_{0} \right) \right\rbrack} \right\}\exp\left( - \dfrac{t - t_{0}}{T_{2}} \right)\]
...
\[M_{y}(t) = \left\{ \left\lbrack \dfrac{1}{2j}M_{x}\left( t_{0} \right) + \dfrac{1}{2}M_{y}\left( t_{0} \right) \right\rbrack\exp\left( \dfrac{t_{0}}{T_{2}} \right)\exp\left\lbrack - j\omega_{0}\left( t - t_{0} \right) \right\rbrack + \left\lbrack - \dfrac{1}{2j}M_{x}\left( t_{0} \right) + \dfrac{1}{2}M_{y}\left( t_{0} \right) \right\rbrack\exp\left( \dfrac{t_{0}}{T_{2}} \right)\exp\left\lbrack j\omega_{0}\left( t - t_{0} \right) \right\rbrack \right\}\exp\left( - \dfrac{t}{T_{2}} \right)\]

Raccogliendo opportunamente si ha:

\[M_{y}(t) = \left\{ - M_{x}\left( t_{0} \right)\dfrac{\exp\left\lbrack j\omega_{0}\left( t - t_{0} \right) \right\rbrack - \exp\left\lbrack - j\omega_{0}\left( t - t_{0} \right) \right\rbrack}{2j} + M_{y}\left( t_{0} \right)\dfrac{\exp\left\lbrack j\omega_{0}\left( t - t_{0} \right) \right\rbrack + \exp\left\lbrack - j\omega_{0}\left( t - t_{0} \right) \right\rbrack}{2} \right\}\exp\left( - \dfrac{t - t_{0}}{T_{2}} \right)\]

Per l'equivalenza di Eulero risulta:

\[M_{y}(t) = \left\{ - M_{x}\left( t_{0} \right)\sin\left\lbrack \omega_{0}\left( t - t_{0} \right) \right\rbrack + M_{y}\left( t_{0} \right)\cos\left\lbrack \omega_{0}\left( t - t_{0} \right) \right\rbrack \right\}\exp\left( - \dfrac{t - t_{0}}{T_{2}} \right)\]

In definitiva, le componenti trasverse evolvono secondo le seguenti equazioni:

\[\left\{ \begin{matrix}
M_{x}(t) = \left\{ M_{x}\left( t_{0} \right)\cos\left\lbrack \omega_{0}\left( t - t_{0} \right) \right\rbrack + M_{y}\left( t_{0} \right)\sin\left\lbrack \omega_{0}\left( t - t_{0} \right) \right\rbrack \right\}\exp\left( - \dfrac{t - t_{0}}{T_{2}} \right) \\
M_{y}(t) = \left\{ - M_{x}\left( t_{0} \right)\sin\left\lbrack \omega_{0}\left( t - t_{0} \right) \right\rbrack + M_{y}\left( t_{0} \right)\cos\left\lbrack \omega_{0}\left( t - t_{0} \right) \right\rbrack \right\}\exp\left( - \dfrac{t - t_{0}}{T_{2}} \right)
\end{matrix} \right.\ \]
...
\[\left\{ \begin{matrix}
M_{x}(t) = \left\lbrack M_{x}(0)\cos\left( \omega_{0}t \right) + M_{y}(0)\sin\left( \omega_{0}t \right) \right\rbrack\exp\left( - \dfrac{t}{T_{2}} \right) \\
M_{y}(t) = \left\lbrack - M_{x}(0)\sin\left( \omega_{0}t \right) + M_{y}(0)\cos\left( \omega_{0}t \right) \right\rbrack\exp\left( - \dfrac{t - t_{0}}{T_{2}} \right)
\end{matrix} \right.\ \]
...
\[M_{+}(t) = M_{x}(t) + jM_{y}(t) = \left\lbrack M_{x}(0)\cos\left( \omega_{0}t \right) + M_{y}(0)\sin\left( \omega_{0}t \right) - jM_{x}(0)\sin\left( \omega_{0}t \right) + jM_{y}(0)\cos\left( \omega_{0}t \right) \right\rbrack\exp\left( - \dfrac{t}{T_{2}} \right)\]

Raccogliendo si ottiene:

\[M_{+}(t) = \left\{ M_{x}(0)\left\lbrack \cos\left( \omega_{0}t \right) - j\sin\left( \omega_{0}t \right) \right\rbrack + jM_{y}(0)\left\lbrack \cos\left( \omega_{0}t \right) - j\sin\left( \omega_{0}t \right) \right\rbrack \right\}\exp\left( - \dfrac{t}{T_{2}} \right) = \left\{ \left\lbrack \cos\left( \omega_{0}t \right) - j\sin\left( \omega_{0}t \right) \right\rbrack\left\lbrack M_{x}(0) + jM_{y}(0) \right\rbrack \right\}\exp\left( - \dfrac{t}{T_{2}} \right)\]
...
\[M_{+}(t) = M_{+}(0)\exp\left( - j\omega_{0}t \right)\exp\left( - \dfrac{t}{T_{2}} \right) = M_{+}(0)\exp\left\lbrack - \left( j\omega_{0}t + \dfrac{t}{T_{2}} \right) \right\rbrack\ \]
...
\[{\overset{\underline{}}{B}}_{eff} = \left( B_{0} - \dfrac{\omega}{\gamma} \right){\widehat{i}}_{z} + B_{1}{\widehat{i}}_{x'}\]
...
\[\left( \dfrac{d\overset{\underline{}}{M}}{dt} \right)' = \gamma\overset{\underline{}}{M} \times {\overset{\underline{}}{B}}_{eff} + \dfrac{1}{T_{1}}\left( M_{0} - M_{z}\  \right){\widehat{i}}_{z} - \dfrac{1}{T_{2}}{\overset{\underline{}}{M}}_{\bot}\]
...
\end{matrix} \right| = M_{y'}\left( B_{0} - \dfrac{\omega}{\gamma} \right){\widehat{i}}_{x'} + M_{z}B_{1}{\widehat{i}}_{y'} - M_{y'}B_{1}{\widehat{i}}_{z} - M_{x'}\left( B_{0} - \dfrac{\omega}{\gamma} \right){\widehat{i}}_{y'}\]

Raccogliendo i termini, si ottiene:

\[\overset{\underline{}}{M} \times {\overset{\underline{}}{B}}_{eff} = M_{y'}\left( B_{0} - \dfrac{\omega}{\gamma} \right){\widehat{i}}_{x'} + M_{z}B_{1}{\widehat{i}}_{y'} - M_{y'}B_{1}{\widehat{i}}_{z} - M_{x'}\left( B_{0} - \dfrac{\omega}{\gamma} \right){\widehat{i}}_{y'} = M_{y'}\left( B_{0} - \dfrac{\omega}{\gamma} \right){\widehat{i}}_{x'} - \left\lbrack M_{x'}\left( B_{0} - \dfrac{\omega}{\gamma} \right) - M_{z}B_{1} \right\rbrack{\widehat{i}}_{y'} - M_{y'}B_{1}{\widehat{i}}_{z}\]

L'equazione vettoriale di Bloch si scrive:

\[\left( \dfrac{d\overset{\underline{}}{M}}{dt} \right)' = \gamma\overset{\underline{}}{M} \times {\overset{\underline{}}{B}}_{eff} + \dfrac{1}{T_{1}}\left( M_{0} - M_{z}\  \right){\widehat{i}}_{z} - \dfrac{1}{T_{2}}{\overset{\underline{}}{M}}_{\bot} = \gamma\left\{ M_{y'}\left( B_{0} - \dfrac{\omega}{\gamma} \right){\widehat{i}}_{x'} - \left\lbrack M_{x'}\left( B_{0} - \dfrac{\omega}{\gamma} \right) - M_{z}B_{1} \right\rbrack{\widehat{i}}_{y'} - M_{y'}B_{1}{\widehat{i}}_{z} \right\} + \dfrac{1}{T_{1}}\left( M_{0} - M_{z}\  \right){\widehat{i}}_{z} - \dfrac{1}{T_{2}}\left( M_{x'}{\widehat{i}}_{x'} + M_{y'}{\widehat{i}}_{y'} \right)\]
...
\[M_{+}(t) = M_{+}(0)\exp\left( - \dfrac{t}{T_{2}} \right)\exp\left( - j\omega_{0}t \right)\]
