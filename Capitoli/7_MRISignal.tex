...
\subsubsection{\texorpdfstring{Origine del tempo \(\mathbf{T}_{\mathbf{2}}^{\mathbf{*}}\)}{Origine del tempo \textbackslash mathbf\{T\}\_\{\textbackslash mathbf\{2\}\}\^{}\{\textbackslash mathbf\{*\}\}}}\label{origine-del-tempo-mathbft_mathbf2mathbf}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}
  >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3333}}@{}}
\caption{Figura .: Andamento degli spin nella sequenza spin-echo}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\centering
\includegraphics[width=1.5in,height=1.28in,alt={Immagine che contiene orologio, schermata Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image105.pdf}\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
\includegraphics[width=1.5in,height=1.28in,alt={Immagine che contiene orologio, schermata Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image106.pdf}\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
\includegraphics[width=1.5in,height=1.28in,alt={Immagine che contiene orologio, schermata Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image107.pdf}\end{minipage} \\
\midrule\noalign{}
\endfirsthead
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\centering
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=1.5in,height=1.28in,alt={Immagine che contiene orologio, schermata Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image108.pdf}\includegraphics[width=1.5in,height=1.28in]{media/7_MRISignal/image111.pdf}\includegraphics[width=1.5in,height=1.28in,alt={Immagine che contiene schermata, aeromobile, aeroplano Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image114.pdf}\includegraphics[width=1.5in,height=1.28in,alt={Immagine che contiene aeromobile Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image117.pdf}\includegraphics[width=1.5in,height=1.28in]{media/7_MRISignal/image120.pdf}\includegraphics[width=1.5in,height=1.28in]{media/7_MRISignal/image123.pdf}\end{longtable}
...
\subsubsection{\texorpdfstring{Applicazione multipla dei gradienti a \(\mathbf{\pi}\)}{Applicazione multipla dei gradienti a \textbackslash mathbf\{\textbackslash pi\}}}\label{applicazione-multipla-dei-gradienti-a-mathbfpi}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2500}}@{}}
\caption{Figura .: Movimento degli spin nella sequenza multiple spin-echo}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\centering
\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, linea, design, testo Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image129.pdf}\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, linea, design, testo Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image129.pdf}\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, schermata, diagramma, testo Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image130.pdf}\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene linea, schermata, diagramma, design Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image131.pdf}\end{minipage} \\
\midrule\noalign{}
\endfirsthead
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\centering
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, disegno, design, arte Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image132.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, disegno, diagramma, design Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image136.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, disegno, diagramma, design Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image140.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, design, arte Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image144.pdf}\includegraphics[width=1.5in,height=1.69243in]{media/7_MRISignal/image148.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, diagramma, linea, design Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image152.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene linea, schizzo, diagramma, design Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image156.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, linea, diagramma, design Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image160.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, linea, diagramma, disegno Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image164.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, disegno, linea, design Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image168.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, disegno, design, arte Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image172.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, disegno, diagramma, design Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image176.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, disegno, diagramma, linea Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image180.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, design, disegno, diagramma Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image184.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, diagramma, disegno, linea Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image188.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, disegno, diagramma, design Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image192.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, disegno, design, arte Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image196.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, disegno, diagramma, linea Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image200.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, linea, diagramma, disegno Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image204.pdf}\includegraphics[width=1.5in,height=1.69243in,alt={Immagine che contiene schizzo, disegno, diagramma, linea Il contenuto generato dall\textquotesingle IA potrebbe non essere corretto.}]{media/7_MRISignal/image208.pdf}\end{longtable}
...
\paragraph{\texorpdfstring{Stima del tempo \(\mathbf{T}_{\mathbf{2}}\) da \(\mathbf{n}\) misurazioni}{Stima del tempo \textbackslash mathbf\{T\}\_\{\textbackslash mathbf\{2\}\} da \textbackslash mathbf\{n\} misurazioni}}\label{stima-del-tempo-mathbft_mathbf2-da-mathbfn-misurazioni}
