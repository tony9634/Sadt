...
\begin{align*}
\text{emf}\left( t \right) \propto \int_{V'} \frac{\partial}{\partial t} \Bigg\{ 
...
\[
s\left( t \right) \propto \omega_0 \int_V \exp\left( - \frac{t}{T_2(\vec{r})} \right) \vec{B}_\perp(\vec{r}) \cdot \vec{M}_\perp(\vec{r}) \sin\left( \omega_0(\vec{r}) t \right) dV
\]
...
\[
M_{\bot}(t) \propto \exp\!\left(-\frac{t}{T_2}\right).
\]
...
\[
M_{\bot} \propto \exp\!\left(-\frac{T_E}{T_2}\right).
\]
