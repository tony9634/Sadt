...
\subsection{\texorpdfstring{Utilizzo dei gradienti per campionare il \(\mathbf{k}\)-spazio}{9Utilizzo dei gradienti per campionare il \textbackslash mathbf\{k\}-spazio}}\label{utilizzo-dei-gradienti-per-campionare-il-mathbfk-spazio}
