...
\[G_{z} = \dfrac{\partial}{\partial z}B_{z}\left( \overset{\underline{}}{r} \right),G_{x} = \dfrac{\partial}{\partial x}B_{z}\left( \overset{\underline{}}{r} \right),G_{y} = \dfrac{\partial}{\partial y}B_{z}\left( \overset{\underline{}}{r} \right)\]
...
\[B_{1} = A{sinc}\left( 2\pi f\left( z_{0} \right)t \right){rect}\left( \dfrac{z}{\Delta z} \right)\]
...
\[TH = \Delta z = \dfrac{BW_{RF}}{\overline{\gamma}G_{z}}\]
...
\[d = \dfrac{\Delta\omega_{slice} - 2\pi BW}{\gamma G_{z}}\]
