...
In altre parole, in questo caso la lagrangiana coincide con l'energia cinetica della particella. Inoltre, la descrizione lagrangiana si riduce alla modellazione newtoniana, dato che il sistema di riferimento corrisponde con quello cartesiano. Tuttavia, nella pratica non è sempre conveniente descrivere il moto in coordinate cartesiane. In presenza di vincoli o geometrie particolari, è utile ricorrere alle coordinate generalizzate \(\mathbf{q}\) e \(\mathbf{\dot{q}}\). È quindi necessario esprimere l'energia del sistema in funzione di queste coordinate. Tuttavia, nella pratica non è sempre conveniente descrivere il moto in coordinate cartesiane. In presenza di vincoli o geometrie particolari, è utile ricorrere alle coordinate generalizzate \(\mathbf{q}\) e \(\mathbf{\dot{q}}\). È quindi necessario esprimere l'energia del sistema in funzione di queste coordinate.
...
\[
\dfrac{\partial L}{\partial{\dot{x}}_{i}} = \dot{p}_i
\]
...
\[
\begin{cases}
\displaystyle p_{i} = \dfrac{\partial L}{\partial{\dot{q}}_{i}} & \quad (\text{Momento generalizzato coniugato}) \\
\displaystyle Q_{i} = - \dfrac{\partial U}{\partial q_{i}} & \quad (\text{Forza generalizzata conservativa})
\end{cases}
\]
