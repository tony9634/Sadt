...
\[= L\left( \vec{q},\vec{\dot{q}} \right) + \left( \dfrac{\partial L}{\partial\vec{q}},\dfrac{\partial L}{\partial\dot{\vec{q}}} \right) \cdot \left( \delta\vec{q},\ \delta\vec{\dot{q}} \right) =\]

Svolgendo l'operazione di prodotto scalare si ha:

\[= L\left( \vec{q},\dot{\vec{q}} \right) + \dfrac{\partial L}{\partial\vec{q}}\delta\vec{q} + \dfrac{\partial L}{\partial\vec{\dot{q}}}\ \delta\dot{\vec{q}\ }\]
...
\[S + \delta S = \int_{t_{0}}^{t_{1}}{\left\lbrack L\left( \vec{q},\vec{\dot{q}} \right) + \dfrac{\partial L}{\partial\vec{q}}\delta\vec{q} + \dfrac{\partial L}{\partial\vec{\dot{q}}}\ \delta\vec{\dot{q}\ } \right\rbrack dt}\]

Per la linearità dell'integrale si scrive:

\[S + \delta S = \int_{t_{0}}^{t_{1}}{L\left( \vec{q},\vec{\dot{q}} \right)dt} + \int_{t_{0}}^{t_{1}}{\left( \dfrac{\partial L}{\partial\vec{q}}\delta\vec{q} + \dfrac{\partial L}{\partial\vec{\dot{q}}}\ \delta\vec{\dot{q}} \right)dt}\]
...
\[S + \delta S = S + \int_{t_{0}}^{t_{1}}{\left( \dfrac{\partial L}{\partial\vec{q}}\delta\vec{q} + \dfrac{\partial L}{\partial\vec{\dot{q}}}\ \delta\vec{\dot{q}} \right)dt}\]

Semplificando \(S\), si ottiene un'espressione per la variazione dell'azione \(\delta S\):

\[\delta S = \int_{t_{0}}^{t_{1}}{\left( \dfrac{\partial L}{\partial\vec{q}}\delta\vec{q} + \dfrac{\partial L}{\partial\vec{\dot{q}}}\ \delta\vec{\dot{q}} \right)dt}\]
...
\[\vec{\dot{q}} = \dfrac{d\vec{q}}{dt}\]

Allora, deve accadere che:

\[\delta\vec{\dot{q}} = \dfrac{d}{dt}\left( \delta\vec{q} \right)\]

Dunque, la variazione di azione può essere espressa come:

\[\delta S = \int_{t_{0}}^{t_{1}}{\left( \dfrac{\partial L}{\partial\vec{q}}\delta\vec{q} + \dfrac{\partial L}{\partial\vec{\dot{q}}}\ \delta\vec{\dot{q}} \right)dt} = \int_{t_{0}}^{t_{1}}{\dfrac{\partial L}{\partial\vec{q}}\delta\vec{q}dt} + \int_{t_{0}}^{t_{1}}{\dfrac{\partial L}{\partial\vec{\dot{q}}}\ \dfrac{d}{dt}\left( \delta\vec{q} \right)dt}\]
...
\[\dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\dot{\vec{q}}}\delta\vec{q} \right) = \left( \dfrac{d}{dt}\dfrac{\partial L}{\partial\dot{\vec{q}}} \right)\delta\vec{q} + \dfrac{\partial L}{\partial\vec{\dot{q}}}\dfrac{d}{dt}\left( \delta\vec{q} \right)\]

Da cui è possibile ricavare:

\[\dfrac{\partial L}{\partial\vec{\dot{q}}}\dfrac{d}{dt}\left( \delta\vec{q} \right) = \dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\dot{\vec{q}}}\delta\vec{q} \right) - \left( \dfrac{d}{dt}\dfrac{\partial L}{\partial\dot{\vec{q}}} \right)\delta\vec{q}\]
...
\[\delta S = \int_{t_{0}}^{t_{1}}{\left\lbrack \left( \dfrac{\partial L}{\partial\vec{q}} - \dfrac{d}{dt}\dfrac{\partial L}{\partial\vec{\dot{q}}} \right)\delta\vec{q} + \dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}}\delta\vec{q} \right) \right\rbrack dt} = \int_{t_{0}}^{t_{1}}{\left( \dfrac{\partial L}{\partial\vec{q}} - \dfrac{d}{dt}\dfrac{\partial L}{\partial\vec{\dot{q}}} \right)\delta\vec{q}dt} + \int_{t_{0}}^{t_{1}}{\dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}}\delta\vec{q} \right)dt}\]

Si considera l'ultimo integrale. Risulta che:

\[\int_{t_{0}}^{t_{1}}{\dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}}\delta\vec{q} \right)dt} = \left. \ \ \dfrac{\partial L}{\partial\vec{\dot{q}}}\delta\vec{q} \right|_{t_{0}}^{t_{1}}\ \]

Ma, poiché \(\delta\vec{q}\left( t_{0} \right) = \delta\vec{q}\left( t_{1} \right) = \vec{0}\), l'integrale è nullo. In definitiva, si ottiene:

\[\delta S = \int_{t_{0}}^{t_{1}}{\left( \dfrac{\partial L}{\partial\vec{q}} - \dfrac{d}{dt}\dfrac{\partial L}{\partial\vec{\dot{q}}} \right)\delta\vec{q}dt}\]

Dato che l'azione deve essere stazionaria, la sua variazione deve essere nulla \(\delta S = 0\). Per cui si ha:

\[\int_{t_{0}}^{t_{1}}{\left( \dfrac{\partial L}{\partial\vec{q}} - \dfrac{d}{dt}\dfrac{\partial L}{\partial\vec{\dot{q}}} \right)\delta\vec{q}dt} = 0\]
...
\[\dfrac{d}{dt}L\left( \vec{q},\vec{\dot{q}} \right) = \dfrac{\partial L}{\partial\vec{q}}\dfrac{d\vec{q}}{dt} + \dfrac{\partial L}{\partial\vec{\dot{q}}}\dfrac{d\vec{\dot{q}}}{dt}\]
...
\[\dfrac{d}{dt}L\left( \vec{q},\vec{\dot{q}} \right) = \dfrac{\partial L}{\partial\vec{q}}\vec{\dot{q}} + \dfrac{\partial L}{\partial\vec{\dot{q}}}\vec{\ddot{q}}\]

Si considera la quantità:

\[\dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}}\vec{\dot{q}} \right)\]

Svolgendo la derivata si ottiene:

\[\dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}}\vec{\dot{q}} \right) = \dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}} \right)\vec{\dot{q}} + \dfrac{\partial L}{\partial\vec{\dot{q}}}\dfrac{d\vec{\dot{q}}}{dt} = \dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}} \right)\vec{\dot{q}} + \dfrac{\partial L}{\partial\vec{\dot{q}}}\vec{\ddot{q}}\]

Si isola il termine contenente \(\vec{\ddot{q}}\):

\[\dfrac{\partial L}{\partial\vec{\dot{q}}}\vec{\ddot{q}} = \dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}}\vec{\dot{q}} \right) - \dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}} \right)\vec{\dot{q}}\]

Si sostituisce questo risultato nella derivata temporale della lagrangiana:

\[\dfrac{dL}{dt} = \dfrac{\partial L}{\partial\vec{q}}\vec{\dot{q}} + \dfrac{\partial L}{\partial\vec{\dot{q}}}\vec{\ddot{q}} = \dfrac{\partial L}{\partial\vec{q}}\vec{\dot{q}} + \dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}}\vec{\dot{q}} \right) - \dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}} \right)\vec{\dot{q}}\]

Si porta il termine \(\dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}}\vec{\dot{q}} \right)\) al primo membro:

\[\dfrac{dL}{dt} - \dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}}\vec{\dot{q}} \right) = \dfrac{\partial L}{\partial\vec{q}}\vec{\dot{q}} - \dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}} \right)\vec{\dot{q}} \Leftrightarrow \dfrac{d}{dt}\left( L - \dfrac{\partial L}{\partial\vec{\dot{q}}}\vec{\dot{q}} \right) = \left\lbrack \dfrac{\partial L}{\partial\vec{q}} - \dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}} \right) \right\rbrack\vec{\dot{q}}\]

Per l'equazione di Eulero-Lagrange, il secondo membro è nullo:

\[\dfrac{\partial L}{\partial\vec{q}} - \dfrac{d}{dt}\left( \dfrac{\partial L}{\partial\vec{\dot{q}}} \right) = \vec{0}\]

Dunque:

\[\dfrac{d}{dt}\left( L - \dfrac{\partial L}{\partial\vec{\dot{q}}}\vec{\dot{q}} \right) = 0\]

Integrando rispetto al tempo si ottiene:

\[L - \dfrac{\partial L}{\partial\vec{\dot{q}}}\vec{\dot{q}} = cost\]
...
\[\dfrac{\partial L}{\partial\vec{\dot{q}}} = \dfrac{\partial}{\partial\vec{\dot{q}}}(T - U) = \dfrac{\partial L}{\partial\vec{\dot{q}}}\]

Dalle relazioni tra meccanica lagrangiana e newtoniana è possibile scrivere:

\[\dfrac{\partial L}{\partial\vec{\dot{q}}} = {\vec{p}}^{T} = m{\vec{\dot{q}}}^{T}\]

Moltiplicando ambo i membri per \(\vec{\dot{q}}\), si ha:

\[\dfrac{\partial L}{\partial\vec{\dot{q}}}\vec{\dot{q}} = m{\vec{\dot{q}}}^{T}\vec{\dot{q}} = m{\dot{q}}^{2}\]
...
\[L - \dfrac{\partial L}{\partial\vec{\dot{q}}}\vec{\dot{q}} = cost \Leftrightarrow T - U - 2T = cost\]
...
\[\dfrac{d}{dt}\dfrac{\partial L}{\partial\vec{\dot{\vartheta}}} - \dfrac{\partial L}{\partial\vec{\vartheta}} = \vec{0}\]
...
\[dL\left( \vec{q},\vec{\dot{q}} \right) = \sum_{i = 1}^{N}\left( \dfrac{\partial L}{\partial q_{i}}dq_{i} + \dfrac{\partial L}{\partial{\dot{q}}_{i}}d{\dot{q}}_{i} \right)\]
