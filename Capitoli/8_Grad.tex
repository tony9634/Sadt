...
\[M_{0} \simeq \rho\frac{\gamma^{2}\hslash^{2}}{4k_{B}T}B_{0},\ \ \rho = \frac{N}{V}\]
...
\[M_{\bot}\left( \overset{\underline{}}{r},0 \right) = M_{0}\left( \overset{\underline{}}{r} \right) = \frac{1}{4}\rho\left( \overset{\underline{}}{r} \right)\frac{\gamma^{2}\hslash^{2}}{k_{B}T}B_{0}\]
...
\[s(t) = \Lambda\omega_{0}B_{\bot}\int_{V}^{}{\frac{1}{4}\rho\left( \overset{\underline{}}{r} \right)\frac{\gamma^{2}\hslash^{2}}{k_{B}T}B_{0}\exp\left( j\left( \Omega t + \phi\left( \overset{\underline{}}{r},t \right) \right) \right)dV}\]

Si definisce densità protonica efficace \(\widehat{\rho}\left( \overset{\underline{}}{r} \right)\) come:

\[\widehat{\rho}\left( \overset{\underline{}}{r} \right) = \frac{1}{4}\Lambda\omega_{0}B_{\bot}\frac{\gamma^{2}\hslash^{2}}{k_{B}T}B_{0}\rho\left( \overset{\underline{}}{r} \right)\]
...
\[G_{z}(t) = \frac{\partial B_{z}}{\partial z}\]
...
\[\mathrm{\Delta}f = 42.5\ \frac{MHz}{T} \cdot 10\frac{mT}{m} \cdot 0.5\ m \simeq 200\ kHz\]
...
\[s(k) = {\widehat{\rho}}_{0}\int_{- z_{0}}^{z_{0}}{\exp( - j2\pi kz)dz} = - \frac{1}{j2\pi k}{\widehat{\rho}}_{0}\int_{- z_{0}}^{z_{0}}{\left\lbrack j2\pi kz\exp( - j2\pi kz) \right\rbrack dz} =\]

La cui soluzione è:

\[= - \frac{1}{j2\pi k}{\widehat{\rho}}_{0}\left. \ \exp( - j2\pi kz) \right|_{- z_{0}}^{z_{0}} = - \frac{1}{j2\pi k}{\widehat{\rho}}_{0}\left\lbrack \exp\left( - j2\pi kz_{0} \right) - \exp\left( j2\pi kz_{0} \right) \right\rbrack\]
...
\[s(k) = {\widehat{\rho}}_{0}\left( - \frac{1}{j2\pi k} \right)\left\lbrack - 2j\sin\left( 2\pi kz_{0} \right) \right\rbrack = {\widehat{\rho}}_{0}\frac{\sin\left( 2\pi kz_{0} \right)}{\pi k}\]

Per scrivere il segnale registrato nel \(k\)-spazio più compatto, si moltiplica e divide per \(2z_{0}\):

\[s(k) = {\widehat{\rho}}_{0}\frac{\sin\left( 2\pi kz_{0} \right)}{\pi k}\frac{2z_{0}}{2z_{0}} = 2z_{0}{\widehat{\rho}}_{0}\frac{\sin\left( 2\pi kz_{0} \right)}{2\pi kz_{0}}\]
