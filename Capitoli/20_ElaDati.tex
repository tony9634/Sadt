...
\vfill
    ...
    \label{blx:ElaDati\therefsection}
\vfill
...
\subsubsection[Attenuazione dei fotoni γ]{Attenuazione dei fotoni $\gamma$}
\label{attenuazione-fotoni-gamma}
