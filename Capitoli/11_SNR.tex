...
\[{\widehat{\rho}}_{m}(p\Delta x,q\Delta y,r\Delta z) = \frac{1}{N_{x}N_{y}N_{z}}\sum_{p' = - N_{x}}^{N_{x}}{\sum_{q' = - N_{y}}^{N_{y}}{\sum_{r' = - N_{z}}^{N_{z}}{s\left( p'\Delta k_{x},q'\Delta k_{y},r'\Delta k_{z} \right)\exp\left( j2\pi\left( \frac{pp'}{N_{x}} + \frac{qq'}{N_{y}} + \frac{rr'}{N_{z}} \right) \right)}}}\]

È possibile compattare la notazione unendo le tre sommatorie:

\[{\widehat{\rho}}_{m}(p\Delta x,q\Delta y,r\Delta z) = \frac{1}{N_{x}N_{y}N_{z}}\sum_{p',q',r'}^{}{s\left( p'\Delta k_{x},q'\Delta k_{y},r'\Delta k_{z} \right)\exp\left( j2\pi\left( \frac{pp'}{N_{x}} + \frac{qq'}{N_{y}} + \frac{rr'}{N_{z}} \right) \right)}\]
...
\[\widehat{\rho}(p\Delta x,q\Delta y,r\Delta z) \propto \frac{{\overline{\gamma}}^{3}\hslash^{2}}{4k_{B}T}B_{0}^{2}B_{\bot}(p\Delta x,q\Delta y,r\Delta z)\Delta x\Delta y\Delta z\]
...
\[\rho(p\Delta x) = \frac{1}{N}\sum_{q = - \frac{N}{2}}^{\frac{N}{2} - 1}{s(q\Delta k)\exp(j2\pi pq\Delta k\Delta x)}\]

Mentre \(\eta\) è la trasformata inversa del rumore additivo \(\varepsilon\) nel \(k\)-spazio:

\[\eta(p\Delta x) = \frac{1}{N}\sum_{q = - \frac{N}{2}}^{\frac{N}{2} - 1}{\varepsilon(q\Delta k)\exp(j2\pi pq\Delta k\Delta x)}\]
...
\[E\left\lbrack \eta(p\Delta x) \right\rbrack = \frac{1}{N}\sum_{q = - \frac{N}{2}}^{\frac{N}{2} - 1}{E\left\lbrack \varepsilon(q\Delta k) \right\rbrack\exp(j2\pi pq\Delta k\Delta x)}\]
...
\[\eta(r\Delta x)\eta^{*}(s\Delta x) = \left( \frac{1}{N}\sum_{r = - \frac{N}{2}}^{\frac{N}{2} - 1}{\varepsilon(r\Delta k)\exp(j2\pi rq\Delta k\Delta x)} \right)\left( \frac{1}{N}\sum_{s = - \frac{N}{2}}^{\frac{N}{2} - 1}{\varepsilon(s\Delta k)\exp(j2\pi sp\Delta k\Delta x)} \right)^{*}\]

Che può essere scritta come:

\[\eta(r\Delta x)\eta^{*}(s\Delta x) = \frac{1}{N^{2}}\sum_{r = - \frac{N}{2}}^{\frac{N}{2} - 1}{\sum_{s = - \frac{N}{2}}^{\frac{N}{2} - 1}{\varepsilon(r\Delta k)\varepsilon^{*}(r\Delta k)\exp\left( j2\pi p(r - s)\Delta k\Delta x \right)}}\]

Applicando l'operatore media statistica e la proprietà di linearità si ottiene:

\[E\left\lbrack \eta(r\Delta x)\eta^{*}(s\Delta x) \right\rbrack = \frac{1}{N^{2}}\sum_{r = - \frac{N}{2}}^{\frac{N}{2} - 1}{\sum_{s = - \frac{N}{2}}^{\frac{N}{2} - 1}{E\left\lbrack \varepsilon(p\Delta k)\varepsilon^{*}(p\Delta k) \right\rbrack\exp\left( j2\pi p(r - s)\Delta k\Delta x \right)}}\]
...
\[E\left\lbrack \eta(r\Delta x)\eta^{*}(s\Delta x) \right\rbrack = \frac{1}{N^{2}}\sigma_{m}^{2}\sum_{r = s}^{}\delta_{rs} = \frac{1}{N^{2}}\sigma_{m}^{2}N = \frac{\sigma_{m}^{2}}{N}\]

Si pone \(\sigma_{o}^{2}\) come:

\[\sigma_{o}^{2} = E\left\lbrack \eta(r\Delta x)\eta^{*}(s\Delta x) \right\rbrack = \frac{\sigma_{m}^{2}}{N}\]
...
\[VAR\left\lbrack \eta(p,q) \right\rbrack \propto \frac{\sigma_{m}^{2}}{N_{x}N_{y}}\]
...
\[VAR\left\lbrack \eta(p,q,r) \right\rbrack \propto \frac{\sigma_{m}^{2}}{N_{x}N_{y}N_{z}}\]
...
\[s_{m,av}(k) = \frac{1}{N_{acq}}\sum_{i = 1}^{N_{acq}}\left( s(k) + \varepsilon_{i}(k) \right)\]
...
\[s_{m,av}(k) = \frac{1}{N_{acq}}\sum_{i = 1}^{N_{acq}}{s(k)} + \frac{1}{N_{acq}}\sum_{i = 1}^{N_{acq}}{\varepsilon_{i}(k)}\]

Dato che il segnale utile non aria con la misura, si ha:

\[s_{m,av}(k) = \frac{s(k)}{N_{acq}}\sum_{i = 1}^{N_{acq}}1 + \frac{1}{N_{acq}}\sum_{i = 1}^{N_{acq}}{\varepsilon_{i}(k)} = \frac{s(k)}{N_{acq}}N_{acq} + \frac{1}{N_{acq}}\sum_{i = 1}^{N_{acq}}{\varepsilon_{i}(k)}\]

Dunque:

\[s_{m,av}(k) = s(k) + \frac{1}{N_{acq}}\sum_{i = 1}^{N_{acq}}{\varepsilon_{i}(k)}\]
...
\[\frac{1}{N_{acq}}\sum_{i = 1}^{N_{acq}}{\varepsilon_{i}(k)} \simeq 0\]
...
\[\sigma_{m,av}^{2} = VAR\left\lbrack s_{m,av}(k) \right\rbrack = \frac{1}{N_{acq}^{2}}\sum_{i = 1}^{N_{acq}}{VAR\left\lbrack s_{m.i}(k) \right\rbrack} = \frac{\sigma_{m}^{2}}{N_{acq}}\]

La deviazione standard, di conseguenza, è data da:

\[\sigma_{m,av} = \frac{\sigma_{m}}{\sqrt{N_{acq}}}\]
...
\[SNR = \frac{\overline{s_{m,av}(k)}}{\sigma_{m,av}} = \sqrt{N_{acq}}\frac{s(k)}{\sigma_{m}}\]
...
\[\sigma_{0}^{2} \propto \frac{BW}{N_{x}N_{y}N_{z}}\frac{1}{N_{acq}}\]
...
\[\left. \ SNR \right|_{\Delta x\Delta y\Delta z} = \frac{s}{\sigma_{0}} \propto \frac{\Delta x\Delta y\Delta z}{\sqrt{\frac{BW}{N_{x}N_{y}N_{z}}}}\sqrt{N_{acq}}\]
...
\[{BW}_{R} = \frac{1}{\Delta t}\]

Con questa considerazione, il rapporto segnale/rumore può essere espresso come:

\[\left. \ SNR \right|_{\Delta x\Delta y\Delta z} = \frac{s}{\sigma_{0}} \propto \frac{\Delta x\Delta y\Delta z}{\sqrt{\frac{BW}{N_{x}N_{y}N_{z}}}}\sqrt{N_{acq}} = \Delta x\Delta y\Delta z\sqrt{N_{acq}}\sqrt{N_{x}N_{y}N_{z}\Delta t}\]
...
\[BW/voxel = \frac{{BW}_{R}}{N_{x}} = \frac{\overline{\gamma}G_{x}L_{x}}{N_{x}}\]
...
\[L_{x}' = N_{x}'\Delta x' \Longleftrightarrow 2L_{x} = 2N_{x}\Delta x' \Leftrightarrow \Delta x' = \frac{L_{x}}{N_{x}} = \Delta x = cost\]
...
\[T_{S} = 2N_{x}\Delta t' \Leftrightarrow \Delta t = \frac{1}{2}\frac{T_{S}}{N_{x}} = \frac{\Delta t}{2}\]

Da questo risultato discende che la banda di ricezione raddoppia, infatti:

\[{BW}_{R}' = \frac{1}{\Delta t'} = \frac{2}{\Delta t} = 2BW\]
...
\[{BW}_{R}' = \overline{\gamma}G_{x}'L_{x}' \Leftrightarrow 2BW = 2\overline{\gamma}G_{x}'L_{x} \Leftrightarrow G_{x}' = \frac{BW}{\overline{\gamma}L_{x}} = G_{x}\]
...
\[L_{x}' = N_{x}'\Delta x' \Leftrightarrow L_{x} = N_{x}'2\Delta x \Leftrightarrow N_{x}' = \frac{1}{2}\frac{L_{x}}{\Delta x} = \frac{N_{x}}{2}\]
...
\[T_{S}' = N_{x}'\Delta t' \Leftrightarrow T_{S} = \frac{N_{x}}{2}\Delta t' \Leftrightarrow \Delta t' = 2\frac{T_{S}}{N_{x}} = 2\Delta t\]

Nella nuova sequenza, il gradiente di lettura deve anch'esso dimezzarsi, infatti:

\[\frac{1}{\Delta t'} = \overline{\gamma}G_{x}'L_{x}' \Leftrightarrow \frac{1}{2\Delta t} = \overline{\gamma}G_{x}'L_{x} \Leftrightarrow G_{x}' = \frac{\overline{\gamma}L_{x}}{2\Delta t} = \frac{1}{2}G_{x}\]
...
\[L_{x}' = N_{x}'\Delta x' \Leftrightarrow L_{x} = N_{x}'\frac{\Delta x}{2} \Leftrightarrow N_{x}' = 2\frac{L_{x}}{\Delta x} = 2N_{x}\]

Mentre l'intervallo di campionamento temporale deve dimezzarsi:

\[T_{S}' = N_{x}'\Delta t' \Leftrightarrow T_{S} = 2N_{x}\Delta t' \Leftrightarrow \Delta t' = \frac{1}{2}\frac{T_{S}}{N_{x}} = \frac{\Delta t}{2}\]

Da questo risultato si evince anche che l'ampiezza del gradiente deve raddoppiarsi:

\[\frac{1}{\Delta t'} = \overline{\gamma}G_{x}'L_{x}' \Leftrightarrow \frac{2}{\Delta t} = \overline{\gamma}G_{x}'L_{x} \Leftrightarrow G_{x}' = 2\frac{\overline{\gamma}L_{x}}{\Delta t} = 2G_{x}\]

Con questa scelta di parametri il rapporto segnale/rumore si dimezza:

\[{SNR}' \propto \Delta x'\sqrt{T_{S}'} = \frac{\Delta x}{2}\sqrt{T_{S}}\]
...
\[L_{y}' = N_{y}\Delta y' = N_{y}\frac{\Delta y}{2} = \frac{L_{y}}{2}\]
...
\[{SNR}'/voxel \propto \Delta y'\Delta z\sqrt{N_{y}'N_{z}} = \frac{\Delta y}{2}\sqrt{2N_{y}N_{z}} = \frac{\Delta y}{\sqrt{2}}\sqrt{N_{y}N_{z}} = \frac{1}{\sqrt{2}}SNR/voxel\]
...
\[{SNR}'/voxel \propto \Delta y'\Delta z\sqrt{N_{y}N_{z}} = \frac{\Delta y}{2}\sqrt{N_{y}N_{z}} = \frac{1}{2}SNR/voxel\]
...
\[{CNR}_{AB} = \frac{C_{AB}}{\sigma_{m}} = \frac{s_{A} - s_{B}}{\sigma_{m}} = {SNR}_{A} - {SNR}_{B}\]
...
\[M_{z}\left( T_{R} \right) = M_{0}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1}} \right) \right)\]
...
\[M_{\bot}\left( T_{E},T_{R} \right) = M_{0}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1}} \right) \right)\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\]
...
\[s\left( \rho,T_{1},T_{2} \right) \propto \rho(x,y,z) \propto M_{0}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1}} \right) \right)\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\]
...
\[s_{0} \propto M_{0}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1}} \right) \right)\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\]

Tendono rispettivamente a:

\[\exp\left( - \frac{T_{R}}{T_{1}} \right) \ll 1,\ T_{R} \gg T_{1}\]

\[\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right) \simeq 1,\ T_{E} \ll T_{2}^{*}\]
...
\[C_{AB} = M_{0,A}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1,A}} \right) \right)\exp\left( - \frac{T_{E}}{T_{2,A}^{*}} \right) - M_{0,B}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1,B}} \right) \right)\exp\left( - \frac{T_{E}}{T_{2,B}^{*}} \right)\]

Siccome \(T_{E} \ll T_{2}^{*}\) allora \(T_{E}/T_{2}^{*} \ll 1\), è possibile sviluppare in serie di Taylor \(\exp\left( - T_{E}/T_{2}^{*} \right)\):

\[\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right) \simeq 1 - \frac{T_{E}}{T_{2}^{*}}\]

Il contrasto può essere scritto come:

\[C_{AB} \simeq M_{0,A}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1,A}} \right) \right)\left( 1 - \frac{T_{E}}{T_{2,A}^{*}} \right) - M_{0,B}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1,B}} \right) \right)\left( 1 - \frac{T_{E}}{T_{2,B}^{*}} \right)\]

Si svolgono i prodotti:

\[= M_{0,A}\left( 1 - \frac{T_{E}}{T_{2,A}^{*}} - \left( 1 - \frac{T_{E}}{T_{2,A}^{*}} \right)\exp\left( - \frac{T_{R}}{T_{1,A}} \right) \right) - M_{0,B}\left( 1 - \frac{T_{E}}{T_{2,B}^{*}} - \left( 1 - \frac{T_{E}}{T_{2,B}} \right)\exp\left( - \frac{T_{R}}{T_{1,B}} \right) \right) = M_{0,A}\left( 1 - \frac{T_{E}}{T_{2,A}^{*}} - \exp\left( - \frac{T_{R}}{T_{1,A}} \right) + \frac{T_{E}}{T_{2,A}^{*}}\exp\left( - \frac{T_{R}}{T_{1,A}} \right) \right) - M_{0,B}\left( 1 - \frac{T_{E}}{T_{2,B}^{*}} - \exp\left( - \frac{T_{R}}{T_{1,B}} \right) + \frac{T_{E}}{T_{2,B}^{*}}\exp\left( - \frac{T_{R}}{T_{1,B}} \right) \right) = M_{0,A} - M_{0,A}\frac{T_{E}}{T_{2,A}^{*}} - M_{0,A}\exp\left( - \frac{T_{R}}{T_{1,A}} \right) + M_{0,A}\frac{T_{E}}{T_{2,A}^{*}}\exp\left( - \frac{T_{R}}{T_{1,A}} \right) - \left( M_{0,B} - M_{0,B}\frac{T_{E}}{T_{2,B}^{*}} - M_{0,B}\exp\left( - \frac{T_{R}}{T_{1,B}} \right) + M_{0,B}\frac{T_{E}}{T_{2,B}^{*}}\exp\left( - \frac{T_{R}}{T_{1,B}} \right) \right) = M_{0,A} - M_{0,A}\frac{T_{E}}{T_{2,A}^{*}} - M_{0,A}\exp\left( - \frac{T_{R}}{T_{1,A}} \right) + M_{0,A}\frac{T_{E}}{T_{2,A}^{*}}\exp\left( - \frac{T_{R}}{T_{1,A}} \right) - M_{0,B} + M_{0,B}\frac{T_{E}}{T_{2,B}^{*}} + M_{0,B}\exp\left( - \frac{T_{R}}{T_{1,B}} \right) - M_{0,B}\frac{T_{E}}{T_{2,B}^{*}}\exp\left( - \frac{T_{R}}{T_{1,B}} \right)\]

Si riorganizza i termini del contrasto:

\[C_{AB} \simeq \left( M_{0,A} - M_{0,B} \right) - M_{0,A}\left( \frac{T_{E}}{T_{2,A}^{*}} + \exp\left( - \frac{T_{R}}{T_{1,A}} \right) \right) + M_{0,B}\left( \frac{T_{E}}{T_{2,B}^{*}} + \exp\left( - \frac{T_{R}}{T_{1,B}} \right) \right)\]
...
\[\frac{T_{E}}{T_{2,A}^{*}} \ll 1,\ \frac{T_{E}}{T_{2,B}^{*}} \ll 1,\ \exp\left( - \frac{T_{R}}{T_{1,A}} \right) \ll 1,\ \exp\left( - \frac{T_{R}}{T_{1,B}} \right) \ll 1\]
...
\[\exp\left( - \frac{T_{E}}{T_{2}} \right) \sim 1\]

Per cui il segnale dipende solamente da \(M_{0}\) e \(T_{1}\):

\[s_{0} \propto M_{0}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1}} \right) \right)\]
...
\paragraph{\texorpdfstring{Contrasto in immagini pesate in \(\mathbf{T}_{\mathbf{1}}\)}{Contrasto in immagini pesate in \textbackslash mathbf\{T\}\_\{\textbackslash mathbf\{1\}\}}}\label{contrasto-in-immagini-pesate-in-mathbft_mathbf1}

Il contrasto tra due tessuti può essere scritto come:

\[C_{AB} = s_{0,A} - s_{0,B} \simeq M_{0,A}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1,A}} \right) \right) - M_{0,B}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1,B}} \right) \right)\]
...
\[\frac{\partial C_{AB}}{\partial T_{R}} = \frac{\partial}{\partial T_{R}}\left\lbrack M_{0,A}\left( 1 - \exp\left( - \frac{T_{R,opt}}{T_{1,A}} \right) \right) - M_{0,B}\left( 1 - \exp\left( - \frac{T_{R,opt}}{T_{1,B}} \right) \right) \right\rbrack = 0\]

Applicando le proprietà dell'operazione di derivata, si ottiene:

\[\frac{M_{0,A}}{T_{1,A}}\exp\left( - \frac{T_{R,opt}}{T_{1,A}} \right) - \frac{M_{0,B}}{T_{1,B}}\exp\left( - \frac{T_{R,opt}}{T_{1,B}} \right) = 0\]

Si portano i termini dipendenti dal tessuto \(B\) al secondo membro:

\[\frac{M_{0,A}}{T_{1,A}}\exp\left( - \frac{T_{R,opt}}{T_{1,A}} \right) = \frac{M_{0,B}}{T_{1,B}}\exp\left( - \frac{T_{R,opt}}{T_{1,B}} \right)\]

Si portano i termini esponenziali al primo membro e i termini lineari al secondo:

\[\exp\left( - \frac{T_{R,opt}}{T_{1,A}} \right)\exp\left( \frac{T_{R,opt}}{T_{1,B}} \right) = \frac{M_{0,B}}{T_{1,B}}\frac{T_{1,A}}{M_{0,A}}\]

Per le proprietà degli esponenziali risulta:

\[\exp\left( \frac{T_{R,opt}}{T_{1,B}} - \frac{T_{R,opt}}{T_{1,A}} \right) = \frac{M_{0,B}}{T_{1,B}}\frac{T_{1,A}}{M_{0,A}}\]

Per isolare il tempo di ripetizione \(T_{R}\) si applica il logaritmo ambo i membri:

\[\frac{T_{R,opt}}{T_{1,B}} - \frac{T_{R,opt}}{T_{1,A}} = \log\left( \frac{M_{0,B}}{T_{1,B}}\frac{T_{1,A}}{M_{0,A}} \right)\]

Per le proprietà dei logaritmi si ha:

\[\frac{T_{R,opt}}{T_{1,B}} - \frac{T_{R,opt}}{T_{1,A}} = \log\left( \frac{M_{0,B}}{T_{1,B}} \right) + \log\left( \frac{T_{1,A}}{M_{0,A}} \right) = \log\left( \frac{M_{0,B}}{T_{1,B}} \right) - \log\left( \frac{M_{0,A}}{T_{1,A}} \right)\]

Il tempo di ripetizione ottimale per ottenere il miglior contrasto tra i tessuti \(A\) e \(B\) è:

\[T_{R,opt} = \frac{\log\left( \frac{M_{0,B}}{T_{1,B}} \right) - \log\left( \frac{M_{0,A}}{T_{1,A}} \right)}{\frac{1}{T_{1,B}} - \frac{1}{T_{1,A}}}\]
...
\[C_{AB}\left( T_{R} \right) = s_{0,A} - s_{0,B} \simeq M_{0,A}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1,A}} \right) \right) - M_{0,B}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1,B}} \right) \right) = 0\]

Si svolgono i prodotti:

\[M_{0,A} - M_{0,A}\exp\left( - \frac{T_{R}}{T_{1,A}} \right) - M_{0,B} + M_{0,B}\exp\left( - \frac{T_{R}}{T_{1,B}} \right) = 0\]

Si portano al secondo membro i termini non dipendenti da \(T_{R}\):

\[M_{0,B}\exp\left( - \frac{T_{R}}{T_{1,B}} \right) - M_{0,A}\exp\left( - \frac{T_{R}}{T_{1,A}} \right) = M_{0,B} - M_{0,A}\]
...
\[C_{AB}\left( T_{R} \right) = s_{0,A} - s_{0,B} \simeq M_{0,A}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1,A}} \right) \right) - M_{0,B}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1,B}} \right) \right) \simeq M_{0}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1,A}} \right) - \left( 1 - \exp\left( - \frac{T_{R}}{T_{1,A}(1 + \delta)} \right) \right) \right) = M_{0}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1,A}} \right) - 1 + \exp\left( - \frac{T_{R}}{T_{1,A}(1 + \delta)} \right) \right)\]

Svolgendo le opportune somme, il contrasto è:

\[C_{AB}\left( T_{R} \right) \simeq M_{0}\left( \exp\left( - \frac{T_{R}}{T_{1,A}(1 + \delta)} \right) - \exp\left( - \frac{T_{R}}{T_{1,A}} \right) \right)\]

Si raccoglie \(\exp\left( - T_{R}/T_{1,A} \right)\), ottenendo:

\[C_{AB}\left( T_{R} \right) \simeq M_{0}\exp\left( - \frac{T_{R}}{T_{1,A}} \right)\left( \frac{\exp\left( - \frac{T_{R}}{T_{1,A}(1 + \delta)} \right)}{\exp\left( - \frac{T_{R}}{T_{1,A}} \right)} - 1 \right) = M_{0}\exp\left( - \frac{T_{R}}{T_{1,A}} \right)\left( \exp\left( - \frac{T_{R}}{T_{1,A}(1 + \delta)} + \frac{T_{R}}{T_{1,A}} \right) - 1 \right)\]

Si considera l'argomento dell'esponenziale e si esegue il minimo comune multiplo:

\[- \frac{T_{R}}{T_{1,A}(1 + \delta)} + \frac{T_{R}}{T_{1,A}} = T_{R}\left( \frac{- 1 + 1 + \delta}{T_{1,A}(1 + \delta)} \right) = T_{R}\left( \frac{\delta}{T_{1,A}(1 + \delta)} \right)\]

Per cui il contrasto è:

\[C_{AB}\left( T_{R} \right) \simeq M_{0}\exp\left( - \frac{T_{R}}{T_{1,A}} \right)\left( \exp\left( T_{R}\left( \frac{\delta}{T_{1,A}(1 + \delta)} \right) \right) - 1 \right)\]
...
\[\exp\left( T_{R}\left( \frac{\delta}{T_{1,A}(1 + \delta)} \right) \right) \simeq T_{R}\left( \frac{\delta}{T_{1,A}(1 + \delta)} \right)\]

Poiché \(\delta \ll 1\), allora;

\[T_{R}\left( \frac{\delta}{T_{1,A}(1 + \delta)} \right) \simeq 1 + \left( \frac{T_{R}}{T_{1,A}} \right)\delta\]

Il contrasto si scrive, quindi:

\[C_{AB}\left( T_{R} \right) \simeq M_{0}\exp\left( - \frac{T_{R}}{T_{1,A}} \right)\left( \exp\left( T_{R}\left( \frac{\delta}{T_{1,A}(1 + \delta)} \right) \right) - 1 \right) \simeq M_{0}\exp\left( - \frac{T_{R}}{T_{1,A}} \right)\left( 1 + \left( \frac{T_{R}}{T_{1,A}} \right)\delta - 1 \right)\]

Semplificando i termini \(\pm 1\), si ottiene:

\[C_{AB}\left( T_{R} \right) \simeq M_{0}\delta\left( \frac{T_{R}}{T_{1,A}} \right)\exp\left( - \frac{T_{R}}{T_{1,A}} \right)\]
...
\[\frac{\partial C_{AB}}{\partial T_{R}} = 0 \Leftrightarrow M_{0}\delta\frac{\partial}{\partial T_{R}}\left( \left( \frac{T_{R}}{T_{1,A}} \right)\exp\left( - \frac{T_{R}}{T_{1,A}} \right) \right) = 0\]

Svolgendo le derivate e semplificando \(M_{0}\delta\), si ha:

\[\frac{1}{T_{1,A}}\exp\left( - \frac{T_{R,opt}}{T_{1,A}} \right) + \left( \frac{T_{R,opt}}{T_{1,A}} \right)\left( - \frac{1}{T_{1,A}} \right)\exp\left( - \frac{T_{R,opt}}{T_{1,A}} \right) = 0\]

Semplificando \(T_{1,A}^{- 1}\) ed \(\exp\left( - T_{R,opt}/T_{1,A} \right)\) si ottiene:

\[1 - \frac{T_{R,opt}}{T_{1,A}} = 0\]
...
\subsubsection{\texorpdfstring{Pesatura in \(\mathbf{T}_{\mathbf{2}}^{\mathbf{*}}\)}{Pesatura in \textbackslash mathbf\{T\}\_\{\textbackslash mathbf\{2\}\}\^{}\{\textbackslash mathbf\{*\}\}}}\label{pesatura-in-mathbft_mathbf2mathbf}
...
\[s_{0} \propto M_{0}\left( 1 - \exp\left( - \frac{T_{R}}{T_{1}} \right) \right)\exp\left( - \frac{T_{E}}{T_{2}} \right) \simeq M_{0}\exp\left( - \frac{T_{E}}{T_{2}^{*}} \right)\]

Con questa scelta il contrasto tra due tessuti può essere scritto:

\[C_{AB} = s_{0,A} - s_{0,B} \simeq M_{0,A}\exp\left( - \frac{T_{E}}{T_{2,A}^{*}} \right) - M_{0,B}\exp\left( - \frac{T_{E}}{T_{2,B}^{*}} \right)\]
...
\[\frac{\partial C_{AB}}{\partial T_{E}} = 0 \Leftrightarrow \frac{\partial}{\partial T_{E}}\left( M_{0,A}\exp\left( - \frac{T_{E}}{T_{2,A}^{*}} \right) - M_{0,B}\exp\left( - \frac{T_{E}}{T_{2,B}^{*}} \right) \right) = 0\]

Si esegue il calcolo della derivata:

\[- \frac{M_{0,A}}{T_{2,A}^{*}}\exp\left( - \frac{T_{E,opt}}{T_{2,A}^{*}} \right) + \frac{M_{0,B}}{T_{2,B}^{*}}\exp\left( - \frac{T_{E,opt}}{T_{2,B}^{*}} \right) = 0\]

Si portano i termini dipendenti dal tessuto \(B\) al secondo membro;

\[\frac{M_{0,A}}{T_{2,A}^{*}}\exp\left( - \frac{T_{E,opt}}{T_{2,A}^{*}} \right) = \frac{M_{0,B}}{T_{2,B}^{*}}\exp\left( - \frac{T_{E,opt}}{T_{2,B}^{*}} \right)\]
...
\[\frac{M_{0,A}}{T_{2,A}^{*}}\exp\left( - \frac{T_{E,opt}}{T_{2,A}^{*}} \right)\exp\left( \frac{T_{E,opt}}{T_{2,B}^{*}} \right) = \frac{M_{0,B}}{T_{2,B}^{*}}\]

Si isolano i termini dipendenti da \(T_{E,opt}\):

\[\exp\left( - \frac{T_{E,opt}}{T_{2,A}^{*}} \right)\exp\left( \frac{T_{E,opt}}{T_{2,B}^{*}} \right) = \frac{M_{0,B}}{T_{2,B}^{*}}\frac{T_{2,A}^{*}}{M_{0,A}}\]

Per le proprietà degli esponenziali, risulta:

\[\exp\left( T_{E,opt}\left( \frac{1}{T_{2,B}^{*}} - \frac{1}{T_{2,A}^{*}} \right) \right) = \frac{M_{0,B}}{T_{2,B}^{*}}\frac{T_{2,A}^{*}}{M_{0,A}}\]

Si applica il logaritmo ambo i membri dell'equazione al fine di isolare \(T_{E,opt}\):

\[T_{E,opt}\left( \frac{1}{T_{2,B}^{*}} - \frac{1}{T_{2,A}^{*}} \right) = \log\left( \frac{M_{0,B}}{T_{2,B}^{*}}\frac{T_{2,A}^{*}}{M_{0,A}} \right)\]

Per le proprietà dei logaritmi è possibile riscrivere il secondo membro come:

\[T_{E,opt}\left( \frac{1}{T_{2,B}^{*}} - \frac{1}{T_{2,A}^{*}} \right) = \log\left( \frac{M_{0,B}}{T_{2,B}^{*}} \right) - \log\left( \frac{M_{0,A}}{T_{2,A}^{*}} \right)\]

Isolando \(T_{E,opt}\) si ottiene il tempo di echo tale da massimizzare il contrasto tra due tessuti:

\[T_{E,opt} = \frac{\log\left( \frac{M_{0,B}}{T_{2,B}^{*}} \right) - \log\left( \frac{M_{0,A}}{T_{2,A}^{*}} \right)}{\frac{1}{T_{2,B}^{*}} - \frac{1}{T_{2,A}^{*}}}\]
...
\[C_{AB} = s_{0,A} - s_{0,B} \simeq M_{0,A}\exp\left( - \frac{T_{E}}{T_{2,A}^{*}} \right) - M_{0,B}\exp\left( - \frac{T_{E}}{T_{2,B}^{*}} \right) \simeq M_{0}\exp\left( - \frac{T_{E}}{T_{2,A}^{*}} \right) - M_{0}\exp\left( - \frac{T_{E}}{T_{2,A}^{*}(1 + \delta)} \right)\]

Si raccoglie il termine \(M_{0}\exp\left( - T_{E}/T_{2,A}^{*} \right)\):

\[C_{AB} \simeq M_{0}\exp\left( - \frac{T_{E}}{T_{2,A}^{*}} \right)\left( 1 - \frac{\exp\left( - \frac{T_{E}}{T_{2,A}^{*}(1 + \delta)} \right)}{\exp\left( - \frac{T_{E}}{T_{2,A}^{*}} \right)} \right) = M_{0}\exp\left( - \frac{T_{E}}{T_{2,A}^{*}} \right)\left( 1 - \exp\left( - \frac{T_{E}}{T_{2,A}^{*}(1 + \delta)} + \frac{T_{E}}{T_{2,A}^{*}} \right) \right)\]

Si esegue il minimo comune multiplo nell'argomento dell'esponenziale:

\[- \frac{T_{E}}{T_{2,A}^{*}(1 + \delta)} + \frac{T_{E}}{T_{2,A}^{*}} = T_{E}\frac{1 + \delta - 1}{T_{2,A}^{*}(1 + \delta)} = \frac{\delta T_{E}}{T_{2,A}^{*}(1 + \delta)}\]

Si ottiene:

\[C_{AB} \simeq M_{0}\exp\left( - \frac{T_{E}}{T_{2,A}^{*}} \right)\left( 1 - \exp\left( \frac{\delta T_{E}}{T_{2,A}^{*}(1 + \delta)} \right) \right)\]
...
\[\exp\left( \frac{\delta T_{E}}{T_{2,A}^{*}(1 + \delta)} \right) \simeq 1 + \frac{\delta T_{E}}{T_{2,A}^{*}(1 + \delta)}\]

Da cui si ottiene:

\[C_{AB} \simeq M_{0}\exp\left( - \frac{T_{E}}{T_{2,A}^{*}} \right)\left( 1 - 1 - \frac{\delta T_{E}}{T_{2,A}^{*}(1 + \delta)} \right) = - M_{0}\frac{\delta T_{E}}{T_{2,A}^{*}(1 + \delta)}\exp\left( - \frac{T_{E}}{T_{2,A}^{*}} \right)\]
...
\[\frac{\partial C_{AB}}{\partial T_{E}} = 0 \Leftrightarrow \frac{\partial}{\partial T_{E}}\left( M_{0}\frac{\delta T_{E}}{T_{2,A}^{*}(1 + \delta)}\exp\left( - \frac{T_{E}}{T_{2,A}^{*}} \right) \right) = 0\]

Si svolge la derivata:

\[M_{0}\frac{\delta}{T_{2,A}^{*}(1 + \delta)}\exp\left( - \frac{T_{E,opt}}{T_{2,A}^{*}} \right) + M_{0}\frac{\delta T_{E,opt}}{T_{2,A}^{*}(1 + \delta)}\left( - \frac{1}{T_{2,A}^{*}} \right)\exp\left( - \frac{T_{E,opt}}{T_{2,A}^{*}} \right) = 0\]

Si mettono in evidenza le quantità in comune tra i due termini (\(M_{0}\), \(\delta\), \(1 + \delta\) e \(T_{2,A}^{*}\)) e gli esponenziali:

\[M_{0}\frac{\delta}{T_{2,A}^{*}(1 + \delta)}\exp\left( - \frac{T_{E,opt}}{T_{2,A}^{*}} \right)\left( 1 - \frac{T_{E,opt}}{T_{2,A}^{*}} \right) = 0\]

L'equazione è soddisfatta se risulta:

\[1 - \frac{T_{E,opt}}{T_{2,A}^{*}} = 0 \Leftrightarrow T_{E,opt} = T_{2,A}^{*}\]
...
\subsubsection{\texorpdfstring{Pesatura in \(\mathbf{T}_{\mathbf{1}}\) mediante inversion recovery}{Pesatura in \textbackslash mathbf\{T\}\_\{\textbackslash mathbf\{1\}\} mediante inversion recovery}}\label{pesatura-in-mathbft_mathbf1-mediante-inversion-recovery}
...
\[s\left( T_{R},T_{I},T_{E} \right) = M_{0}\left( 1 - 2\exp\left( - \frac{T_{I}}{T_{1}} \right) + \exp\left( - \frac{T_{R}}{T_{1}} \right) \right)\exp\left( - \frac{T_{E}}{T_{2}} \right)\]
...
\[C_{AB} = M_{0,A}\left( 1 - 2\exp\left( - \frac{T_{I}}{T_{1,A}} \right) + \exp\left( - \frac{T_{R}}{T_{1,A}} \right) \right)\exp\left( - \frac{T_{E}}{T_{2,A}} \right) - M_{0,B}\left( 1 - 2\exp\left( - \frac{T_{I}}{T_{1,B}} \right) + \exp\left( - \frac{T_{R}}{T_{1,B}} \right) \right)\exp\left( - \frac{T_{E}}{T_{2,B}} \right)\]
...
\[\exp\left( - \frac{T_{R}}{T_{1}} \right) \ll 1\]

Inoltre, per l'ipotesi \(T_{E} \ll T_{2}\), il termine esponenziale \(\exp\left( T_{E}/T_{2} \right)\) tende all'unità:

\[\exp\left( \frac{T_{E}}{T_{2}} \right) \simeq 1\]

Il contrasto, con queste approssimazioni, può essere scritto come:

\[C_{AB} = M_{0,A}\left( 1 - 2\exp\left( - \frac{T_{I}}{T_{1,A}} \right) + \exp\left( - \frac{T_{R}}{T_{1,A}} \right) \right)\exp\left( - \frac{T_{E}}{T_{2,A}} \right) - M_{0,B}\left( 1 - 2\exp\left( - \frac{T_{I}}{T_{1,B}} \right) + \exp\left( - \frac{T_{R}}{T_{1,B}} \right) \right)\exp\left( - \frac{T_{E}}{T_{2,B}} \right) \simeq M_{0,A}\left( 1 - 2\exp\left( - \frac{T_{I}}{T_{1,A}} \right) \right) - M_{0,B}\left( 1 - 2\exp\left( - \frac{T_{I}}{T_{1,B}} \right) \right)\]
...
\[\frac{\partial C_{AB}}{\partial T_{I}} = 0 \Leftrightarrow \frac{\partial}{\partial T_{I}}\left( M_{0,A}\left( 1 - 2\exp\left( - \frac{T_{I}}{T_{1,A}} \right) \right) - M_{0,B}\left( 1 - 2\exp\left( - \frac{T_{I}}{T_{1,B}} \right) \right) \right) = 0\]

Svolgendo l'operazione di derivazione, si ottiene:

\[2M_{0,A}\left( - \frac{1}{T_{1,A}} \right)\exp\left( - \frac{T_{I,opt}}{T_{1,A}} \right) + 2M_{0,B}\frac{1}{T_{1,B}}\exp\left( - \frac{T_{I,opt}}{T_{1,B}} \right) = 0\]

Si isolano i termini \(T_{I,opt}\):

\[2M_{0,A}\frac{1}{T_{1,A}}\exp\left( - \frac{T_{I,opt}}{T_{1,A}} \right) = 2M_{0,B}\frac{1}{T_{1,B}}\exp\left( - \frac{T_{I,opt}}{T_{1,B}} \right)\]

Si divide per \(\exp\left( T_{I,opt}/T_{1,B} \right)\) ambo i membri:

\[2M_{0,A}\frac{1}{T_{1,A}}\exp\left( - \frac{T_{I,opt}}{T_{1,A}} \right)\exp\left( \frac{T_{I,opt}}{T_{1,B}} \right) = 2M_{0,B}\frac{1}{T_{1,B}}\]
...
\[\exp\left( - \frac{T_{I,opt}}{T_{1,A}} + \frac{T_{I,opt}}{T_{1,B}} \right) = \frac{M_{0,B}}{T_{1,B}}\frac{T_{1,A}}{M_{0,A}}\]

Si applica il logaritmo ambo i membri, si ha:

\[T_{I,opt}\left( \frac{1}{T_{1,B}} - \frac{1}{T_{1,A}} \right) = \log\left( \frac{M_{0,B}}{T_{1,B}}\frac{T_{1,A}}{M_{0,A}} \right)\]

Applicando le proprietà dei logaritmi e isolando il termine \(T_{I,opt}\), si ha:

\[T_{I,opt} = \frac{\log\left( \frac{M_{0,B}}{T_{1,B}} \right) - \log\left( \frac{M_{0,A}}{T_{1,A}} \right)}{\frac{1}{T_{1,B}} - \frac{1}{T_{1,A}}}\]
...
\[\frac{1}{T_{1}(c)} = \frac{1}{T_{1,0}} + \alpha_{1}c\]
...
\[\frac{1}{T_{2}(c)} = \frac{1}{T_{2,0}} + \alpha_{2}c\]
...
\[\lbrack\alpha\rbrack = \left\lbrack \left( m\frac{mol}{L}s \right)^{- 1} \right\rbrack\]
...
\[0.1\frac{mmol}{L\ kg}50\ kg = 5mmol/L\]
...
\[\alpha_{A}' = \frac{V_{A}}{\beta V_{tot}} = \frac{\alpha_{A}}{\beta}\]
...
\[s_{voxel,1}' = \frac{\alpha_{A}}{\beta}\left( s_{A}' \right) + \left( 1 - \frac{\alpha_{A}}{\beta} \right)\ \left( s_{B}' \right)\]
...
\[s_{voxel,1}' = \frac{\alpha_{A}}{\beta}\left( \beta s_{A} \right) + \left( 1 - \frac{\alpha_{A}}{\beta} \right)\ \left( \beta s_{B} \right)\]

Il contrasto tra i due tessuti contenuti nei voxel adiacenti è, a valle della riduzione, è:

\[C_{AB} = s_{voxel,2}' - s_{voxel,1}' = \beta s_{B} - \left( \frac{\alpha_{A}}{\beta}\left( \beta s_{A} \right) + \left( 1 - \frac{\alpha_{A}}{\beta} \right)\ \left( \beta s_{B} \right) \right)\]
...
\[T_{S}' = \frac{L_{x}'}{\Delta x'}\ \Delta t'\]
...
\[T_{S}' = \frac{L_{x}'}{\Delta x'}\ \Delta t' = \frac{L_{x}}{\beta\Delta x}\Delta t = \frac{T_{S}}{\beta}\]

Con questa scelta il rapporto segnale/rumore viene ridotto di una quantità \(\sqrt{\beta}\):

\[SNR' \propto \Delta x'\sqrt{T_{S}'} = \ \beta\Delta x\sqrt{\frac{T_{S}}{\beta}} = \sqrt{\beta}\ \Delta x\sqrt{T_{S}}\]

Mantenendo costante la finestra di acquisizione, il numero dei campioni viene scalato di un fattore \(\beta^{- 1}\):

\[L_{x}' = N_{x}'\Delta x' \Leftrightarrow N_{x}' = \frac{L_{x}'}{\Delta x'} = \frac{L_{x}}{\beta\Delta x} = \frac{N_{x}}{\beta}\]

Con questa scelta il rapporto segnale/rumore viene ridotto di una quantità \(\sqrt{\beta}\):

\[SNR' \propto \Delta x'\sqrt{N_{x}'\Delta t'} = \ \beta\Delta x\sqrt{\frac{N_{x}}{\beta}\Delta t} = \sqrt{\beta}\ \Delta x\sqrt{N_{x}\Delta t}\]
...
\[T_{S}' = \frac{L_{x}'}{\Delta x'}\ \Delta t' = \frac{\beta L_{x}}{\beta\Delta x}\Delta t = T_{S}\]
...
\[\sigma_{0}^{2} = \frac{\sigma_{m}^{2}}{N_{x}}\]
...
\[\sigma_{0}^{2} = \beta\frac{\sigma_{m}^{2}}{N_{x}}\]

Ne discende che il rapporto contrasto/rumore aumenta di un fattore \(\sqrt{\beta^{- 1}}\):

\[CNR = \frac{C_{AB}}{\sigma_{0}} = \frac{C_{AB}}{\sqrt{\beta^{- 1}}\sigma_{0}}\]
